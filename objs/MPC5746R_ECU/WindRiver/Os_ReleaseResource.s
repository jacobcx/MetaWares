...
.L11389:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\resources\\Os_ReleaseResource.c"
        .d2line         64,28
#$$ld
.L11396:

#$$bf	ReleaseResource,interprocedural,rasave,nostackparams
...
.Llo1:
	...
	.d2prologue_end
# {
#     VAR(Os_APICallType,AUTOMATIC) Os_ReleaseResourceCall;
# 
#     OS_API_ALLOC(Os_ReleaseResourceCall,ReleaseResource);
	.d2line		68
.Llo2:
	e_lis		r3,4660
.Llo3:
	e_or2i		r3,22136
	stw		r3,8(r1)
	lis		r3,Os_API_ReleaseResource@ha
	e_add16i		r3,r3,Os_API_ReleaseResource@l
	stw		r3,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
#     Os_ReleaseResourceCall.Os_API_Data.Os_ApiReleaseResource.ResourceId = resId;
	.d2line		69
	stw		r0,24(r1)		# resId=r0
# 
#     OS_SYSCALL(Os_ReleaseResourceCall);
	.d2line		71
	diab.addi		r3,r1,8
	bl		OS_SYS_CALL
# 
#     return Os_ReleaseResourceCall.Os_API_ReturnValue;
	.d2line		73
.Llo4:
	lbz		r3,12(r1)
# }
...
# Allocations for ReleaseResource
#	?a4		resId
#	SP,8		Os_ReleaseResourceCall
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_RelResource_Err(P2CONST(Os_ProcStatType,AUTOMATIC ,OS_CONST) currentTask,
	.section	.Os_TEXT,,c
	.align		1
...
#$$bf	Os_RelResource_Err,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_RelResource_Err:
.Llo5:
	stwu		r1,-32(r1)		
...
#     if(E_OK == retVal)
	...
	bc		0,2,.L11376	# ne
#     {
#         /* The resource that is being released was not occupied before earlier by the current task or isr */
#         if(currentTask != Os_ResourceStat[resourceId].Os_ResourceDyn->Os_LockerProc)
	.d2line		209
.Llo7:
	...
	lwzx		r4,r4,r0
	lwz		r0,0(r4)
	se_cmpl		r0,r31		# currentTask=r31
	bc		1,2,.L11377	# eq
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_NOFUNC); /* [OS001-085.v1] */
	.d2line		211
	diab.li		r3,5		# retVal=r3
	b		.L11376
.L11377:
#         }
#         /* If the resource being released is not the resource that was occupied the last time by current task,
#          * (violation of resource nesting), that is an error condition.
#          *
#          * Note that due to the previous condition, currentTask->Os_ProcDyn->Os_ProcResourcesAllocated is at least 1.
#          */
#         else if( &Os_ResourceStat[resourceId] !=
	.d2line		218
.Llo10:
	lis		r4,Os_ResourceStat@ha
	e_add16i		r4,r4,Os_ResourceStat@l
.Llo11:
	e_mulli		r30,r30,12		# resourceId=r30 resourceId=r30
	se_add		r30,r4		# resourceId=r30 resourceId=r30
	lwz		r0,68(r31)		# currentTask=r31
	lwz		r4,8(r31)		# currentTask=r31
	lwz		r4,28(r4)
	se_slwi		r4,2
	se_add		r4,r0
	lwz		r0,-4(r4)
	se_cmpl		r30,r0		# resourceId=r30
	bc		1,2,.L11379	# eq
#                  currentTask->Os_ProcResourceStack[currentTask->Os_ProcDyn->Os_ProcResourcesAllocated - 1] )
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_NOFUNC); /* [OS001-086.v1] [OS001-087.v1] */
	.d2line		221
.Llo12:
	diab.li		r3,5		# retVal=r3
	b		.L11376
...
#         /* The resource is not occupied in the current spinlock.  */
#         else if ( ( currentTask->Os_ProcDyn->Os_ProcSpinlock != NULL_PTR ) &&
	...
	lwz		r0,8(r4)
	se_cmpi		r0,0
#                   ( currentTask->Os_ProcDyn->Os_ProcSpinlock->Os_SpinlockDyn->Os_ResourceDependency == NULL_PTR ))
#         {
...
#              * [OS088-01-079] [OS088-01-080] [OS001-083.v1] [OS001-088.v1]
#              */
#         }
#     }
# 
...
#$$ld
.L11421:
	.type		Os_RelResource_Err,@function
	.size		Os_RelResource_Err,.-Os_RelResource_Err
# Number of nodes = 85

# Allocations for Os_RelResource_Err
#	?a4		currentTask
#	?a5		resourceId
#	?a6		retVal
# OS_API(ReleaseResource)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         86,1
#$$ld
...
#$$bf	Os_API_ReleaseResource,interprocedural,rasave,nostackparams
	.globl		Os_API_ReleaseResource
	.d2_cfa_start __cie
...
#   #endif
# 
#     OS_TRACE(ReleaseResource_Entry , coreId);
	.d2line		95
	diab.li		r4,47
.Llo19:
	...
	stbx		r4,r3,r5
# 
#     resourceId  =  Os_APICall->Os_API_Data.Os_ApiReleaseResource.ResourceId;
	.d2line		97
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN ( coreId )->Os_HookID)
	...
	bc		1,2,.L11360	# eq
#     {
#         /* [OS088-03-054] [OS088-03-055] [OS088-03-056] [OS088-03-057] [OS088-03-058]
#          * [OS088-03-059] [OS088-03-060] [OS088-03-350] [OS088-03-350] [OS088-03-385]
#          * [OS088-03-428] [OS-MGC-0056-07] [OS-MGC-0056-50]
#          */
...
.L11453:
#     {
#         VAR(Os_PriorityType,AUTOMATIC) newPriority;
# 
...
#             {
#                 Os_TPTimer_Stop(callerProc->Os_ProcResourceBudgets[res].Os_ResourceBudget); /* [OS033-02] */
#             }
#         }
# 
...
#         callerProc->Os_ProcDyn->Os_ProcResourcesAllocated--;
	.d2line		143
	lwz		r4,8(r30)		# callerProc=r30
	lwz		r3,28(r4)		# retVal=r3
	diab.addi		r3,r3,-1		# retVal=r3 retVal=r3
	stw		r3,28(r4)		# retVal=r3
# 
#         /* [OS001-089.v1] */
#         callerProc->Os_ProcResourceStack[callerProc->Os_ProcDyn->Os_ProcResourcesAllocated] = NULL_PTR;
	.d2line		146
	lwz		r3,68(r30)		# retVal=r3 callerProc=r30
	lwz		r4,8(r30)		# callerProc=r30
	lwz		r4,28(r4)
	se_slwi		r4,2
	stwx		r0,r3,r4		# retVal=r3
# 
#         OS_CALL_RTM_RESOURCE_RELEASE(resourceId, OS_GETCOREID());
# 
#       #ifdef OS_MODULE_SPINLOCK
...
.Llo31:
	...
	se_add		r3,r28		# retVal=r3 retVal=r3 resourceId=r28
...
#       #endif
# 
#         if(callerProc->Os_ProcDyn->Os_ProcResourcesAllocated > 1U)
	.d2line		159
.Llo33:
	lwz		r3,8(r30)		# retVal=r3 callerProc=r30
	lwz		r0,28(r3)		# retVal=r3
	se_cmpli	r0,1
	bc		0,1,.L11364	# le
#         {
#             newPriority = callerProc->Os_ProcResourceStack[callerProc->Os_ProcDyn->Os_ProcResourcesAllocated - 1U]->
	.d2line		161
.Llo34:
	lwz		r0,68(r30)		# callerProc=r30
	lwz		r3,8(r30)		# retVal=r3 callerProc=r30
	lwz		r3,28(r3)		# retVal=r3 retVal=r3
	se_slwi		r3,2		# retVal=r3 retVal=r3
	se_add		r3,r0		# retVal=r3 retVal=r3
	lwz		r3,-4(r3)		# retVal=r3 retVal=r3
	lwz		r4,0(r3)		# retVal=r3
.Llo37:
	mr		r4,r4		# newPriority=r4 newPriority=r4
	b		.L11365
.L11364:
#                                                                                                 Os_ResourcePriority;
#         }
#         else /* last resource is released */
#         {
#             newPriority = callerProc->Os_ProcRunPriority;
	.d2line		166
.Llo38:
	lwz		r4,36(r30)		# callerProc=r30
.Llo39:
	mr		r4,r4		# newPriority=r4 newPriority=r4
.L11365:
#         }
# 
#         /* Change the priority only when necessary. */
#         if ( newPriority != callerProc->Os_ProcDyn->Os_ProcCurrentPriority )
	.d2line		170
	lwz		r3,8(r30)		# retVal=r3 callerProc=r30
	lwz		r0,48(r3)		# retVal=r3
	se_cmpl		r0,r4		# newPriority=r4
	bc		1,2,.L11367	# eq
#         {
#             Os_SchedulerChangeProcPriority(callerProc, newPriority,Os_true); /* [OS001-289.v1] */
	.d2line		172
.Llo40:
	mr		r3,r30		# callerProc=r3 callerProc=r30
.Llo41:
...
#         }
# 
#         /* [OS001-275.v1]: Will reschedule when returning from Dispatch() */
#     }
#     else
#     {
...
.Llo22:
	...
	rlwinm		r0,r27,0,16,31		# coreId=r27
	e_mulli		r0,r0,152
	stwx		r28,r3,r0		# retVal=r3 resourceId=r28
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal,OSServiceId_ReleaseResource,callerProc); /* [OS001-302.v1-09] */
	.d2line		185
...
#     OS_TRACE(ReleaseResource_Exit , coreId);
	.d2line		188
	diab.li		r3,46		# retVal=r3
	lis		r4,(Os_Core_DynShared+120)@ha		# newPriority=r4
.Llo43:
	e_add16i		r4,r4,(Os_Core_DynShared+120)@l		# newPriority=r4 newPriority=r4
.Llo35:
	rlwinm		r27,r27,0,16,31		# coreId=r27 coreId=r27
	e_mulli		r27,r27,152		# coreId=r27 coreId=r27
.Llo36:
	stbx		r3,r4,r27		# newPriority=r4 retVal=r3
# }
	.d2line		189
	.d2epilogue_begin
...
#$$ld
.L11435:
	.type		Os_API_ReleaseResource,@function
	.size		Os_API_ReleaseResource,.-Os_API_ReleaseResource
# Number of nodes = 247

# Allocations for Os_API_ReleaseResource
#	?a4		Os_APICall
#	?a5		callerProc
#	?a6		$$2352
#	?a7		retVal
...
#$$ld
.L5:
.L11954:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11951:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11949:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11947:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11945:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11930:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11928:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11911:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11891:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11846:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
...
.L11533:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
...
.L11461:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ResourceCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11390:
.L11398:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\resources\\Os_ReleaseResource.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11414:
.L11422:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\resources\\Os_ReleaseResource.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\resources\\Os_ReleaseResource.c"
	.byte		0
...
.L11438:
	...
	.d2locend
.L11442:
	.d2locreg	%offsetof(.Llo15), %offsetof(.Llo19),4
...
.L11444:
	...
	.d2locreg	%offsetof(.Llo26), %offsetof(.Llo18),29
	.d2locreg	%offsetof(.Llo27), %offsetof(.Llo28),3
	.d2locend
.L11446:
	.d2locreg	%offsetof(.Llo29), %offsetof(.Llo30),28
	.d2locreg	%offsetof(.Llo31), %offsetof(.Llo32),28
	.d2locreg	%offsetof(.Llo33), %offsetof(.Llo34),28
	.d2locreg	%offsetof(.Llo22), %offsetof(.Llo23),28
	.d2locend
.L11452:
	.d2locreg	%offsetof(.Llo15), %offsetof(.Llo23),27
	.d2locreg	%offsetof(.Llo35), %offsetof(.Llo36),27
	.d2locend
.L11459:
	.d2locreg	%offsetof(.Llo37), %offsetof(.Llo38),4
	.d2locreg	%offsetof(.Llo39), %offsetof(.Llo40),4
	.d2locreg	%offsetof(.Llo41), %offsetof(.Llo42),4
	.d2locreg	%offsetof(.Llo43), %offsetof(.Llo28),4
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_ReleaseResource"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_RelResource_Err","Os_SchedulerChangeProcPriority","Os_ShutdownAllCores"
	.wrcm.end
	.wrcm.nelem "Os_RelResource_Err"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Resource_Err"
	.wrcm.end
	.wrcm.nelem "ReleaseResource"
	.wrcm.nint32 "frameSize", 48
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_ReleaseResource.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\resources\Os_ReleaseResource.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
