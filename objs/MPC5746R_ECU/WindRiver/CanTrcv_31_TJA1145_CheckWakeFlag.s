...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"CanTrcv_31_TJA1145_CheckWakeFlag.c"
#$$dg 1
...
.L4:
	...
	.section	.text_vle
# FUNC (Std_ReturnType, CANTRCV_31_TJA1145_CODE)CANTRCV_31_TJA1145_CHECKWAKEFLAG
...
.L673:
	...
	.section	.invalid_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_CheckWakeFlag.c"
        .d2line         92,47
#$$ld
.L680:

#$$bf	CanTrcv_31_TJA1145_CheckWakeFlag,interprocedural,nostackparams

# Regs written: r0,r1,r3
	.globl		CanTrcv_31_TJA1145_CheckWakeFlag
	.d2_cfa_start __cie
CanTrcv_31_TJA1145_CheckWakeFlag:
	stwu		r1,-16(r1)		
...
#     VAR(uint16, AUTOMATIC) DataToBeSent[CheckWakeFlagDataToBeSentLength];
# 
# 	/* Variable holds the data to be received from CanTrcv via SPI. */
# 	VAR(uint16, AUTOMATIC) DataToBeReceived[CheckWakeFlagDataToBeReceivedLength];
#     
...
#     ReturnValue = CanTrcv_31_TJA1145_CheckWakeFlagDECheck( Transceiver );
#     if (E_OK == ReturnValue)
#     {
# #else
#     
...
#                               
#         /* Prepare the command to be sent to the CanTrcv to read the CAN wake-up flag */
...
# 
#         /* Prepare the command to be sent to the CanTrcv to read the WAKE pin wake-up flag */
...
#                                  CANTRCV_31_TJA1145_CHECK_WAKE_FLAG_SID,
...
# 			{
# 
# 				CanIf_CheckTrcvWakeFlagIndication( LtConfig_p->CanIfTrcvID );
# 
# 			}
# 			else
# 			{
...
#     return (ReturnValue);
# 
# }/* End of CanTrcv_31_TJA1145_CheckWakeFlag () */
	.d2line		208
	.d2epilogue_begin
.Llo2:
	se_addi		r1,16		
...
#$$ld
.L681:
	.type		CanTrcv_31_TJA1145_CheckWakeFlag,@function
	.size		CanTrcv_31_TJA1145_CheckWakeFlag,.-CanTrcv_31_TJA1145_CheckWakeFlag
# Number of nodes = 5

# Allocations for CanTrcv_31_TJA1145_CheckWakeFlag
...
#$$ld
.L674:
.L682:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_CheckWakeFlag.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_CheckWakeFlag.c"
	.byte		0
...
.L686:
	.sleb128	2
	.4byte		.L679-.L671
	.byte		"CanTrcv_31_TJA1145_CheckWakeFlag"
	.byte		0
	.4byte		.L682
	.uleb128	92
	.uleb128	47
...
.L688:
	...
	.wrcm.nelem "CanTrcv_31_TJA1145_CheckWakeFlag"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanTrcv_31_TJA1145_CheckWakeFlag.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\COM\CanTrcv\ssc\target\TJA1145\make\..\src\CanTrcv_31_TJA1145_CheckWakeFlag.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
