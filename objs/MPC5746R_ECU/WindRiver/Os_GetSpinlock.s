...
.L11387:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_GetSpinlock.c"
        .d2line         55,26
#$$ld
.L11394:

#$$bf	GetSpinlock,interprocedural,rasave,nostackparams
	.globl		GetSpinlock
	.d2_cfa_start __cie
GetSpinlock:
.Llo1:
	...
	.d2prologue_end
# {
#     VAR(Os_APICallType, AUTOMATIC) Os_GetSpinlockAPI_Call;
# 
#     Os_GetSpinlockAPI_Call.Os_API_Data.Os_API_GetSpinlock.SpinlockId = spinlockId;
	.d2line		59
	sth		r3,24(r1)		# spinlockId=r3
# 
#     OS_LIGHT_SYSCALL(Os_GetSpinlockAPI_Call, GetSpinlock);
	.d2line		61
	diab.addi		r3,r1,8		# spinlockId=r3
.Llo2:
	lis		r4,Os_API_GetSpinlock@ha
	e_add16i		r4,r4,Os_API_GetSpinlock@l
	bl		OS_SYS_CALL
# 
#     return Os_GetSpinlockAPI_Call.Os_API_ReturnValue;
	.d2line		63
...
# Allocations for GetSpinlock
#	?a4		spinlockId
#	SP,8		Os_GetSpinlockAPI_Call
# FUNC (StatusType, OS_CODE) Os_GetSpinlock ( CONSTP2CONST (Os_ProcStatType, AUTOMATIC, OS_CONST)  callerProc,
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_GetSpinlock,interprocedural,rasave,nostackparams
	.globl		Os_GetSpinlock
	.d2_cfa_start __cie
Os_GetSpinlock:
.Llo3:
	stwu		r1,-32(r1)		
	...
	mr		r30,r4		# spinlockId=r30 spinlockId=r4
	.d2prologue_end
...
.Llo5:
	...
	rlwinm		r4,r30,4,12,27		# spinlockId=r30
	lwzx		r3,r3,r4
...
#             callerProc->Os_ProcDyn->Os_ProcSpinlock = &Os_SpinlockStat[spinlockId];
	.d2line		151
.Llo7:
	lis		r3,Os_SpinlockStat@ha
	e_add16i		r3,r3,Os_SpinlockStat@l
.Llo8:
	rlwinm		r30,r30,4,12,27		# spinlockId=r30 spinlockId=r30
	se_add		r30,r3		# spinlockId=r30 spinlockId=r30
	lwz		r3,8(r31)		# callerProc=r31
	stw		r30,40(r3)		# spinlockId=r30
#             callerProc->Os_ProcDyn->Os_ProcSpinlock->Os_SpinlockDyn->Os_SpinlockLockerProc = callerProc;
	.d2line		152
	lwz		r3,8(r31)		# callerProc=r31
	lwz		r3,40(r3)
	lwz		r3,4(r3)
	stw		r31,0(r3)		# callerProc=r31
	.section	.Os_TEXT,,c
.L11436:
#             break;
#         }
...
#$$ld
.L11419:
	.type		Os_GetSpinlock,@function
	.size		Os_GetSpinlock,.-Os_GetSpinlock
# Number of nodes = 88

# Allocations for Os_GetSpinlock
#	?a4		callerProc
#	?a5		spinlockId
#	?a6		retVal
#	?a7		coreId
#	SP,8		tryLockResourceResult
# OS_APILIGHT(GetSpinlock)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         77,1
#$$ld
...
#$$bf	Os_API_GetSpinlock,interprocedural,rasave,nostackparams
	.globl		Os_API_GetSpinlock
	.d2_cfa_start __cie
Os_API_GetSpinlock:
.Llo11:
	stwu		r1,-48(r1)		
...
#     CONST        (SpinlockIdType,  AUTOMATIC)            spinlockId = Os_APICall->Os_API_Data.Os_API_GetSpinlock.SpinlockId;
	.d2line		80
...
# 
#     OS_TRACE(GetSpinlock_Entry , coreId);
	.d2line		84
	diab.li		r0,101
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN(coreId)->Os_HookID)
	...
	bc		1,2,.L11361	# eq
#     {
#         /* [OS088-03-316] [OS088-03-317] [OS088-03-318] [OS088-03-319] [OS088-03-320]
#          * [OS088-03-321] [OS088-03-322] [OS088-03-375] [OS088-03-418] [OS088-03-462]
#          * [OS-MGC-0056-38] [OS-MGC-0056-81]
#          */
...
#     if(E_OK == retVal)
	...
	bc		0,2,.L11363	# ne
#     {
#         retVal = Os_GetSpinlock ( callerProc, spinlockId );
	.d2line		107
.Llo18:
	mr		r3,r27		# callerProc=r3 callerProc=r27
.Llo19:
	mr		r4,r29		# spinlockId=r4 spinlockId=r29
	bl		Os_GetSpinlock
	mr		r30,r3		# retVal=r30 retVal=r3
.L11363:
#     }
...
#         OS_GET_PARAMETER_ERRORCODE(coreId).Os_Err_SpinlockID = spinlockId;
	...
	rlwinm		r4,r28,0,16,31		# spinlockId=r4 coreId=r28
	e_mulli		r4,r4,152		# spinlockId=r4 spinlockId=r4
	sthx		r29,r3,r4		# retVal=r3 spinlockId=r29
#       #endif
#         OS_CALL_ERRORHOOK ( retVal, OSServiceId_GetSpinlock, callerProc ); /* [OS001-302.v1-34] */
	.d2line		115
	rlwinm		r3,r30,0,24,31		# retVal=r3 retVal=r30
	diab.li		r4,25		# spinlockId=r4
...
# 
#     OS_TRACE(GetSpinlock_Exit , coreId);
	.d2line		120
	diab.li		r3,100		# retVal=r3
...
.Llo27:
	stbx		r3,r4,r28		# spinlockId=r4 retVal=r3
# }
	.d2line		121
	.d2epilogue_begin
...
#$$ld
.L11446:
	.type		Os_API_GetSpinlock,@function
	.size		Os_API_GetSpinlock,.-Os_API_GetSpinlock
# Number of nodes = 159

# Allocations for Os_API_GetSpinlock
#	?a4		Os_APICall
#	?a5		$$2354
#	?a6		retVal
#	?a7		spinlockId
...
#$$ld
.L5:
.L11957:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11954:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11952:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11950:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11948:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11933:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11931:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11914:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11894:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
...
.L11467:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11460:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SpinlockCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11388:
.L11396:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_GetSpinlock.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11412:
.L11420:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_GetSpinlock.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_GetSpinlock.c"
	.byte		0
...
.L11428:
	...
	.d2locreg	%offsetof(.Llo5), %offsetof(.Llo7),30
	.d2locreg	%offsetof(.Llo8), %offsetof(.Llo6),30
	.d2locend
.L11430:
	.d2locreg	%offsetof(.Llo3), %offsetof(.Llo9),29
	.d2locend
.L11434:
	.d2locreg	%offsetof(.Llo10), %offsetof(.Llo4),0
	.d2locend
.L11449:
...
.L11454:
	...
	.d2locreg	%offsetof(.Llo24), %offsetof(.Llo21),4
	.d2locend
.L11456:
	.d2locreg	%offsetof(.Llo25), %offsetof(.Llo23),28
	.d2locreg	%offsetof(.Llo26), %offsetof(.Llo27),28
	.d2locend
.L11458:
	.d2locreg	%offsetof(.Llo28), %offsetof(.Llo23),27
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetSpinlock"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_GetSpinlock","Os_ShutdownAllCores","Os_Spinlock_Err_DynLock","Os_Spinlock_Err_Stat"
	.wrcm.end
	.wrcm.nelem "Os_GetSpinlock"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Platform_TryLockResource_Byte"
	.wrcm.end
	.wrcm.nelem "GetSpinlock"
	.wrcm.nint32 "frameSize", 48
