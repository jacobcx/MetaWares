...
.L11410:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\scheduler\\Os_Schedule.c"
        .d2line         47,27
#$$ld
.L11417:

#$$bf	Schedule,interprocedural,rasave,nostackparams
	.globl		Schedule
	.d2_cfa_start __cie
Schedule:
	stwu		r1,-48(r1)		
	...
	.d2prologue_end
# {
#     VAR(Os_APICallType,AUTOMATIC) Os_SchedulerCall;
# 
#     OS_API_ALLOC(Os_SchedulerCall,Schedule);
	.d2line		51
	e_lis		r0,4660
	e_or2i		r0,22136
	stw		r0,8(r1)
	lis		r3,Os_API_Schedule@ha
	e_add16i		r3,r3,Os_API_Schedule@l
	stw		r3,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
#     OS_SYSCALL(Os_SchedulerCall);
	.d2line		52
	diab.addi		r3,r1,8
	bl		OS_SYS_CALL
# 
#     return Os_SchedulerCall.Os_API_ReturnValue;
	.d2line		54
	lbz		r3,12(r1)
# }
	.d2line		55
...
# Allocations for Schedule
#	SP,8		Os_SchedulerCall
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_Schedule_Err(P2CONST (Os_ProcStatType,AUTOMATIC,OS_CONST) CurrentProc )
	.section	.Os_TEXT,,c
	.align		1
	.section	.Os_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\scheduler\\Os_Schedule.c"
...
#$$bf	Os_Schedule_Err,interprocedural,rasave,nostackparams
...
.Llo3:
	...
	stw		r0,20(r1)
	.d2_cfa_offset    108,-1
	mr		r7,r3		# CurrentProc=r7 CurrentProc=r3
	.d2prologue_end
# {
#     VAR (StatusType, AUTOMATIC) retVal;
# 
#     if(Os_Proc_Task != CurrentProc->Os_ProcKind) /* [OS088-01-005] */
	.d2line		127
	lwz		r0,16(r7)		# CurrentProc=r7
	se_cmpi		r0,0
	bc		1,2,.L11373	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_CALLEVEL); /* [OS088-03-028] [OS088-03-044] [OS001-044.v1] */
	.d2line		129
.Llo4:
...
.Llo7:
	...
	bc		1,2,.L11375	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_DISABLEDINT); /* [OS093-01-04] [OS093-02-04] */
	.d2line		133
...
.L11375:
#     }
#     else if(0 != CurrentProc->Os_ProcDyn->Os_ProcResourcesAllocated)
	.d2line		135
.Llo9:
	lwz		r3,8(r7)		# CurrentProc=r7
	lwz		r0,28(r3)
	se_cmpi		r0,0
	bc		1,2,.L11377	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_RESOURCE); /* [OS088-01-043] [OS001-043.v1] */
	.d2line		137
...
# 
#     else if(CurrentProc->Os_ProcDyn->Os_ProcSpinlock != NULL_PTR)
	.d2line		142
.Llo11:
	lwz		r3,8(r7)		# CurrentProc=r7
...
#         retVal = E_OS_SPINLOCK;
	...
	isel		r0,r8,r0,2		# retVal=r0 retVal=r8 retVal=r0
.L11379:
#     }
# 
#   #endif
...
#$$ld
.L11430:
	.type		Os_Schedule_Err,@function
	.size		Os_Schedule_Err,.-Os_Schedule_Err
# Number of nodes = 56

# Allocations for Os_Schedule_Err
#	?a4		CurrentProc
#	?a5		retVal
# OS_API(Schedule)
	.align		2
...
#$$bf	Os_API_Schedule,interprocedural,rasave,nostackparams
	.globl		Os_API_Schedule
	.d2_cfa_start __cie
Os_API_Schedule:
.Llo14:
	stwu		r1,-32(r1)		
...
# 
#     OS_TRACE(Schedule_Entry , coreId);
	.d2line		74
	diab.li		r0,67
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN(coreId)->Os_HookID)
	...
	bc		1,2,.L11361	# eq
#     {
#         /* [OS088-03-029] [OS088-03-030] [OS088-03-031] [OS088-03-032] [OS088-03-033]
#          * [OS088-03-034] [OS088-03-035] [OS088-03-348] [OS088-03-348] [OS088-03-381]
#          * [OS088-03-424] [OS-MGC-0056-04] [OS-MGC-0056-47]
#          */
...
# 
#     {
#         retVal = Os_Schedule_Err(callerProc);
	.d2line		92
...
.Llo24:
	...
	bc		0,2,.L11364	# ne
#     {
#         /* [OS001-040.v1] [OS001-280.v1] */
#         if(callerProc->Os_ProcPriority != callerProc->Os_ProcRunPriority)
	.d2line		99
	lwz		r0,32(r30)		# callerProc=r30
	lwz		r3,36(r30)		# callerProc=r30
	se_cmpl		r0,r3
	bc		1,2,.L11366	# eq
#         {
#             /* [OS001-035.v1] [OS001-294.v1] */
#             Os_SchedulerChangeProcPriority(callerProc, callerProc->Os_ProcPriority,Os_false);
	.d2line		102
	lwz		r4,32(r30)		# callerProc=r30
	mr		r3,r30		# callerProc=r3 callerProc=r30
	diab.li		r5,0
...
#     else
#     {
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_Schedule, callerProc); /* [OS001-302.v1-04] */
	.d2line		109
	rlwinm		r3,r29,0,24,31		# retVal=r29
...
# 
#     OS_TRACE(Schedule_Exit , coreId);
	.d2line		114
	diab.li		r3,66		# callerProc=r3
.Llo20:
...
#$$ld
.L11443:
	.type		Os_API_Schedule,@function
	.size		Os_API_Schedule,.-Os_API_Schedule
# Number of nodes = 114

# Allocations for Os_API_Schedule
#	?a4		Os_APICall
#	?a5		callerProc
#	?a6		retVal
#	?a7		coreId
...
.L11930:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
.L11925:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11923:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11906:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11886:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
...
.L11793:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11790:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11765:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
.L11524:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
.L11467:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11456:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11390:
.L11431:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\scheduler\\Os_Schedule.c"
.L11398:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11411:
.L11419:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\scheduler\\Os_Schedule.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\scheduler\\Os_Schedule.c"
	.byte		0
...
.L11452:
	...
	.d2locreg	%offsetof(.Llo24), %offsetof(.Llo17),29
	.d2locend
.L11454:
	.d2locreg	%offsetof(.Llo14), %offsetof(.Llo19),28
	...
	.wrcm.nelem "Os_API_Schedule"
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_Schedule_Err","Os_SchedulerChangeProcPriority","Os_ShutdownAllCores"
	.wrcm.nint32 "frameSize", 32
	.wrcm.end
	.wrcm.nelem "Os_Schedule_Err"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_Schedule.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_Schedule.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_Schedule.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_Schedule.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_Schedule.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_Schedule.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\scheduler\Os_Schedule.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
