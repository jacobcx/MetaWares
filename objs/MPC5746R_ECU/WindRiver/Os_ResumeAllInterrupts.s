...
.L11393:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeAllInterrupts.c"
        .d2line         50,22
#$$ld
.L11400:

#$$bf	ResumeAllInterrupts,interprocedural,rasave,nostackparams
...
# 
#     VAR (Os_APICallType, AUTOMATIC) Os_ResumeAllInterruptCall;
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_ResumeAllInterruptCall, ResumeAllInterrupts );
# 
#   #else
# 
...
# Allocations for ResumeAllInterrupts
#	?a4		$$2352
# FUNC (void, OS_CODE) Os_ResumeAllInterruptsDefault(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         70,22
#$$ld
...
#$$bf	Os_ResumeAllInterruptsDefault,interprocedural,nostackparams

# Regs written: r0,r1,r3,r4,r5,cr0,lr
	.globl		Os_ResumeAllInterruptsDefault
	.d2_cfa_start __cie
Os_ResumeAllInterruptsDefault:
	stwu		r1,-16(r1)		
	.d2_cfa_def_cfa_offset	16
	mfspr		r0,lr
.Llo1:
...
#     OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SuspendAllCount--;
	...
	diab.addi		r3,r3,-1
	stw		r3,12(r4)
#     if(OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SuspendAllCount == 0U)
	.d2line		75
	lis		r3,Os_Core_Stat@ha
	e_add16i		r3,r3,Os_Core_Stat@l
	lwzx		r3,r3,r5
...
#         /* [OS001-063.v1] */
#         OS_RESTORE_ALLINTR(OS_GET_CORE_ISR_DYN(coreID)->Os_SuspendAllPrevIsrState);
	.d2line		79
.Llo2:
...
#$$ld
.L11407:
	.type		Os_ResumeAllInterruptsDefault,@function
	.size		Os_ResumeAllInterruptsDefault,.-Os_ResumeAllInterruptsDefault
# Number of nodes = 56

# Allocations for Os_ResumeAllInterruptsDefault
#	?a4		$$2353
#	?a5		coreID
# FUNC(void,OS_CODE)  Os_ResumeAllInterruptsAPITrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         84,21
#$$ld
...
#$$bf	Os_ResumeAllInterruptsAPITrusted,interprocedural,rasave,nostackparams
	.globl		Os_ResumeAllInterruptsAPITrusted
	.d2_cfa_start __cie
Os_ResumeAllInterruptsAPITrusted:
	stwu		r1,-32(r1)		
...
# 
#     OS_TRACE(ResumeAllInterrupts_Entry , coreID);
	.d2line		93
	diab.li		r0,91
...
#     if(    (OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SuspendAllCount == 0U)
	...
	bc		0,2,.L11366	# ne
.L11371:
#         || OS_ISR_CHECK_SUSPENDALL(coreID) )
#     {
#         /* [OS092-02] [OS-MGC-0069-01] */
...
# 
#       #ifdef OS_CONFIG_INTERRUPTSERVICE_VALIDATION
#         OS_ISR_UREGISTER_SUSPENDALL(coreID);
	.d2line		117
	lis		r3,(Os_Core_Stat+4)@ha
	e_add16i		r3,r3,(Os_Core_Stat+4)@l
	lwzux		r6,r3,r8
...
#       #endif /* OS_CONFIG_INTERRUPTSERVICE_VALIDATION */
# 
#         OS_CALL_RTM_RESUME_ALL_INTERRUPTS(coreID);
# 
...
#              */
#             CONST(Os_IsrRegister_t, AUTOMATIC) Os_IsrPrevSt = OS_DISABLE_ALLINTR();
#             Os_TPTimer_Stop(OS_SCHEDULER_GET_CURRENT_PROC(coreID)->Os_ProcLockAllTimerConf); /* [OS037-05] */
#             OS_SET_ISR_LEVEL (OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SavedIsrLevel ,coreID );
# 
#             OS_RESTORE_ALLINTR(Os_IsrPrevSt);
#           #else
#             /* [OS001-063.v1] */
#             OS_RESTORE_ALLINTR(OS_GET_CORE_ISR_DYN(coreID)->Os_SuspendAllPrevIsrState);
	.d2line		137
...
#     }
# 
#     OS_TRACE(ResumeAllInterrupts_Exit , coreID);
	.d2line		142
.Llo8:
	diab.li		r3,90
...
#$$ld
.L11418:
	.type		Os_ResumeAllInterruptsAPITrusted,@function
	.size		Os_ResumeAllInterruptsAPITrusted,.-Os_ResumeAllInterruptsAPITrusted
# Number of nodes = 257

# Allocations for Os_ResumeAllInterruptsAPITrusted
#	?a4		$$2355
#	?a5		$$2354
#	?a6		coreID
# FUNC(void,OS_CODE)  Os_ResumeAllInterruptsAPINonTrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         152,21
#$$ld
...
#$$bf	Os_ResumeAllInterruptsAPINonTrusted,interprocedural,rasave,nostackparams
	.globl		Os_ResumeAllInterruptsAPINonTrusted
	.d2_cfa_start __cie
Os_ResumeAllInterruptsAPINonTrusted:
	stwu		r1,-48(r1)		
...
#     OS_LIGHT_SYSCALL ( Os_ResumeAllInterruptCall, ResumeAllInterrupts );
	.d2line		157
	diab.addi		r3,r1,8
	lis		r4,Os_API_ResumeAllInterrupts@ha
	e_add16i		r4,r4,Os_API_ResumeAllInterrupts@l
	bl		OS_SYS_CALL
# }
	.d2line		158
	.d2epilogue_begin
...
#$$ld
.L11425:
	.type		Os_ResumeAllInterruptsAPINonTrusted,@function
	.size		Os_ResumeAllInterruptsAPINonTrusted,.-Os_ResumeAllInterruptsAPINonTrusted
# Number of nodes = 8

# Allocations for Os_ResumeAllInterruptsAPINonTrusted
#	SP,8		Os_ResumeAllInterruptCall
# OS_APILIGHT(ResumeAllInterrupts)
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_API_ResumeAllInterrupts,interprocedural,rasave,nostackparams
	.globl		Os_API_ResumeAllInterrupts
	.d2_cfa_start __cie
...
#      *
#      * [OS088-01-047] [OS088-01-048] [OS088-01-049] [OS088-01-050] [OS088-01-051]
#      * [OS088-01-052] [OS088-01-053] [OS088-01-054] [OS088-01-055] [OS088-01-056]
#      * [OS088-01-208] [OS088-01-231] [OS088-01-232] [OS-MGC-0055-05] [OS-MGC-0055-19]
#      */
# 
#   #ifdef OS_CONFIG_INTERRUPTSERVICE_VALIDATION
# 
...
#             {
#                 Os_TPTimer_Stop ( currentTask->Os_ProcLockAllTimerConf ); /* [OS037-05] */
#             }
#   #endif /* OS_MODULE_TIMINGPROTECTION */
# 
#             OS_SET_ISR_LEVEL_UM ( OS_GET_CORE_ISR_DYN_INIT ( coreID )->Os_SavedIsrLevel, coreID );
	.d2line		217
	lis		r4,Os_Core_Stat@ha
	e_add16i		r4,r4,Os_Core_Stat@l
	rlwinm		r5,r31,0,16,31		# coreID=r31
...
#$$ld
.L11441:
	.type		Os_API_ResumeAllInterrupts,@function
	.size		Os_API_ResumeAllInterrupts,.-Os_API_ResumeAllInterrupts
# Number of nodes = 267

# Allocations for Os_API_ResumeAllInterrupts
...
#$$ld
.L5:
.L11967:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11964:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11962:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11960:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11958:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11943:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11941:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11924:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
...
.L11802:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
...
.L11529:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
...
.L11448:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_PublicDataTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11394:
.L11402:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeAllInterrupts.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11434:
.L11442:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeAllInterrupts.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeAllInterrupts.c"
	.byte		0
...
.L11408:
	.sleb128	2
	.4byte		.L11405-.L11391
	.byte		"Os_ResumeAllInterruptsDefault"
	.byte		0
	.4byte		.L11402
	.uleb128	70
	.uleb128	22
...
.L11419:
	.sleb128	2
	.4byte		.L11416-.L11391
	.byte		"Os_ResumeAllInterruptsAPITrusted"
	.byte		0
	.4byte		.L11402
	.uleb128	84
	.uleb128	21
...
.L11426:
	.sleb128	2
	.4byte		.L11423-.L11391
	.byte		"Os_ResumeAllInterruptsAPINonTrusted"
	.byte		0
	.4byte		.L11402
	.uleb128	152
	.uleb128	21
...
.L11427:
	...
	.uleb128	154
	.uleb128	37
	.byte		"Os_ResumeAllInterruptCall"
	.byte		0
	.4byte		.L11428
	.sleb128	3
	.byte		0x92
...
.L11443:
	.sleb128	2
	.4byte		.L11439-.L11431
	.byte		"Os_API_ResumeAllInterrupts"
	.byte		0
	.4byte		.L11442
	.uleb128	169
	.uleb128	1
...
.L11446:
	...
	.wrcm.nelem "Os_API_ResumeAllInterrupts"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_ResumeAllInterruptsAPINonTrusted"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "OS_SYS_CALL"
	.wrcm.end
	.wrcm.nelem "Os_ResumeAllInterruptsAPITrusted"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_ResumeAllInterruptsDefault"
	.wrcm.nint32 "frameSize", 16
	.wrcm.end
	.wrcm.nelem "ResumeAllInterrupts"
	.wrcm.nint32 "frameSize", 16
