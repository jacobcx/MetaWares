...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"CanSM_CheckTransceiverWakeFlagIndication.c"
#$$dg 1
...
# FUNC(void,CANSM_CODE)CanSM_CheckTransceiverWakeFlagIndication(VAR(uint8,AUTOMATIC) Transceiver)
	.align		2
	.section	.text_vle
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanSM\\ssc\\make\\..\\src\\CanSM_CheckTransceiverWakeFlagIndication.c"
        .d2line         56,22
#$$ld
.L588:

#$$bf	CanSM_CheckTransceiverWakeFlagIndication,interprocedural,rasave,nostackparams
	.globl		CanSM_CheckTransceiverWakeFlagIndication
	.d2_cfa_start __cie
...
.Llo1:
	...
	.d2prologue_end
# {
#     /* <Requirements> CANSM416 CANSM417 CANSM418 <EndRequirements> */
# 
...
#             (void)Det_ReportError( CANSM_MODULE_ID, CANSM_INSTANCE_ID, CANSM_SID_CHECK_TRANSCEIVER_WAKE_FLAGINDICATION, CANSM_E_UNINIT );
# #endif
#     }
#     else
#     {
...
#                  */
#                 if((net->CanSMPartialNetworkSupport == TRUE) && (net->RAM->State == CANSM_ST_PNC_PN_WF_CC_NO_SLEEP))
	.d2line		80
...
.Llo7:
	se_cmpi		r0,19		# Transceiver=r0
	bc		0,2,.L580	# ne
#                 {
#                     /* Trigger state machine with the determined transition */
#                     (void)CanSM_ProcessSM(net->CanSMNetworkIndex, CANSM_PNC_PN_WF_CC_NO_SLEEP_TO_CANSM_ST_PNC_PN_CLR_WF, FALSE);
	.d2line		83
.Llo8:
...
#                     net->RAM->CanSM_TransceiverWakeFlagIndication = TRUE;
	.d2line		95
.Llo12:
	diab.li		r0,1		# Transceiver=r0
.Llo13:
	lwz		r3,0(r31)		# net=r3 net=r31
	stb		r0,30(r3)		# net=r3 Transceiver=r0
	.section	.text_vle
.L596:
.L575:
#                 }
...
#             (void)Det_ReportError( CANSM_MODULE_ID, CANSM_INSTANCE_ID, CANSM_SID_CHECK_TRANSCEIVER_WAKE_FLAGINDICATION, CANSM_E_PARAM_TRANSCEIVER );
#         }
# #endif
#     }
# }
...
#$$ld
.L589:
	.type		CanSM_CheckTransceiverWakeFlagIndication,@function
	.size		CanSM_CheckTransceiverWakeFlagIndication,.-CanSM_CheckTransceiverWakeFlagIndication
# Number of nodes = 77

# Allocations for CanSM_CheckTransceiverWakeFlagIndication
#	?a4		Transceiver
#	?a5		net
...
.L590:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanSM\\ssc\\make\\..\\src\\CanSM_CheckTransceiverWakeFlagIndication.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanSM\\ssc\\make\\..\\src\\CanSM_CheckTransceiverWakeFlagIndication.c"
	.byte		0
...
.L591:
	.sleb128	2
	.4byte		.L587-.L2
	.byte		"CanSM_CheckTransceiverWakeFlagIndication"
	.byte		0
	.4byte		.L590
	.uleb128	56
	.uleb128	22
...
.L604:
	...
	.wrcm.nelem "CanSM_CheckTransceiverWakeFlagIndication"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanSM_CheckTransceiverWakeFlagIndication.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\COM\CanSM\ssc\make\..\src\CanSM_CheckTransceiverWakeFlagIndication.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
