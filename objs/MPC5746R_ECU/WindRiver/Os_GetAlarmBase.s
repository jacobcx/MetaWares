...
.L11382:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\alarms\\Os_GetAlarmBase.c"
        .d2line         71,28
#$$ld
.L11389:

#$$bf	GetAlarmBase,interprocedural,rasave,nostackparams
	.globl		GetAlarmBase
	.d2_cfa_start __cie
GetAlarmBase:
.Llo1:
...
#         VAR (AlarmBaseRefType, AUTOMATIC)  value )
# {
#     VAR(Os_APICallType,AUTOMATIC) Os_GetAlarmBaseCall;
# 
#     Os_GetAlarmBaseCall.Os_API_Data.Os_ApiGetAlarmBase.AlarmID          =  alarmId;
	.d2line		77
	stw		r3,24(r1)		# alarmId=r3
#     Os_GetAlarmBaseCall.Os_API_Data.Os_ApiGetAlarmBase.AlarmBaseTypeRef =  value;
	.d2line		78
	stw		r4,28(r1)		# value=r4
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_GetAlarmBaseCall, GetAlarmBase );
	.d2line		81
	diab.addi		r3,r1,8		# alarmId=r3
.Llo2:
	lis		r4,Os_API_GetAlarmBase@ha		# value=r4
	e_add16i		r4,r4,Os_API_GetAlarmBase@l		# value=r4 value=r4
.Llo3:
	bl		OS_SYS_CALL
# 
#     return Os_GetAlarmBaseCall.Os_API_ReturnValue;
	.d2line		83
...
# Allocations for GetAlarmBase
#	?a4		alarmId
#	?a5		value
#	SP,8		Os_GetAlarmBaseCall
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_GetAlarmBase (
	.section	.Os_TEXT,,c
	.align		1
...
#$$bf	Os_GetAlarmBase,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_GetAlarmBase:
.Llo4:
	stwu		r1,-32(r1)		
...
#         VAR          (AlarmType,        AUTOMATIC)            alarmId,
#         VAR          (AlarmBaseRefType, AUTOMATIC)            valuePtr )
# {
...
.Llo9:
	...
	se_add		r30,r0		# alarmId=r30 alarmId=r30
	lwz		r3,4(r30)		# retVal=r3 alarmId=r30
.Llo17:
	mr		r3,r3		# alarmCounter=r3 alarmCounter=r3
# 
#         /* [OS001-129.v1] */
#         valuePtr->maxallowedvalue = Os_CounterGetMaxAllowedValue(alarmCounter);
	.d2line		171
	lwz		r0,4(r3)		# alarmCounter=r3
	stw		r0,0(r29)		# valuePtr=r29
#         valuePtr->mincycle        = Os_CounterGetMinCycle(alarmCounter);
	.d2line		172
	lwz		r0,8(r3)		# alarmCounter=r3
	stw		r0,8(r29)		# valuePtr=r29
#         valuePtr->ticksperbase    = Os_CounterGetTicksPerBase(alarmCounter);
	.d2line		173
	lwz		r0,12(r3)		# alarmCounter=r3
	stw		r0,4(r29)		# valuePtr=r29
	.section	.Os_TEXT,,c
.L11434:
.Llo10:
	b		.L11370
...
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_AlarmBaseRefType_Info = valuePtr;
	.d2line		182
	lis		r3,(Os_Core_DynShared+92)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+92)@l		# retVal=r3 retVal=r3
	stwx		r29,r3,r0		# retVal=r3 valuePtr=r29
# 
#         #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_GetAlarmBase, callerProc); /* [OS001-302.v1-14] */
	.d2line		186
...
#     return retVal;
	.d2line		188
.Llo7:
	rlwinm		r3,r28,0,24,31		# alarmCounter=r3 retVal=r28
# }
	.d2line		189
	.d2epilogue_begin
...
#$$ld
.L11420:
	.type		Os_GetAlarmBase,@function
	.size		Os_GetAlarmBase,.-Os_GetAlarmBase
# Number of nodes = 90

# Allocations for Os_GetAlarmBase
#	?a4		callerProc
#	?a5		alarmId
#	?a6		valuePtr
#	?a7		retVal
#	?a8		alarmCounter
#	?a9		coreId
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_GetAlarmBase_Err_Stat (
	.align		1
	.section	.Os_TEXT,,c
        .d2line         197,41
#$$ld
...
#$$bf	Os_GetAlarmBase_Err_Stat,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_GetAlarmBase_Err_Stat:
.Llo20:
	stwu		r1,-32(r1)		
	.d2_cfa_def_cfa_offset	32
	mfspr		r0,lr
...
#         CONSTP2CONST (AlarmBaseType,   AUTOMATIC, AUTOMATIC)  valuePtr)
# {
#     VAR (StatusType, AUTOMATIC ) retVal;
# 
...
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR,E_OS_PARAM_POINTER); /* [OS566-04] */
	.d2line		210
	diab.li		r4,14
.Llo26:
...
#                                                                 OS_SIZEOF(AlarmBaseType),
#                                                                 TRUE ) ) )
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR,E_OS_ILLEGAL_ADDRESS); /* [OS051-01-MGC-04] */
#         }
#       #endif /* OS_MODULE_MEMORYPROTECTION */
#         else
#         {
#             /* List of requirements that are not checked (automatically satisfied):
#              * [OS088-01-090] [OS088-01-091] [OS001-126.v1] [OS001-128.v1]
#              */
#             retVal = E_OK;
	.d2line		226
.Llo23:
...
#$$ld
.L11457:
	.type		Os_GetAlarmBase_Err_Stat,@function
	.size		Os_GetAlarmBase_Err_Stat,.-Os_GetAlarmBase_Err_Stat
# Number of nodes = 24

# Allocations for Os_GetAlarmBase_Err_Stat
#	?a4		callerProc
#	?a5		alarmId
#	?a6		valuePtr
#	?a7		retVal
# OS_APILIGHT(GetAlarmBase)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         95,1
#$$ld
...
#$$bf	Os_API_GetAlarmBase,interprocedural,rasave,nostackparams
	.globl		Os_API_GetAlarmBase
	.d2_cfa_start __cie
Os_API_GetAlarmBase:
.Llo28:
	stwu		r1,-48(r1)		
...
# {
#     VAR (StatusType, AUTOMATIC)         retVal;
#     CONST (AlarmType,AUTOMATIC)         alarmId = Os_APICall->Os_API_Data.Os_ApiGetAlarmBase.AlarmID;
	.d2line		98
	lwz		r29,16(r31)		# Os_APICall=r31
.Llo37:
	mr		r29,r29		# alarmId=r29 alarmId=r29
#     CONST (AlarmBaseRefType,AUTOMATIC)  TickPtr   = Os_APICall->Os_API_Data.Os_ApiGetAlarmBase.AlarmBaseTypeRef;
	.d2line		99
...
#   #endif
# 
#     OS_TRACE(GetAlarmBase_Entry , coreId);
	.d2line		105
	diab.li		r0,19
...
#     if ( OS_HOOKISNOT(  OS_HOOKID_NONE
	...
	se_cmpi		r0,0
	bc		0,2,.L11359	# ne
#                       | OS_HOOKID_ERRORHOOK     /* [OS088-01-092] */
#                       | OS_HOOKID_PRETASKHOOK   /* [OS088-01-093] */
#                       | OS_HOOKID_POSTTASKHOOK  /* [OS088-01-094] */
#                       | OS_HOOKID_APPERRORHOOK  /* [OS088-01-212] */
#                       | OS_HOOKID_PREAPPHOOK    /* [OS-MGC-0055-09] */
#                       | OS_HOOKID_POSTAPPHOOK   /* [OS-MGC-0055-23] */
#                       , coreId ) )
#     {
#         /* [OS088-03-093] [OS088-03-094] [OS088-03-095] [OS088-03-096] [OS088-03-390]
#          * [OS088-03-433] [OS088-04-MGC-016] [OS088-04-MGC-017] [OS088-04-MGC-018] [OS088-04-MGC-019]
#          * [OS088-04-MGC-067] [OS088-04-MGC-076]
#          */
...
#     {
#         /* [OS639-01-MGC] */
#         Os_APICall->Os_API_ReturnValue = Os_GetAlarmBase(callerProc, alarmId, TickPtr);
	.d2line		137
	mr		r3,r27		# callerProc=r3 callerProc=r27
	mr		r4,r29		# alarmId=r4 alarmId=r29
	mr		r5,r28		# TickPtr=r5 TickPtr=r28
...
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_AlarmBaseRefType_Info = TickPtr;
	.d2line		144
	lis		r3,(Os_Core_DynShared+92)@ha
	e_add16i		r3,r3,(Os_Core_DynShared+92)@l
...
#     }
# 
#     OS_TRACE(GetAlarmBase_Exit , coreId);
	.d2line		152
.Llo31:
	diab.li		r3,18
...
#$$ld
.L11471:
	.type		Os_API_GetAlarmBase,@function
	.size		Os_API_GetAlarmBase,.-Os_API_GetAlarmBase
# Number of nodes = 149

# Allocations for Os_API_GetAlarmBase
#	?a4		Os_APICall
#	?a5		retVal
#	?a6		alarmId
#	?a7		TickPtr
...
#$$ld
.L5:
.L12053:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L12050:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L12048:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L12046:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L12044:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L12024:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L12022:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L12005:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11985:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11942:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11917:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CounterCfgTypes.h"
.L11876:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11873:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
...
.L11505:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11494:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11487:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_AlarmCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11383:
.L11391:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\alarms\\Os_GetAlarmBase.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11413:
.L11421:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\alarms\\Os_GetAlarmBase.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\alarms\\Os_GetAlarmBase.c"
	.byte		0
...
.L11428:
	...
	.d2locend
.L11429:
	.d2locreg	%offsetof(.Llo4), %offsetof(.Llo8),4
	.d2locreg	%offsetof(.Llo9), %offsetof(.Llo10),30
	.d2locreg	%offsetof(.Llo6), %offsetof(.Llo7),30
	.d2locend
.L11430:
	.d2locreg	%offsetof(.Llo4), %offsetof(.Llo11),5
	.d2locreg	%offsetof(.Llo12), %offsetof(.Llo10),29
	.d2locreg	%offsetof(.Llo6), %offsetof(.Llo7),29
	.d2locend
.L11432:
	.d2locreg	%offsetof(.Llo4), %offsetof(.Llo13),28
	.d2locreg	%offsetof(.Llo14), %offsetof(.Llo12),3
	.d2locreg	%offsetof(.Llo15), %offsetof(.Llo16),28
	.d2locend
.L11443:
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo10),3
	.d2locend
.L11453:
...
.L11476:
	...
	.d2locreg	%offsetof(.Llo36), %offsetof(.Llo31),30
	.d2locend
.L11478:
	.d2locreg	%offsetof(.Llo37), %offsetof(.Llo31),29
	.d2locend
.L11481:
	.d2locreg	%offsetof(.Llo38), %offsetof(.Llo31),28
	.d2locend
.L11483:
	.d2locreg	%offsetof(.Llo39), %offsetof(.Llo31),27
	.d2locend
.L11485:
	.d2locreg	%offsetof(.Llo28), %offsetof(.Llo31),26
	.d2locreg	%offsetof(.Llo40), %offsetof(.Llo41),26
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetAlarmBase"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_GetAlarmBase","Os_GetAlarmBase_Err_Stat"
	.wrcm.end
	.wrcm.nelem "Os_GetAlarmBase_Err_Stat"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Alarm_Err_Stat"
	.wrcm.end
	.wrcm.nelem "Os_GetAlarmBase"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Alarm_Err_Dyn","Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "GetAlarmBase"
	.wrcm.nint32 "frameSize", 48
