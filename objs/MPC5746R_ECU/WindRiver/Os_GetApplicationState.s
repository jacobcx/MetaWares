...
#	?a4		coreId
# FUNC (StatusType, OS_CODE) GetApplicationState (  VAR(ApplicationType,         AUTOMATIC) application,
...
.L11400:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\application\\Os_GetApplicationState.c"
        .d2line         63,28
#$$ld
.L11407:

#$$bf	GetApplicationState,interprocedural,rasave,nostackparams
	.globl		GetApplicationState
	.d2_cfa_start __cie
GetApplicationState:
.Llo3:
	stwu		r1,-48(r1)		
	.d2_cfa_def_cfa_offset	48
	mfspr		r0,lr		# application=r0
	stw		r0,52(r1)		# application=r0
	.d2_cfa_offset    108,-1
...
# {
#     VAR (Os_APICallType, AUTOMATIC) Os_GetApplicationCall;
# 
#     Os_GetApplicationCall.Os_API_Data.Os_ApiGetApplicationState.Application = application;
	.d2line		68
	stb		r3,24(r1)		# application=r3
#     Os_GetApplicationCall.Os_API_Data.Os_ApiGetApplicationState.AppStateRef = value;
	.d2line		69
	stw		r4,28(r1)		# value=r4
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_GetApplicationCall, GetApplicationState );
	.d2line		72
	diab.addi		r3,r1,8		# application=r3
.Llo4:
	lis		r4,Os_API_GetApplicationState@ha		# value=r4
	e_add16i		r4,r4,Os_API_GetApplicationState@l		# value=r4 value=r4
.Llo5:
	bl		OS_SYS_CALL
# 
#     return Os_GetApplicationCall.Os_API_ReturnValue;
	.d2line		74
	lbz		r3,12(r1)		# application=r3
# }
	.d2line		75
	.d2epilogue_begin
	lwz		r0,52(r1)		# application=r0
	mtspr		lr,r0		# application=lr
	diab.addi		r1,r1,48		
	.d2_cfa_def_cfa_offset	0
	blr
#$$ef
...
#$$ld
.L11408:
	.type		GetApplicationState,@function
	.size		GetApplicationState,.-GetApplicationState
# Number of nodes = 28

# Allocations for GetApplicationState
#	?a4		application
#	?a5		value
#	SP,8		Os_GetApplicationCall
# LOCAL_INLINE FUNC(StatusType,OS_CODE) GetApplicationState_Err(VAR(ApplicationType, AUTOMATIC)               application,
	.section	.Os_TEXT,,c
	.align		1
	.section	.Os_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\application\\Os_GetApplicationState.c"
...
#$$bf	GetApplicationState_Err,interprocedural,rasave,nostackparams

# Regs written: r0,r1,r3,r4,r5,r6,r7,r31,cr0,lr
	.d2_cfa_start __cie
GetApplicationState_Err:
.Llo6:
	stwu		r1,-32(r1)		
	...
	stw		r0,36(r1)
	.d2_cfa_offset    108,-1
	mr		r7,r3		# application=r7 application=r3
	mr		r31,r4		# value=r31 value=r4
	.d2prologue_end
#                                                         P2CONST(ApplicationStateType, AUTOMATIC, AUTOMATIC) value,
...
# 
#     if( OS_HOOKID_ALARMCALLBACK == coreHookDyn->Os_HookID )
#     {
#         retVal =  OS_GET_ERRORCODE ( E_OS_SYS_ERROR, E_OS_CALLEVEL ); /* [OS088-03-290] [OS088-04-MGC-058] */
#     }
#     else
# 
#   #endif
...
.Llo10:
	...
	bc		1,2,.L11366	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_DISABLEDINT);    /* [OS093-01-41] [OS093-02-32] */
	.d2line		154
.Llo8:
...
.L11366:
#     }
#     else if((Os_ObjectType)application > Os_ApplicationRange[OS_CORE_NO - 1U].Os_ObjEndId)
	.d2line		156
	rlwinm		r7,r7,0,24,31		# application=r7 application=r7
	lis		r3,(Os_ApplicationRange+12)@ha
	lwz		r3,(Os_ApplicationRange+12)@l(r3)
	se_cmpl		r7,r3		# application=r7
	bc		0,1,.L11368	# le
#     {
#         retVal = OS_GET_ERRORCODE ( E_OS_SYS_ERROR, E_OS_ID ); /* [OS495-01] */
	.d2line		158
.Llo9:
...
#     else if(NULL_PTR == value)
	.d2line		160
	se_cmpi		r31,0		# value=r31
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_PARAM_POINTER); /* [OS566-11] */
	.d2line		162
...
#                                                                OS_CASTTOADDRESS(value),
#                                                                OS_SIZEOF(ApplicationStateType),
#                                                                TRUE ) ) )
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ILLEGAL_ADDRESS); /* [OS051-01-MGC-10] */
#     }
#   #endif
#     else
#     {
#         /* List of requirements that are not checked (automatically satisfied):
#          * [OS088-01-173] [OS088-01-174] [OS088-01-175] [OS088-01-176] [OS088-01-177]
#          * [OS088-01-178] [OS088-01-179] [OS088-01-180] [OS088-01-222] [OS088-01-242]
#          * [OS088-01-243] [OS-MGC-0055-13] [OS-MGC-0055-27]
#          */
#         retVal = E_OK;
	.d2line		180
.Llo11:
...
#$$ld
.L11426:
	.type		GetApplicationState_Err,@function
	.size		GetApplicationState_Err,.-GetApplicationState_Err
# Number of nodes = 42

# Allocations for GetApplicationState_Err
#	?a4		application
#	?a5		value
#	not allocated	callerTask
#	?a6		retVal
#	?a7		coreId
# OS_APILIGHT(GetApplicationState)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         87,1
#$$ld
...
#$$bf	Os_API_GetApplicationState,interprocedural,rasave,nostackparams
	.globl		Os_API_GetApplicationState
	.d2_cfa_start __cie
...
# {
#     VAR          (StatusType,              AUTOMATIC)            retVal;
#     VAR          (ApplicationType,         AUTOMATIC)            app;
#     VAR          (ApplicationStateRefType, AUTOMATIC)            valueref;
#     CONST        (CoreIdType,              AUTOMATIC)            coreId     = OS_GETCOREID();
	.d2line		92
.Llo16:
...
#     CONSTP2CONST (Os_ProcStatType,         AUTOMATIC, OS_CONST)  callerProc = OS_SCHEDULER_GET_CURRENT_PROC ( coreId );
	.d2line		93
	lis		r3,Os_Core_Stat@ha		# retVal=r3
.Llo19:
	e_add16i		r3,r3,Os_Core_Stat@l		# retVal=r3 retVal=r3
	rlwinm		r0,r29,0,16,31		# coreId=r29
	e_mulli		r4,r0,20
	lwzx		r3,r3,r4		# retVal=r3 retVal=r3
	lwz		r8,28(r3)		# retVal=r3
.Llo33:
	mr		r8,r8		# callerProc=r8 callerProc=r8
# 
#     OS_TRACE (GetApplicationState_Entry , coreId);
	.d2line		95
	diab.li		r4,3
...
# 
#     app      = Os_APICall->Os_API_Data.Os_ApiGetApplicationState.Application;
	.d2line		97
	lbz		r28,16(r31)		# Os_APICall=r31
.Llo26:
	mr		r28,r28		# app=r28 app=r28
#     valueref = Os_APICall->Os_API_Data.Os_ApiGetApplicationState.AppStateRef;
	.d2line		98
	lwz		r27,20(r31)		# Os_APICall=r31
.Llo30:
	mr		r27,r27		# valueref=r27 valueref=r27
# 
#     /* Validate API access and parameters */
#     retVal = GetApplicationState_Err(app, valueref, callerProc);
	.d2line		101
	mr		r3,r28		# app=r3 app=r28
.Llo20:
	mr		r4,r27		# valueref=r4 valueref=r27
	mr		r5,r8		# callerProc=r5 callerProc=r8
	bl		GetApplicationState_Err
.Llo21:
...
#     if( E_OK == retVal)
	...
	bc		0,2,.L11360	# ne
#     {
#         *valueref = Os_Applications_Stat[app].Os_AppDyn->Os_AppState;
	.d2line		106
.Llo22:
	rlwinm		r28,r28,0,24,31		# app=r28 app=r28
.Llo23:
	lis		r3,Os_Applications_Stat@ha		# retVal=r3
	e_add16i		r3,r3,Os_Applications_Stat@l		# retVal=r3 retVal=r3
	rlwinm		r0,r28,6,0,25		# app=r28
	se_slwi		r28,4		# app=r28 app=r28
	subf		r28,r28,r0		# app=r28 app=r28
.Llo27:
	lwzx		r3,r3,r28		# retVal=r3 retVal=r3
	lbz		r0,0(r3)		# retVal=r3
	stb		r0,0(r27)		# valueref=r27
	b		.L11361
.L11360:
#     }
#     else
...
# 
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_ApplID           = app;
	.d2line		112
.Llo28:
	...
	rlwinm		r0,r29,0,16,31		# coreId=r29
	e_mulli		r0,r0,152
	stbux		r28,r3,r0		# retVal=r3 app=r28
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_ApplStateRefType = valueref;
	.d2line		113
	lis		r3,(Os_Core_DynShared+56)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+56)@l		# retVal=r3 retVal=r3
	stwx		r27,r3,r0		# retVal=r3 valueref=r27
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_GetApplicationState,callerProc); /* [OS001-302.v1-33] */
	.d2line		117
...
# 
#     OS_TRACE (GetApplicationState_Exit , coreId);
	.d2line		122
...
#$$ld
.L11444:
	.type		Os_API_GetApplicationState,@function
	.size		Os_API_GetApplicationState,.-Os_API_GetApplicationState
# Number of nodes = 123

# Allocations for Os_API_GetApplicationState
#	?a4		Os_APICall
#	?a5		$$2352
#	?a6		retVal
#	?a7		app
...
#$$ld
.L5:
.L11963:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11960:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11958:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11956:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11954:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11942:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
.L11937:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11934:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11917:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11897:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11805:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11802:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11777:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
.L11539:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
...
.L11460:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11380:
.L11427:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\application\\Os_GetApplicationState.c"
.L11388:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11401:
.L11409:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\application\\Os_GetApplicationState.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\application\\Os_GetApplicationState.c"
	.byte		0
...
.L11445:
	.sleb128	8
	.4byte		.L11442-.L11377
	.byte		"Os_API_GetApplicationState"
	.byte		0
	.4byte		.L11427
	.uleb128	87
	.uleb128	1
...
.L11432:
	...
	.d2locreg	%offsetof(.Llo8), %offsetof(.Llo11),31
	.d2locend
.L11438:
	...
	.d2locend
.L11440:
	.d2locreg	%offsetof(.Llo7), %offsetof(.Llo14),3
	.d2locend
.L11447:
...
.L11449:
	...
	.d2locreg	%offsetof(.Llo23), %offsetof(.Llo18),30
...
.L11451:
	...
	.d2locend
.L11453:
	.d2locreg	%offsetof(.Llo30), %offsetof(.Llo29),27
	.d2locend
.L11455:
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo29),29
	.d2locreg	%offsetof(.Llo31), %offsetof(.Llo32),29
	.d2locend
.L11458:
	.d2locreg	%offsetof(.Llo33), %offsetof(.Llo29),8
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetApplicationState"
	.wrcm.nstrlist "calls", "GetApplicationState_Err","Os_Call_ErrorHook"
	.wrcm.nint32 "frameSize", 48
	.wrcm.end
	.wrcm.nelem "GetApplicationState_Err"
	.wrcm.nstrlist "calls", "Os_Isr_GetState"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nint32 "local", 1
	.wrcm.end
	.wrcm.nelem "GetApplicationState"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetApplicationState.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\application\Os_GetApplicationState.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
