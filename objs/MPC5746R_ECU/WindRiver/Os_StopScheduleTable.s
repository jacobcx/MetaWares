...
.L4:
	...
	.section	.text_vle
# FUNC(StatusType, OS_CODE) StopScheduleTable(VAR(ScheduleTableType, AUTOMATIC) schTblId)
...
.L11395:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StopScheduleTable.c"
        .d2line         70,27
#$$ld
.L11402:

#$$bf	StopScheduleTable,interprocedural,rasave,nostackparams
	.globl		StopScheduleTable
	.d2_cfa_start __cie
StopScheduleTable:
.Llo1:
	stwu		r1,-48(r1)		
	.d2_cfa_def_cfa_offset	48
	mfspr		r0,lr		# schTblId=r0
	stw		r0,52(r1)		# schTblId=r0
	.d2_cfa_offset    108,-1
	mr		r0,r3		# schTblId=r0 schTblId=r3
	.d2prologue_end
# {
#     VAR (Os_APICallType, AUTOMATIC) Os_StopScheduleTableAPI_Call;
# 
#     OS_API_ALLOC(Os_StopScheduleTableAPI_Call,StopScheduleTable);
	.d2line		74
.Llo2:
	e_lis		r3,4660
.Llo3:
	e_or2i		r3,22136
	stw		r3,8(r1)
	lis		r3,Os_API_StopScheduleTable@ha
	e_add16i		r3,r3,Os_API_StopScheduleTable@l
	stw		r3,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
# 
#     Os_StopScheduleTableAPI_Call.Os_API_Data.Os_ApiStopScheduleTable.SchTblId = schTblId;
	.d2line		76
	stw		r0,24(r1)		# schTblId=r0
# 
#     OS_SYSCALL(Os_StopScheduleTableAPI_Call);
	.d2line		78
	diab.addi		r3,r1,8
	bl		OS_SYS_CALL
# 
#     return Os_StopScheduleTableAPI_Call.Os_API_ReturnValue;
	.d2line		80
.Llo4:
	lbz		r3,12(r1)
# }
...
# Allocations for StopScheduleTable
#	?a4		schTblId
#	SP,8		Os_StopScheduleTableAPI_Call
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_StopScheduleTable_Err_Dyn(
	.section	.Os_TEXT,,c
	.align		1
...
#$$bf	Os_StopScheduleTable_Err_Dyn,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_StopScheduleTable_Err_Dyn:
.Llo5:
	stwu		r1,-32(r1)		
...
#$$ld
.L11427:
	.type		Os_StopScheduleTable_Err_Dyn,@function
	.size		Os_StopScheduleTable_Err_Dyn,.-Os_StopScheduleTable_Err_Dyn
# Number of nodes = 32

# Allocations for Os_StopScheduleTable_Err_Dyn
#	?a4		callerProc
#	?a5		schTblId
#	?a6		retVal
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_StopScheduleTable(
	.align		1
	.section	.Os_TEXT,,c
        .d2line         163,40
#$$ld
...
#$$bf	Os_StopScheduleTable,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
...
#     VAR (StatusType, AUTOMATIC) retVal;
# 
#     retVal = Os_StopScheduleTable_Err_Dyn(callerProc,schTblId);
	.d2line		170
	mr		r3,r31		# callerProc=r3 callerProc=r31
.Llo19:
	mr		r4,r30		# schTblId=r4 schTblId=r30
.Llo22:
	bl		Os_StopScheduleTable_Err_Dyn
...
.L11448:
#     {
#         CONSTP2VAR(Os_SchTblDynType, AUTOMATIC, OS_VAR)  schTblRegistry = Os_SchTblStat[schTblId].Os_SchTblRegistry;
	.d2line		174
.Llo23:
	lis		r3,Os_SchTblStat@ha		# retVal=r3
.Llo29:
	lwz		r4,Os_SchTblStat@l(r3)		# retVal=r3
	e_mulli		r5,r30,40		# schTblId=r30
	se_add		r4,r5
	lwz		r31,24(r4)		# retVal=r31
.Llo31:
	mr		r31,r31		# schTblRegistry=r31 schTblRegistry=r31
#         VAR (ScheduleTableType,AUTOMATIC)                nextSchTblId;
# 
#         if ( SCHEDULETABLE_WAITING != Os_SchTblGetStatus ( schTblId ) )
	.d2line		177
...
#             Os_CounterCancelIndication(Os_SchTblStat[schTblId].Os_SchTblCounter,
	...
	e_mulli		r4,r30,40		# schTblId=r30
	lwzx		r3,r3,r4		# retVal=r3 retVal=r3
	mr		r5,r30		# schTblId=r5 schTblId=r30
	diab.li		r4,2
...
#         {
#             CONST(ScheduleTableStatusType, AUTOMATIC) prevSchTblStatus = schTblRegistry->Os_SchTblStatus;
#       #endif
# 
#         schTblRegistry->Os_SchTblStatus = SCHEDULETABLE_STOPPED;
	.d2line		189
	diab.li		r0,0		# nextSchTblId=r0
.Llo33:
	stw		r0,0(r31)		# schTblRegistry=r31 nextSchTblId=r0
# 
#       #ifdef OS_CONFIG_RTM_SCHEDULETABLES
# 
...
# 
#         schTblRegistry->Os_SchTblNextEP = NULL_PTR;
	.d2line		219
	stw		r0,4(r31)		# schTblRegistry=r31 nextSchTblId=r0
# 
#       #ifdef OS_MODULE_SCHEDULETABLE_SYNC
#         schTblRegistry->Os_SchTblDeviation            =  OS_SCHTBLDEVIATION_INVALID;
#       #endif /* OS_MODULE_SCHEDULETABLE_SYNC */
# 
#         /* Check if there is any (repeating/next) SchTbl registered*/
#         nextSchTblId = schTblRegistry->Os_SchTblNextSchTblId;
	.d2line		226
	lwz		r0,8(r31)		# nextSchTblId=r0 schTblRegistry=r31
...
#         {
#             /* [OS414-04] */
#             schTblRegistry->Os_SchTblNextSchTblId = OS_INVALID_SCHTBL;
	.d2line		230
.Llo24:
	diab.li		r3,-1		# retVal=r3
	stw		r3,8(r31)		# schTblRegistry=r31 retVal=r3
#             Os_SchTblStat[nextSchTblId].Os_SchTblRegistry->Os_SchTblNextSchTblBack = NULL_PTR;
	.d2line		231
	diab.li		r5,0		# schTblId=r5
.Llo25:
	lis		r3,Os_SchTblStat@ha		# retVal=r3
	lwz		r4,Os_SchTblStat@l(r3)		# retVal=r3
	e_mulli		r6,r0,40		# nextSchTblId=r0
	se_add		r4,r6
	lwz		r4,24(r4)
	stw		r5,12(r4)		# schTblId=r5
# 
...
#             if (Os_SchTblStat[nextSchTblId].Os_SchTblRegistry->Os_SchTblStatus == SCHEDULETABLE_NEXT)
	.d2line		234
	lwz		r3,Os_SchTblStat@l(r3)		# retVal=r3 retVal=r3
	se_add		r6,r3		# retVal=r3
	lwz		r3,24(r6)		# retVal=r3
...
#         }
# 
#         /* Delete reference as a next schedule table */
#         if ( NULL_PTR != schTblRegistry->Os_SchTblNextSchTblBack )
	.d2line		244
.Llo35:
	lwz		r0,12(r31)		# nextSchTblId=r0 schTblRegistry=r31
.Llo36:
	se_cmpi		r0,0		# nextSchTblId=r0
	bc		1,2,.L11381	# eq
#         {
#             schTblRegistry->Os_SchTblNextSchTblBack->Os_SchTblRegistry->Os_SchTblNextSchTblId = OS_INVALID_SCHTBL;
	.d2line		246
.Llo37:
	diab.li		r0,-1		# nextSchTblId=r0
.Llo38:
	lwz		r3,12(r31)		# retVal=r3 schTblRegistry=r31
	lwz		r3,24(r3)		# retVal=r3 retVal=r3
	stw		r0,8(r3)		# retVal=r3 nextSchTblId=r0
#             schTblRegistry->Os_SchTblNextSchTblBack = NULL_PTR;
	.d2line		247
	diab.li		r0,0		# nextSchTblId=r0
	stw		r0,12(r31)		# schTblRegistry=r31 nextSchTblId=r0
	.section	.Os_TEXT,,c
.L11449:
.Llo32:
	b		.L11381
...
.Llo40:
	stwx		r30,r3,r0		# retVal=r3 schTblId=r30
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_StopScheduleTable,callerProc); /* [OS001-302.v1-22] */
	.d2line		260
...
#$$ld
.L11442:
	.type		Os_StopScheduleTable,@function
	.size		Os_StopScheduleTable,.-Os_StopScheduleTable
# Number of nodes = 161

# Allocations for Os_StopScheduleTable
#	?a4		callerProc
#	?a5		schTblId
#	?a6		retVal
#	?a7		schTblRegistry
...
#$$bf	Os_API_StopScheduleTable,interprocedural,rasave,nostackparams
	.globl		Os_API_StopScheduleTable
	.d2_cfa_start __cie
...
#     CONST (ScheduleTableType, AUTOMATIC)  schTblId = Os_APICall->Os_API_Data.Os_ApiStopScheduleTable.SchTblId;
	.d2line		98
.Llo50:
...
# 
#     OS_TRACE(StopScheduleTable_Entry , coreId);
	.d2line		104
	diab.li		r0,23		# retVal=r0
.Llo51:
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN ( coreId )->Os_HookID)
	...
	bc		1,2,.L11362	# eq
#     {
#         /* [OS088-03-202] [OS088-03-203] [OS088-03-204] [OS088-03-205] [OS088-03-206]
#          * [OS088-03-207] [OS088-03-208] [OS088-03-361] [OS088-03-404] [OS088-03-448]
#          * [OS-MGC-0056-24] [OS-MGC-0056-67]
#          */
...
#         {
#             /*[OS646-01-MGC]*/
#             OS_API_ALLOCAPIREMULTI(StopScheduleTable, coreId, Os_SchTblStat[schTblId].Os_SchTblCounter->Os_CounterCoreId);
	.d2line		132
.Llo48:
...
.Llo70:
	lis		r3,Os_API_MC_StopScheduleTable@ha		# retVal=r3
.Llo57:
	e_add16i		r3,r3,Os_API_MC_StopScheduleTable@l		# retVal=r3 retVal=r3
...
# #endif
#         {
#             Os_APICall->Os_API_ReturnValue = Os_StopScheduleTable(callerProc, schTblId);
	.d2line		137
.Llo45:
	mr		r3,r30		# callerProc=r3 callerProc=r30
	mr		r4,r28		# schTblId=r4 schTblId=r28
	bl		Os_StopScheduleTable
.Llo60:
...
.Llo62:
	...
	rlwinm		r5,r27,0,16,31		# coreId=r27
	e_mulli		r5,r5,152
	stwx		r28,r3,r5		# retVal=r3 schTblId=r28
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_StopScheduleTable, callerProc); /* [OS001-302.v1-22] */
...
#     }
# 
#     OS_TRACE(StopScheduleTable_Exit , coreId);
	.d2line		152
.Llo46:
	diab.li		r3,22		# retVal=r3
.Llo63:
...
#$$ld
.L11473:
	.type		Os_API_StopScheduleTable,@function
	.size		Os_API_StopScheduleTable,.-Os_API_StopScheduleTable
# Number of nodes = 185

# Allocations for Os_API_StopScheduleTable
#	?a4		Os_APICall
#	?a5		callerProc
#	?a6		retVal
#	?a7		schTblId
...
#$$bf	Os_API_MC_StopScheduleTable,interprocedural,rasave,nostackparams
	.globl		Os_API_MC_StopScheduleTable
	.d2_cfa_start __cie
Os_API_MC_StopScheduleTable:
.Llo72:
	stwu		r1,-32(r1)		
	.d2_cfa_def_cfa_offset	32
	mfspr		r0,lr
...
.Llo73:
	...
	.d2prologue_end
# {
#     Os_APICall->Os_API_ReturnValue = Os_StopScheduleTable( callerProc,
	.d2line		158
.Llo74:
...
#                                                            Os_APICall->Os_API_Data.Os_ApiStopScheduleTable.SchTblId );
# }
	.d2line		160
	.d2epilogue_begin
	lwz		r31,28(r1)		# offset r1+28  0x1c
...
#$$ld
.L11499:
	.type		Os_API_MC_StopScheduleTable,@function
	.size		Os_API_MC_StopScheduleTable,.-Os_API_MC_StopScheduleTable
# Number of nodes = 14

# Allocations for Os_API_MC_StopScheduleTable
#	?a4		Os_APICall
#	?a5		callerProc
...
#$$ld
.L5:
.L12066:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L12063:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L12061:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L12059:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L12057:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L12038:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L12036:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L12019:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11999:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11955:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11930:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CounterCfgTypes.h"
.L11889:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11886:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11814:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
.L11574:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
.L11522:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11511:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11504:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ScheduleTableCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11396:
.L11404:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StopScheduleTable.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11420:
.L11428:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StopScheduleTable.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StopScheduleTable.c"
	.byte		0
...
.L11413:
	...
	.uleb128	72
	.uleb128	37
	.byte		"Os_StopScheduleTableAPI_Call"
	.byte		0
	.4byte		.L11414
	.sleb128	3
	.byte		0x92
...
.L11429:
	.sleb128	5
	.4byte		.L11425-.L11417
	.byte		"Os_StopScheduleTable_Err_Dyn"
	.byte		0
	.4byte		.L11428
	.uleb128	272
	.uleb128	40
...
.L11500:
	.sleb128	8
	.4byte		.L11497-.L11417
	.byte		"Os_API_MC_StopScheduleTable"
	.byte		0
	.4byte		.L11428
	.uleb128	156
	.uleb128	1
...
.L11438:
	...
	.d2locreg	%offsetof(.Llo13), %offsetof(.Llo9),4
...
.L11445:
	...
	.d2locend
.L11447:
	.d2locreg	%offsetof(.Llo18), %offsetof(.Llo27),29
	.d2locreg	%offsetof(.Llo28), %offsetof(.Llo23),3
...
.L11457:
	...
	.d2locend
.L11459:
	.d2locreg	%offsetof(.Llo33), %offsetof(.Llo26),0
	.d2locreg	%offsetof(.Llo34), %offsetof(.Llo35),0
	.d2locreg	%offsetof(.Llo36), %offsetof(.Llo37),0
	.d2locreg	%offsetof(.Llo38), %offsetof(.Llo32),0
	.d2locend
.L11469:
...
.L11476:
	...
	.d2locend
.L11480:
	.d2locreg	%offsetof(.Llo41), %offsetof(.Llo47),4
	.d2locreg	%offsetof(.Llo43), %offsetof(.Llo48),30
	.d2locreg	%offsetof(.Llo45), %offsetof(.Llo46),30
	.d2locend
.L11482:
	.d2locreg	%offsetof(.Llo49), %offsetof(.Llo50),0
	.d2locreg	%offsetof(.Llo51), %offsetof(.Llo43),0
	.d2locreg	%offsetof(.Llo52), %offsetof(.Llo53),0
	.d2locreg	%offsetof(.Llo54), %offsetof(.Llo55),3
	.d2locreg	%offsetof(.Llo56), %offsetof(.Llo48),29
	.d2locreg	%offsetof(.Llo57), %offsetof(.Llo58),3
	.d2locreg	%offsetof(.Llo59), %offsetof(.Llo44),0
	.d2locreg	%offsetof(.Llo60), %offsetof(.Llo61),3
	.d2locreg	%offsetof(.Llo62), %offsetof(.Llo46),29
	.d2locreg	%offsetof(.Llo63), %offsetof(.Llo64),3
	.d2locend
.L11484:
	.d2locreg	%offsetof(.Llo65), %offsetof(.Llo48),28
	.d2locreg	%offsetof(.Llo59), %offsetof(.Llo66),28
	.d2locreg	%offsetof(.Llo45), %offsetof(.Llo46),28
	.d2locend
.L11486:
	.d2locreg	%offsetof(.Llo41), %offsetof(.Llo46),27
	.d2locreg	%offsetof(.Llo67), %offsetof(.Llo68),27
	.d2locend
.L11495:
	.d2locreg	%offsetof(.Llo69), %offsetof(.Llo70),3
	.d2locreg	%offsetof(.Llo57), %offsetof(.Llo44),4
...
.L11502:
	...
	.wrcm.nelem "Os_API_MC_StopScheduleTable"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_StopScheduleTable"
	.wrcm.end
	.wrcm.nelem "Os_API_StopScheduleTable"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_Dispatcher_Alloc_Core","Os_SchTbl_Err_Stat","Os_ShutdownAllCores","Os_StopScheduleTable"
	.wrcm.end
	.wrcm.nelem "Os_StopScheduleTable"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_CounterCancelIndication","Os_StopScheduleTable_Err_Dyn"
	.wrcm.end
	.wrcm.nelem "Os_StopScheduleTable_Err_Dyn"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_SchTbl_Err_Dyn"
	.wrcm.end
	.wrcm.nelem "StopScheduleTable"
	.wrcm.nint32 "frameSize", 48
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StopScheduleTable.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\expiry_element\schedule_table\Os_StopScheduleTable.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
