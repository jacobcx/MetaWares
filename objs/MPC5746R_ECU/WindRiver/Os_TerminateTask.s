...
.L11398:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_TerminateTask.c"
        .d2line         58,28
#$$ld
.L11405:

#$$bf	TerminateTask,interprocedural,rasave,nostackparams
	.globl		TerminateTask
	.d2_cfa_start __cie
TerminateTask:
	stwu		r1,-48(r1)		
	...
	.d2prologue_end
# {
#     VAR(Os_APICallType,AUTOMATIC)  Os_TermiateTaskCall;
# 
#     OS_API_ALLOC(Os_TermiateTaskCall,TerminateTask);
	.d2line		62
	e_lis		r0,4660
	e_or2i		r0,22136
	stw		r0,8(r1)
	lis		r3,Os_API_TerminateTask@ha
	e_add16i		r3,r3,Os_API_TerminateTask@l
	stw		r3,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
# 
#     OS_SYSCALL(Os_TermiateTaskCall);
	.d2line		64
	diab.addi		r3,r1,8
	bl		OS_SYS_CALL
# 
#     return Os_TermiateTaskCall.Os_API_ReturnValue;
	.d2line		66
	lbz		r3,12(r1)
# }
	.d2line		67
...
# Allocations for TerminateTask
#	SP,8		Os_TermiateTaskCall
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_TerminateTask_Err(P2CONST(Os_ProcStatType,AUTOMATIC,OS_CONST) proc)
	.section	.Os_TEXT,,c
	.align		1
	.section	.Os_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_TerminateTask.c"
...
#$$bf	Os_TerminateTask_Err,interprocedural,rasave,nostackparams

# Regs written: r0,r1,r3,r4,r5,r6,r7,cr0,lr
	.d2_cfa_start __cie
Os_TerminateTask_Err:
.Llo3:
	stwu		r1,-16(r1)		
	.d2_cfa_def_cfa_offset	16
	mfspr		r0,lr
...
#     if(proc->Os_ProcKind != Os_Proc_Task)
	.d2line		131
	lwz		r0,16(r7)		# proc=r7
	se_cmpi		r0,0
	bc		1,2,.L11361	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_CALLEVEL); /* [OS088-03-010] [OS001-017.v1] */
	.d2line		133
.Llo4:
...
.Llo7:
	...
	bc		1,2,.L11363	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_DISABLEDINT); /* [OS093-01-02] [OS093-02-02] */
	.d2line		137
...
# 
#     else if(proc->Os_ProcDyn->Os_ProcResourcesAllocated > 0)
	.d2line		142
.Llo9:
	lwz		r3,8(r7)		# proc=r7
	lwz		r0,28(r3)
	...
	bc		1,2,.L11365	# eq
#     {
#         retVal = E_OS_RESOURCE; /* [OS001-016.v1] */
	.d2line		144
...
# 
#     else if(proc->Os_ProcDyn->Os_ProcSpinlock != NULL_PTR)
	.d2line		155
.Llo11:
	lwz		r3,8(r7)		# proc=r7
...
#$$ld
.L11418:
	.type		Os_TerminateTask_Err,@function
	.size		Os_TerminateTask_Err,.-Os_TerminateTask_Err
# Number of nodes = 56

# Allocations for Os_TerminateTask_Err
#	?a4		proc
#	?a5		retVal
# OS_API(TerminateTask)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         81,1
#$$ld
...
#$$bf	Os_API_TerminateTask,interprocedural,rasave,nostackparams
	.globl		Os_API_TerminateTask
	.d2_cfa_start __cie
...
# 
#     OS_TRACE(TerminateTask_Entry , coreId);
	.d2line		88
	diab.li		r0,57		# retVal=r0
.Llo21:
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN(coreId)->Os_HookID)
	...
	bc		1,2,.L11352	# eq
#     {
#         /* [OS088-03-011] [OS088-03-012] [OS088-03-013] [OS088-03-014] [OS088-03-015]
#          * [OS088-03-016] [OS088-03-017] [OS088-03-346] [OS088-03-346] [OS088-03-379]
#          * [OS088-03-422] [OS-MGC-0056-02] [OS-MGC-0056-45]
#          */
...
#   #endif
# 
#     retVal = Os_TerminateTask_Err(callerProc);
	.d2line		104
	mr		r3,r30		# callerProc=r3 callerProc=r30
	bl		Os_TerminateTask_Err
.Llo24:
...
#     if(E_OK == retVal)
	...
	bc		0,2,.L11354	# ne
#     {
#         Os_Task_Terminate(callerProc); /* [OS001-014.v1] [OS001-015.v1] [OS001-033.v1] */
	.d2line		109
.Llo25:
	mr		r3,r30		# callerProc=r3 callerProc=r30
.Llo26:
...
#     else
#     {
#         /* Calling the function to perform error handling */
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_TerminateTask, callerProc); /* [OS001-302.v1-02] */
	.d2line		114
...
#     }
# 
#     OS_TRACE(TerminateTask_Exit , coreId);
	.d2line		118
.Llo17:
	diab.li		r3,56		# retVal=r3
.Llo27:
...
#$$ld
.L11431:
	.type		Os_API_TerminateTask,@function
	.size		Os_API_TerminateTask,.-Os_API_TerminateTask
# Number of nodes = 100

# Allocations for Os_API_TerminateTask
#	?a4		Os_APICall
#	?a5		callerProc
#	?a6		retVal
#	?a7		coreId
...
#$$ld
.L5:
.L11939:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11936:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11934:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11932:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11930:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11918:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
.L11913:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11911:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11894:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11874:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11829:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11781:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11778:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11753:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
...
#$$ld
.L11378:
.L11419:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_TerminateTask.c"
.L11386:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11399:
.L11407:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_TerminateTask.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_TerminateTask.c"
	.byte		0
...
.L11440:
	...
	.d2locreg	%offsetof(.Llo21), %offsetof(.Llo16),0
	.d2locreg	%offsetof(.Llo22), %offsetof(.Llo23),0
	.d2locreg	%offsetof(.Llo24), %offsetof(.Llo25),3
	.d2locreg	%offsetof(.Llo26), %offsetof(.Llo17),29
	.d2locreg	%offsetof(.Llo27), %offsetof(.Llo28),3
	.d2locend
.L11442:
	.d2locreg	%offsetof(.Llo14), %offsetof(.Llo17),28
	...
	.wrcm.nelem "Os_API_TerminateTask"
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_ShutdownAllCores","Os_Task_Terminate","Os_TerminateTask_Err"
	.wrcm.nint32 "frameSize", 32
	.wrcm.end
	.wrcm.nelem "Os_TerminateTask_Err"
	.wrcm.nstrlist "calls", "Os_Isr_GetState"
	.wrcm.nint32 "frameSize", 16
	.wrcm.nint32 "local", 1
	.wrcm.end
	.wrcm.nelem "TerminateTask"
