...
.L11378:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\isr\\Os_GetISRID.c"
        .d2line         48,25
#$$ld
.L11385:

#$$bf	GetISRID,interprocedural,rasave,nostackparams
	.globl		GetISRID
	.d2_cfa_start __cie
GetISRID:
	stwu		r1,-48(r1)		
	...
	.d2prologue_end
# {
#     VAR(Os_APICallType,AUTOMATIC) Os_GetISRIDCall;
# 
#     OS_LIGHT_SYSCALL ( Os_GetISRIDCall, GetISRID );/* Taking address of function on purpose */
	.d2line		52
	diab.addi		r3,r1,8
	lis		r4,Os_API_GetISRID@ha
	e_add16i		r4,r4,Os_API_GetISRID@l
	bl		OS_SYS_CALL
# 
#     return Os_GetISRIDCall.Os_API_Data.Os_ApiGetISRID.ISRId;
	.d2line		54
	lwz		r3,24(r1)
# }
	.d2line		55
...
# Allocations for GetISRID
#	SP,8		Os_GetISRIDCall
# OS_APILIGHT(GetISRID)
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_API_GetISRID,interprocedural,nostackparams

# Regs written: r0,r1,r3,r4,r5,r6,r7,cr0,lr
	.globl		Os_API_GetISRID
	.d2_cfa_start __cie
Os_API_GetISRID:
.Llo1:
	stwu		r1,-16(r1)		
...
# 
#     OS_TRACE(GetISRID_Entry , coreId);
	.d2line		71
	diab.li		r0,71
	lis		r5,(Os_Core_DynShared+120)@ha
	e_add16i		r5,r5,(Os_Core_DynShared+120)@l
	rlwinm		r7,r4,0,16,31		# coreId=r4
	e_mulli		r6,r7,152
	stbx		r0,r5,r6
# 
...
#     if ( OS_HOOKISNOT(  OS_HOOKID_NONE
	...
	se_cmpi		r0,0
	bc		0,2,.L11359	# ne
#                       | OS_HOOKID_ERRORHOOK       /* [OS088-01-127] */
#                       | OS_HOOKID_PROTECTIONHOOK  /* [OS088-01-128] */
#                       | OS_HOOKID_APPERRORHOOK    /* [OS088-01-217] */
#                       , coreId))
#     {
#         /* [OS088-03-148] [OS088-03-149] [OS088-03-150] [OS088-03-151] [OS088-03-152]
#          * [OS088-03-396] [OS088-03-440] [OS-MGC-0056-16] [OS-MGC-0056-59]
#          */
#         Os_APICall->Os_API_Data.Os_ApiGetISRID.ISRId = INVALID_ISR;
	.d2line		85
	diab.li		r0,-1
	stw		r0,16(r3)		# Os_APICall=r3
	b		.L11360
.L11359:
	.section	.Os_TEXT,,c
.L11419:
...
#          * [OS088-01-125] [OS088-01-126]
#          */
#         CONSTP2CONST(Os_ProcStatType,AUTOMATIC ,OS_CONST)  callerProc = OS_SCHEDULER_GET_CURRENT_PROC(coreId);
	.d2line		97
	lis		r5,Os_Core_Stat@ha		# callerProc=r5
.Llo10:
	e_add16i		r5,r5,Os_Core_Stat@l		# callerProc=r5 callerProc=r5
	rlwinm		r7,r4,0,16,31		# coreId=r4
	e_mulli		r7,r7,20
	lwzx		r5,r5,r7		# callerProc=r5 callerProc=r5
	lwz		r5,28(r5)		# callerProc=r5 callerProc=r5
	mr		r5,r5		# callerProc=r5 callerProc=r5
#         if (callerProc->Os_ProcKind == Os_Proc_ISR_CAT2 )
	.d2line		98
	lwz		r0,16(r5)		# callerProc=r5
	se_cmpi		r0,1
	bc		0,2,.L11361	# ne
	.section	.Os_TEXT,,c
.L11430:
#         {
#             P2CONST(Os_ProcStatType,AUTOMATIC ,OS_CONST) currentIsr = Os_Isr_GetCurrent(coreId);
	.d2line		100
.Llo11:
	lis		r5,(Os_Core_Stat+4)@ha		# callerProc=r5
.Llo12:
	e_add16i		r5,r5,(Os_Core_Stat+4)@l		# callerProc=r5 callerProc=r5
	rlwinm		r7,r4,0,16,31		# coreId=r4
	e_mulli		r7,r7,20
	lwzx		r5,r5,r7		# callerProc=r5 callerProc=r5
	lwz		r0,56(r5)		# callerProc=r5
	se_cmpi		r0,0
	bc		0,2,.L11366	# ne
.Llo13:
	diab.li		r5,0		# currentIsr=r5
.Llo16:
	b		.L11367
.L11366:
.Llo17:
	lis		r5,Os_IsrCurrentIsr@ha		# callerProc=r5
.Llo14:
	e_add16i		r5,r5,Os_IsrCurrentIsr@l		# callerProc=r5 callerProc=r5
	rlwinm		r7,r4,2,14,29		# coreId=r4
	lwzx		r0,r5,r7		# callerProc=r5
	lis		r5,(Os_Core_Stat+4)@ha		# callerProc=r5
	e_add16i		r5,r5,(Os_Core_Stat+4)@l		# callerProc=r5 callerProc=r5
	rlwinm		r7,r4,0,16,31		# coreId=r4
	e_mulli		r7,r7,20
	lwzx		r5,r5,r7		# callerProc=r5 callerProc=r5
	lwz		r5,56(r5)		# callerProc=r5 callerProc=r5
	se_slwi		r5,2		# callerProc=r5 callerProc=r5
	se_add		r5,r0		# callerProc=r5 callerProc=r5
	lwz		r5,-4(r5)		# callerProc=r5 callerProc=r5
.Llo15:
	mr		r5,r5		# currentIsr=r5 currentIsr=r5
.L11367:
#             if(currentIsr != NULL_PTR)
	.d2line		101
	se_cmpi		r5,0		# currentIsr=r5
	bc		1,2,.L11362	# eq
#             {
#                 Os_APICall->Os_API_Data.Os_ApiGetISRID.ISRId = (ISRType)currentIsr->Os_ProcId;   /* [OS263] */
	.d2line		103
	lwz		r0,0(r5)		# currentIsr=r5
	stw		r0,16(r3)		# Os_APICall=r3
	b		.L11363
.L11362:
#             }
#             else
#             {
#                 /* [OS088-05-004] [OS088-05-005] [OS088-05-006] [OS088-05-007] [OS088-05-008]
#                  * [OS088-05-060] [OS088-05-068]
#                  */
#                 Os_APICall->Os_API_Data.Os_ApiGetISRID.ISRId = INVALID_ISR;
	.d2line		110
	diab.li		r0,-1
...
.L11363:
#             }
#             Os_APICall->Os_API_ReturnValue = E_OK;
	.d2line		112
.Llo18:
	diab.li		r0,0
	stb		r0,4(r3)		# Os_APICall=r3
	.section	.Os_TEXT,,c
.L11431:
.Llo2:
	b		.L11360
...
.Llo3:
	diab.li		r0,-1
	stw		r0,16(r3)		# Os_APICall=r3
#             Os_APICall->Os_API_ReturnValue                =  E_OS_ID;
	.d2line		117
	diab.li		r0,3
	stb		r0,4(r3)		# Os_APICall=r3
	.section	.Os_TEXT,,c
...
#         }
#     }
#     OS_TRACE(GetISRID_Exit , coreId);
	.d2line		120
.Llo4:
	diab.li		r3,70		# Os_APICall=r3
.Llo5:
	lis		r5,(Os_Core_DynShared+120)@ha		# currentIsr=r5
.Llo19:
	e_add16i		r5,r5,(Os_Core_DynShared+120)@l		# currentIsr=r5 currentIsr=r5
.Llo8:
	rlwinm		r4,r4,0,16,31		# coreId=r4 coreId=r4
	e_mulli		r4,r4,152		# coreId=r4 coreId=r4
.Llo9:
	stbx		r3,r5,r4		# currentIsr=r5 Os_APICall=r3
# }
	.d2line		121
	.d2epilogue_begin
	lwz		r0,20(r1)
...
#$$ld
.L11408:
	.type		Os_API_GetISRID,@function
	.size		Os_API_GetISRID,.-Os_API_GetISRID
# Number of nodes = 159

# Allocations for Os_API_GetISRID
#	?a4		Os_APICall
#	?a5		coreId
#	?a6		callerProc
#	?a7		currentIsr
...
#$$ld
.L5:
.L11936:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11933:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11931:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11929:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11927:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11912:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11910:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11893:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11873:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11828:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
...
.L11510:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
.L11454:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11449:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
.L11437:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11379:
.L11387:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\isr\\Os_GetISRID.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11401:
.L11409:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\isr\\Os_GetISRID.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\isr\\Os_GetISRID.c"
	.byte		0
...
.L11435:
	...
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo6),5
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetISRID"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetISRID.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\isr\Os_GetISRID.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
