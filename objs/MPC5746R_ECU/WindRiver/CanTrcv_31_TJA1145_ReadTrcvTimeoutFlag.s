...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag.c"
#$$dg 1
...
.L4:
	...
	.section	.text_vle
# FUNC (Std_ReturnType, CANTRCV_31_TJA1145_CODE)CANTRCV_31_TJA1145_READTRCVTIMEOUTFLAG
...
.L673:
	...
	.section	.invalid_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag.c"
        .d2line         102,47
#$$ld
.L680:

#$$bf	CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag,interprocedural,nostackparams

# Regs written: r0,r1,r3
	.globl		CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag
	.d2_cfa_start __cie
CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag:
	stwu		r1,-16(r1)		
...
#     
#     VAR(uint8,AUTOMATIC) PnFrameErrDetectionFLag_u8;
# 
...
#     ReturnValue = CanTrcv_31_TJA1145_ReadTrcvTimeoutFlagDECheck( Transceiver, FlagState );
#     if (E_OK == ReturnValue)
#     {
# #else
#     
...
#                              CANTRCV_31_TJA1145_READ_TRCV_TIMEOUT_FLAG_SID,
...
#             PnFrameErrDetectionFLag_u8 = CANTRCV_31_TJA1145_READ_BITN( DataToBeReceived[0], CANTRCV_31_TJA1145_PNFDE_BIT ); 
#             
#             if ( PnFrameErrDetectionFLag_u8 != 0 )
#             {
#             
...
#     return (ReturnValue);
#     
# }/* End of CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag() */
	.d2line		199
	.d2epilogue_begin
.Llo2:
	se_addi		r1,16		
...
#$$ld
.L681:
	.type		CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag,@function
	.size		CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag,.-CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag
# Number of nodes = 5

# Allocations for CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag
...
#$$ld
.L674:
.L682:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanTrcv\\ssc\\target\\TJA1145\\make\\..\\src\\CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag.c"
	.byte		0
...
.L686:
	.sleb128	2
	.4byte		.L679-.L671
	.byte		"CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag"
	.byte		0
	.4byte		.L682
	.uleb128	102
	.uleb128	47
...
.L691:
	...
	.wrcm.nelem "CanTrcv_31_TJA1145_ReadTrcvTimeoutFlag"
