...
.L4:
	...
	.section	.text_vle
# FUNC(StatusType,OS_CODE) TryToGetSpinlock(VAR(SpinlockIdType,AUTOMATIC) spinlockId,
...
.L11384:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_TryToGetSpinlock.c"
        .d2line         53,26
#$$ld
.L11391:

#$$bf	TryToGetSpinlock,interprocedural,rasave,nostackparams
	.globl		TryToGetSpinlock
	.d2_cfa_start __cie
TryToGetSpinlock:
.Llo1:
	stwu		r1,-48(r1)		
	...
	mr		r4,r4		# success=r4 success=r4
	.d2prologue_end
#                                           P2VAR(TryToGetSpinlockType,AUTOMATIC,AUTOMATIC) success)
# {
#     VAR(Os_APICallType, AUTOMATIC) Os_TryToGetSpinlockAPI_Call;
# 
#     Os_TryToGetSpinlockAPI_Call.Os_API_Data.Os_API_TryToGetSpinlock.SpinlockId = spinlockId;
	.d2line		58
	sth		r3,24(r1)		# spinlockId=r3
#     Os_TryToGetSpinlockAPI_Call.Os_API_Data.Os_API_TryToGetSpinlock.Success = success;
	.d2line		59
	stw		r4,28(r1)		# success=r4
# 
#     OS_LIGHT_SYSCALL(Os_TryToGetSpinlockAPI_Call, TryToGetSpinlock);
	.d2line		61
	diab.addi		r3,r1,8		# spinlockId=r3
.Llo2:
	lis		r4,Os_API_TryToGetSpinlock@ha		# success=r4
	e_add16i		r4,r4,Os_API_TryToGetSpinlock@l		# success=r4 success=r4
.Llo3:
	bl		OS_SYS_CALL
# 
#     return Os_TryToGetSpinlockAPI_Call.Os_API_ReturnValue;
	.d2line		63
...
# Allocations for TryToGetSpinlock
#	?a4		spinlockId
#	?a5		success
#	SP,8		Os_TryToGetSpinlockAPI_Call
# OS_APILIGHT(TryToGetSpinlock)
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_API_TryToGetSpinlock,interprocedural,rasave,nostackparams
	.globl		Os_API_TryToGetSpinlock
	.d2_cfa_start __cie
...
#     CONST(SpinlockIdType, AUTOMATIC) spinlockId = Os_APICall->Os_API_Data.Os_API_TryToGetSpinlock.SpinlockId;
	.d2line		80
	lhz		r29,16(r31)		# Os_APICall=r31
.Llo15:
	mr		r29,r29		# spinlockId=r29 spinlockId=r29
#     CONST(TryToGetSpinlockRefType, AUTOMATIC) success = Os_APICall->Os_API_Data.Os_API_TryToGetSpinlock.Success;
	.d2line		81
	lwz		r28,20(r31)		# Os_APICall=r31
.Llo21:
	mr		r28,r28		# success=r28 success=r28
...
.Llo5:
	...
	rlwinm		r4,r27,0,16,31		# coreId=r27
	e_mulli		r5,r4,20
	lwzx		r3,r3,r5
	lwz		r26,28(r3)
.Llo25:
...
# 
#     OS_TRACE(TryToGetSpinlock_Entry , coreId);
	.d2line		85
	diab.li		r0,105
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN(coreId)->Os_HookID)
	...
	bc		1,2,.L11361	# eq
#     {
#         /* [OS088-03-332] [OS088-03-333] [OS088-03-334] [OS088-03-335] [OS088-03-336]
#          * [OS088-03-337] [OS088-03-338] [OS088-03-377] [OS088-03-420] [OS088-03-464]
#          * [OS-MGC-0056-40] [OS-MGC-0056-83]
#          */
...
#     retVal = Os_Spinlock_Err_Stat(spinlockId,callerProc);
	.d2line		106
	rlwinm		r3,r29,0,16,31		# retVal=r3 spinlockId=r29
	mr		r4,r26		# callerProc=r4 callerProc=r26
	bl		Os_Spinlock_Err_Stat
.Llo8:
	mr		r3,r3		# retVal=r3 retVal=r3
#     retVal = (retVal == E_OK) ? Os_Spinlock_Err_DynLock(spinlockId,callerProc):retVal;
	.d2line		107
...
#         if(success == NULL_PTR)
	.d2line		111
.Llo11:
	se_cmpi		r28,0		# success=r28
#         {
#             retVal = OS_GET_ERRORCODE ( E_OS_SYS_ERROR, E_OS_PARAM_POINTER ); /* [OS566-12] */
	.d2line		113
.Llo12:
	diab.li		r3,14		# retVal=r3
	isel		r30,r3,r30,2		# retVal=r30 retVal=r3 retVal=r30
.L11363:
#         }
# #ifdef OS_MODULE_MEMORYPROTECTION
#         else if (!OSMEMORY_IS_RETURNABLE(Os_CheckMemoryAccess(callerProc,
#                                          OS_CASTTOADDRESS(success),
#                                          OS_SIZEOF(success),
#                                          TRUE)))
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ILLEGAL_ADDRESS); /* [OS051-01-MGC-11] */
#         }
#         else {/* okay */}
# #endif
#     }
...
.L11445:
#     {
#         volatile VAR(uint32, AUTOMATIC) tryLockResourceResult;
# 
#         tryLockResourceResult = OS_PLATFORM_TRYLOCK_SPINLOCK_RESOURCE(coreId,
	.d2line		132
	lis		r3,(Os_SpinlockStat+12)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_SpinlockStat+12)@l		# retVal=r3 retVal=r3
	rlwinm		r4,r29,4,12,27		# spinlockId=r29
	lwzx		r3,r3,r4		# retVal=r3 retVal=r3
	bl		Os_Platform_TryLockResource_Byte
	stw		r3,8(r1)		# retVal=r3
#                                                Os_SpinlockStat[spinlockId].Os_SpinlockLockResourceAddress);
# 
#         /* [OS705-01][OS705-02][OS705-03][OS705-04][OS705-05] whatever is the lock status, return with E_OK */
#         if(OS_TRY_LOCK_RESOURCE_LOCKED == tryLockResourceResult)
	.d2line		136
	lwz		r0,8(r1)
	se_cmpi		r0,0
	bc		0,2,.L11366	# ne
...
#             if(callerProc->Os_ProcDyn->Os_ProcSpinlock != NULL_PTR)
	.d2line		138
	lwz		r3,8(r26)		# retVal=r3 callerProc=r26
	lwz		r0,40(r3)		# retVal=r3
	se_cmpi		r0,0
	bc		1,2,.L11367	# eq
#             {
#                 /* chained lock */
#                 Os_SpinlockStat[spinlockId].Os_SpinlockDyn->Os_SpinlockSuperseded =
	.d2line		141
	lwz		r3,8(r26)		# retVal=r3 callerProc=r26
	lwz		r0,40(r3)		# retVal=r3
	lis		r3,(Os_SpinlockStat+4)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_SpinlockStat+4)@l		# retVal=r3 retVal=r3
	rlwinm		r4,r29,4,12,27		# spinlockId=r29
	lwzx		r3,r3,r4		# retVal=r3 retVal=r3
	stw		r0,4(r3)		# retVal=r3
.L11367:
#                                                                             callerProc->Os_ProcDyn->Os_ProcSpinlock;
#             }
#             callerProc->Os_ProcDyn->Os_ProcSpinlock = &Os_SpinlockStat[spinlockId];
	.d2line		144
.Llo16:
	lis		r3,Os_SpinlockStat@ha		# retVal=r3
	e_add16i		r3,r3,Os_SpinlockStat@l		# retVal=r3 retVal=r3
.Llo17:
	rlwinm		r29,r29,4,12,27		# spinlockId=r29 spinlockId=r29
	se_add		r29,r3		# spinlockId=r29 spinlockId=r29 retVal=r3
	lwz		r3,8(r26)		# retVal=r3 callerProc=r26
	stw		r29,40(r3)		# retVal=r3 spinlockId=r29
#             callerProc->Os_ProcDyn->Os_ProcSpinlock->Os_SpinlockDyn->Os_SpinlockLockerProc = callerProc;
	.d2line		145
	lwz		r3,8(r26)		# retVal=r3 callerProc=r26
	lwz		r3,40(r3)		# retVal=r3 retVal=r3
	lwz		r3,4(r3)		# retVal=r3 retVal=r3
	stw		r26,0(r3)		# retVal=r3 callerProc=r26
# 
#             *success =  TRYTOGETSPINLOCK_SUCCESS;
	.d2line		147
	diab.li		r0,0
	stw		r0,0(r28)		# success=r28
	b		.L11369
.L11366:
#         }
#         else
...
.Llo19:
	...
	rlwinm		r0,r27,0,16,31		# coreId=r27
	e_mulli		r0,r0,152
	sthux		r29,r3,r0		# retVal=r3 spinlockId=r29
#         OS_GET_PARAMETER_ERRORCODE(coreId).Os_Err_TryToGetSpinlockRef = success;
	.d2line		160
	lis		r3,(Os_Core_DynShared+116)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+116)@l		# retVal=r3 retVal=r3
	stwx		r28,r3,r0		# retVal=r3 success=r28
#       #endif
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_TryToGetSpinlock, callerProc); /* [OS001-302.v1-36] */
	.d2line		162
	rlwinm		r3,r30,0,24,31		# retVal=r3 retVal=r30
	diab.li		r4,27
...
#     OS_TRACE(TryToGetSpinlock_Exit , coreId);
	.d2line		166
	diab.li		r3,104		# retVal=r3
...
#$$ld
.L11420:
	.type		Os_API_TryToGetSpinlock,@function
	.size		Os_API_TryToGetSpinlock,.-Os_API_TryToGetSpinlock
# Number of nodes = 260

# Allocations for Os_API_TryToGetSpinlock
#	?a4		Os_APICall
#	?a5		$$2354
#	?a6		retVal
#	?a7		spinlockId
...
#$$ld
.L5:
.L11947:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11944:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11942:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11940:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11938:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11923:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11921:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11905:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11885:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11841:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11794:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11791:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11766:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
...
.L11472:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11461:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11454:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SpinlockCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11385:
.L11393:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_TryToGetSpinlock.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11413:
.L11421:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_TryToGetSpinlock.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\spinlock\\Os_TryToGetSpinlock.c"
	.byte		0
...
.L11406:
	...
	.uleb128	56
	.uleb128	36
	.byte		"Os_TryToGetSpinlockAPI_Call"
	.byte		0
	.4byte		.L11407
	.sleb128	3
	.byte		0x92
...
.L11426:
	...
	.d2locreg	%offsetof(.Llo12), %offsetof(.Llo7),30
	.d2locreg	%offsetof(.Llo13), %offsetof(.Llo14),3
	.d2locend
.L11429:
	.d2locreg	%offsetof(.Llo15), %offsetof(.Llo16),29
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo18),29
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo20),29
	.d2locend
.L11433:
	.d2locreg	%offsetof(.Llo21), %offsetof(.Llo18),28
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo20),28
	.d2locend
.L11437:
	.d2locreg	%offsetof(.Llo22), %offsetof(.Llo20),27
	.d2locreg	%offsetof(.Llo23), %offsetof(.Llo24),27
	.d2locend
.L11444:
	.d2locreg	%offsetof(.Llo25), %offsetof(.Llo18),26
	...
	.wrcm.nelem "Os_API_TryToGetSpinlock"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_Platform_TryLockResource_Byte","Os_ShutdownAllCores","Os_Spinlock_Err_DynLock","Os_Spinlock_Err_Stat"
	.wrcm.end
	.wrcm.nelem "TryToGetSpinlock"
	.wrcm.nint32 "frameSize", 48
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_TryToGetSpinlock.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\spinlock\Os_TryToGetSpinlock.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
