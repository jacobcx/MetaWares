...
.L11393:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeOSInterrupts.c"
        .d2line         52,22
#$$ld
.L11400:

#$$bf	ResumeOSInterrupts,interprocedural,rasave,nostackparams
...
# 
#     VAR(Os_APICallType,AUTOMATIC) Os_ResumeOSInterruptsCall;
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_ResumeOSInterruptsCall, ResumeOSInterrupts );
# 
#   #else
# 
#     Os_PublicData[OS_GETCOREIDASUSER()].Os_PublicDataVarInitRef->Os_ISRServices->Os_ResOsInt();
	.d2line		65
...
# Allocations for ResumeOSInterrupts
#	?a4		$$2352
# FUNC (void, OS_CODE) Os_ResumeOSInterruptsDefault(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         72,22
#$$ld
...
#$$bf	Os_ResumeOSInterruptsDefault,interprocedural,nostackparams

# Regs written: r0,r1
	.globl		Os_ResumeOSInterruptsDefault
	.d2_cfa_start __cie
Os_ResumeOSInterruptsDefault:
	stwu		r1,-16(r1)		
	.d2_cfa_def_cfa_offset	16
	mfspr		r0,lr
	stw		r0,20(r1)
...
#$$ld
.L11407:
	.type		Os_ResumeOSInterruptsDefault,@function
	.size		Os_ResumeOSInterruptsDefault,.-Os_ResumeOSInterruptsDefault
# Number of nodes = 0

# Allocations for Os_ResumeOSInterruptsDefault
# FUNC(void,OS_CODE)  Os_ResumeOSInterruptsAPITrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         78,21
#$$ld
...
#$$bf	Os_ResumeOSInterruptsAPITrusted,interprocedural,rasave,nostackparams
	.globl		Os_ResumeOSInterruptsAPITrusted
	.d2_cfa_start __cie
Os_ResumeOSInterruptsAPITrusted:
	stwu		r1,-32(r1)		
...
#     OS_TRACE(ResumeOSInterrupts_Entry , coreID);
	.d2line		86
	diab.li		r0,93
...
#     /* [OS-MGC-0079-05] */
# 
#     if(    (OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SuspendOSCount == 0U )
	.d2line		92
	...
	bc		1,2,.L11360	# eq
.L11367:
#         || OS_ISR_CHECK_SUSPENDOS(coreID) )
#     {
#         /* [OS092-03] [OS-MGC-0071-01] */
...
# 
#       #ifdef OS_CONFIG_INTERRUPTSERVICE_VALIDATION
#         OS_ISR_UREGISTER_SUSPENDOS(coreID);
	.d2line		106
	lis		r3,(Os_Core_Stat+4)@ha
	e_add16i		r3,r3,(Os_Core_Stat+4)@l
	lwzux		r5,r3,r8
	...
	lwz		r4,12(r6)
	se_add		r30,r4
	rlwinm		r4,r30,0,27,31
	slw		r7,r7,r4
	or		r0,r0,r7
	stw		r0,68(r5)
#       #endif /* OS_CONFIG_INTERRUPTSERVICE_VALIDATION */
# 
#         OS_CALL_RTM_RESUME_OS_INTERRUPTS(coreID);
# 
...
#             /**
#              * Interrupts must be disabled otherwise Os_TPTimer_Stop won't be atomic and
#              * is subject to interruption by TP timer tick.
#              */
#             P2CONST(Os_ProcStatType, AUTOMATIC, OS_CONST) currentTask;
#             currentTask = OS_SCHEDULER_GET_CURRENT_PROC(coreID);
#             Os_TPTimer_Stop(currentTask->Os_ProcLockOsTimerConf); /* [OS037-06] */
#           #endif /* OS_MODULE_TIMINGPROTECTION */
# 
#             /* [OS001-070.v1] */
#             OS_SET_ISR_LEVEL(OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_SavedOSIsrLevel, coreID);
	.d2line		125
.Llo7:
	...
	rlwinm		r4,r31,2,14,29		# coreID=r31
	stwx		r6,r3,r4
	lis		r3,Os_Core_Stat@ha
	e_add16i		r3,r3,Os_Core_Stat@l
	lwzx		r3,r3,r5
...
#     }
# 
#     OS_TRACE(ResumeOSInterrupts_Exit , coreID);
	.d2line		131
.Llo2:
	diab.li		r3,92
...
#$$ld
.L11412:
	.type		Os_ResumeOSInterruptsAPITrusted,@function
	.size		Os_ResumeOSInterruptsAPITrusted,.-Os_ResumeOSInterruptsAPITrusted
# Number of nodes = 300

# Allocations for Os_ResumeOSInterruptsAPITrusted
#	?a4		$$2354
#	?a5		$$2353
#	?a6		coreID
#	?a7		prevState
# FUNC(void,OS_CODE)  Os_ResumeOSInterruptsAPINonTrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         141,21
#$$ld
...
#$$bf	Os_ResumeOSInterruptsAPINonTrusted,interprocedural,rasave,nostackparams
	.globl		Os_ResumeOSInterruptsAPINonTrusted
	.d2_cfa_start __cie
Os_ResumeOSInterruptsAPINonTrusted:
	stwu		r1,-48(r1)		
...
#     OS_LIGHT_SYSCALL ( Os_ResumeOSInterruptsCall, ResumeOSInterrupts );
	.d2line		146
	diab.addi		r3,r1,8
	lis		r4,Os_API_ResumeOSInterrupts@ha
	e_add16i		r4,r4,Os_API_ResumeOSInterrupts@l
	bl		OS_SYS_CALL
# }
	.d2line		147
	.d2epilogue_begin
...
#$$ld
.L11433:
	.type		Os_ResumeOSInterruptsAPINonTrusted,@function
	.size		Os_ResumeOSInterruptsAPINonTrusted,.-Os_ResumeOSInterruptsAPINonTrusted
# Number of nodes = 8

# Allocations for Os_ResumeOSInterruptsAPINonTrusted
#	SP,8		Os_ResumeOSInterruptsCall
# OS_APILIGHT(ResumeOSInterrupts)
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_API_ResumeOSInterrupts,interprocedural,rasave,nostackparams
	.globl		Os_API_ResumeOSInterrupts
	.d2_cfa_start __cie
...
#      *
#      * [OS088-01-067] [OS088-01-068] [OS088-01-069] [OS088-01-070] [OS088-01-071]
#      * [OS088-01-072] [OS088-01-073] [OS088-01-074] [OS088-01-075] [OS088-01-076]
#      * [OS088-01-210] [OS088-01-235] [OS088-01-236] [OS-MGC-0055-07] [OS-MGC-0055-21]
#      */
# 
#   #ifdef OS_CONFIG_INTERRUPTSERVICE_VALIDATION
# 
...
# 
#             /* [OS001-070.v1] */
#             OS_SET_ISR_LEVEL_UM ( OS_GET_CORE_ISR_DYN_INIT ( coreID )->Os_SavedOSIsrLevel, coreID );
	.d2line		207
	lis		r4,Os_Core_Stat@ha
	e_add16i		r4,r4,Os_Core_Stat@l
	rlwinm		r5,r31,0,16,31		# coreID=r31
...
#$$ld
.L11449:
	.type		Os_API_ResumeOSInterrupts,@function
	.size		Os_API_ResumeOSInterrupts,.-Os_API_ResumeOSInterrupts
# Number of nodes = 266

# Allocations for Os_API_ResumeOSInterrupts
...
#$$ld
.L5:
.L11976:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11973:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11971:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11969:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11967:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11952:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11950:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11933:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11904:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11859:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11811:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11808:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11783:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
...
.L11478:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11475:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\ssc\\inc\\Os_Arch_Intr.h"
...
.L11456:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_PublicDataTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11394:
.L11402:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeOSInterrupts.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11442:
.L11450:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeOSInterrupts.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_ResumeOSInterrupts.c"
	.byte		0
...
.L11408:
	.sleb128	2
	.4byte		.L11405-.L11391
	.byte		"Os_ResumeOSInterruptsDefault"
	.byte		0
	.4byte		.L11402
	.uleb128	72
	.uleb128	22
...
.L11413:
	.sleb128	2
	.4byte		.L11410-.L11391
	.byte		"Os_ResumeOSInterruptsAPITrusted"
	.byte		0
	.4byte		.L11402
	.uleb128	78
	.uleb128	21
...
.L11434:
	.sleb128	2
	.4byte		.L11431-.L11391
	.byte		"Os_ResumeOSInterruptsAPINonTrusted"
	.byte		0
	.4byte		.L11402
	.uleb128	141
	.uleb128	21
...
.L11435:
	...
	.uleb128	143
	.uleb128	35
	.byte		"Os_ResumeOSInterruptsCall"
	.byte		0
	.4byte		.L11436
	.sleb128	3
	.byte		0x92
...
.L11451:
	.sleb128	2
	.4byte		.L11447-.L11439
	.byte		"Os_API_ResumeOSInterrupts"
	.byte		0
	.4byte		.L11450
	.uleb128	160
	.uleb128	1
...
.L11454:
	...
	.wrcm.nelem "Os_API_ResumeOSInterrupts"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_ResumeOSInterruptsAPINonTrusted"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "OS_SYS_CALL"
	.wrcm.end
	.wrcm.nelem "Os_ResumeOSInterruptsAPITrusted"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_ResumeOSInterruptsDefault"
	.wrcm.nint32 "frameSize", 16
	.wrcm.end
	.wrcm.nelem "ResumeOSInterrupts"
	.wrcm.nint32 "frameSize", 16
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_ResumeOSInterrupts.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\misc\Os_ResumeOSInterrupts.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
