...
.L4:
	...
	.section	.text_vle
# FUNC (StatusType, OS_CODE) GetElapsedValue(VAR (CounterType, AUTOMATIC)  counterId,
...
.L11391:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\counter\\Os_GetElapsedValue.c"
        .d2line         68,28
#$$ld
.L11398:

#$$bf	GetElapsedValue,interprocedural,rasave,nostackparams
	.globl		GetElapsedValue
	.d2_cfa_start __cie
GetElapsedValue:
.Llo1:
	stwu		r1,-48(r1)		
	...
	mr		r5,r5		# elapsedValue=r5 elapsedValue=r5
	.d2prologue_end
#                                            VAR (TickRefType, AUTOMATIC)  value,
#                                            VAR (TickRefType, AUTOMATIC)  elapsedValue)
# {
#     VAR (Os_APICallType, AUTOMATIC)  Os_GetElapsedValueAPI_Call;
# 
#     Os_GetElapsedValueAPI_Call.Os_API_Data.Os_ApiGetElapsedValue.CounterId        =  counterId;
	.d2line		74
	stw		r3,24(r1)		# counterId=r3
#     Os_GetElapsedValueAPI_Call.Os_API_Data.Os_ApiGetElapsedValue.ValuePtr         =  value;
	.d2line		75
	stw		r4,28(r1)		# value=r4
#     Os_GetElapsedValueAPI_Call.Os_API_Data.Os_ApiGetElapsedValue.ElapsedValuePtr  =  elapsedValue;
	.d2line		76
	stw		r5,32(r1)		# elapsedValue=r5
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_GetElapsedValueAPI_Call, GetElapsedValue );
	.d2line		79
	diab.addi		r3,r1,8		# counterId=r3
.Llo2:
	lis		r4,Os_API_GetElapsedValue@ha		# value=r4
	e_add16i		r4,r4,Os_API_GetElapsedValue@l		# value=r4 value=r4
.Llo3:
	bl		OS_SYS_CALL
# 
#     return Os_GetElapsedValueAPI_Call.Os_API_ReturnValue;
	.d2line		81
.Llo4:
...
# Allocations for GetElapsedValue
#	?a4		counterId
#	?a5		value
#	?a6		elapsedValue
#	SP,8		Os_GetElapsedValueAPI_Call
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_GetElapsedValue_Err_Stat(
	.section	.Os_TEXT,,c
	.align		1
...
#$$bf	Os_GetElapsedValue_Err_Stat,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_GetElapsedValue_Err_Stat:
.Llo5:
	stwu		r1,-32(r1)		
	...
	mr		r30,r4		# valuePtr=r30 valuePtr=r4
	mr		r29,r5		# elapsedValuePtr=r29 elapsedValuePtr=r5
	mr		r4,r6		# callerTask=r4 callerTask=r6
	.d2prologue_end
#                                                 CONST       ( CounterType,     AUTOMATIC )            counterId,
#                                                 CONSTP2CONST( TickType,        AUTOMATIC, AUTOMATIC ) valuePtr,
#                                                 CONSTP2CONST( TickType,        AUTOMATIC, AUTOMATIC ) elapsedValuePtr,
...
#         if(valuePtr == NULL_PTR)
	.d2line		194
.Llo7:
	se_cmpi		r30,0		# valuePtr=r30
	bc		0,2,.L11378	# ne
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_PARAM_POINTER); /* [OS566-09] */
	.d2line		196
	diab.li		r3,14		# retVal=r3
	b		.L11377
.L11378:
#         }
#         else if(elapsedValuePtr == NULL_PTR)
	.d2line		198
	se_cmpi		r29,0		# elapsedValuePtr=r29
	bc		0,2,.L11380	# ne
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_PARAM_POINTER); /* [OS566-10] */
	.d2line		200
.Llo14:
	diab.li		r3,14		# retVal=r3
	b		.L11377
...
#         else if( !OSMEMORY_IS_RETURNABLE( Os_CheckMemoryAccess(callerTask, OS_CASTTOADDRESS(valuePtr),
#                                           OS_SIZEOF(TickRefType),
#                                           TRUE ) ) )
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ILLEGAL_ADDRESS);/* [OS051-01-MGC-08] */
#         }
# 
#         else if( !OSMEMORY_IS_RETURNABLE( Os_CheckMemoryAccess(callerTask, OS_CASTTOADDRESS(elapsedValuePtr),
#                                           OS_SIZEOF(TickRefType),
#                                           TRUE ) ) )
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ILLEGAL_ADDRESS);/* [OS051-01-MGC-09] */
#         }
#       #endif /* OS_MODULE_MEMORYPROTECTION */
# 
#         else if ( *valuePtr > Os_CounterStat[counterId].Os_CounterMaxAllowedValue )
	.d2line		219
.Llo8:
	lwz		r0,0(r30)		# valuePtr=r30
	lis		r4,(Os_CounterStat+4)@ha
	e_add16i		r4,r4,(Os_CounterStat+4)@l
.Llo9:
...
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR,E_OS_VALUE);
	...
	diab.li		r4,8
.Llo15:
	isel		r3,r4,r3,1		# retVal=r3 retVal=r3
.L11382:
#         }
#         else
#         {
#             /* List of requirements that are not checked (automatically satisfied):
#              * [OS088-01-167] [OS088-01-168]
#              */
#             retVal = E_OK;
	.d2line		228
.Llo12:
	diab.li		r0,0
	isel		r3,r3,r0,1		# retVal=r3 retVal=r3
.L11377:
#         }
#     }
# 
...
#$$ld
.L11428:
	.type		Os_GetElapsedValue_Err_Stat,@function
	.size		Os_GetElapsedValue_Err_Stat,.-Os_GetElapsedValue_Err_Stat
# Number of nodes = 47

# Allocations for Os_GetElapsedValue_Err_Stat
#	?a4		counterId
#	?a5		valuePtr
#	?a6		elapsedValuePtr
#	?a7		callerTask
#	?a8		retVal
# OS_APILIGHT(GetElapsedValue)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         96,1
#$$ld
...
#$$bf	Os_API_GetElapsedValue,interprocedural,rasave,nostackparams
	.globl		Os_API_GetElapsedValue
	.d2_cfa_start __cie
...
# {
#     VAR     (StatusType,    AUTOMATIC)  retVal;
#     CONST   (CounterType,   AUTOMATIC)  counterId       = Os_APICall->Os_API_Data.Os_ApiGetElapsedValue.CounterId;
	.d2line		99
	lwz		r29,16(r31)		# Os_APICall=r31
.Llo30:
	mr		r29,r29		# counterId=r29 counterId=r29
#     CONST   (TickRefType,   AUTOMATIC)  valuePtr        = Os_APICall->Os_API_Data.Os_ApiGetElapsedValue.ValuePtr;
	.d2line		100
	lwz		r28,20(r31)		# Os_APICall=r31
.Llo32:
	mr		r28,r28		# valuePtr=r28 valuePtr=r28
#     CONST   (TickRefType,   AUTOMATIC)  elapsedValuePtr = Os_APICall->Os_API_Data.Os_ApiGetElapsedValue.ElapsedValuePtr;
	.d2line		101
	lwz		r27,24(r31)		# Os_APICall=r31
.Llo33:
	mr		r27,r27		# elapsedValuePtr=r27 elapsedValuePtr=r27
...
.Llo18:
	...
	lwz		r26,28(r3)
.Llo34:
	mr		r26,r26		# callerProc=r26 callerProc=r26
...
# 
#     OS_TRACE(GetElapsedValue_Entry , coreId);
	.d2line		107
	diab.li		r0,43
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN(coreId)->Os_HookID)
	...
	bc		1,2,.L11359	# eq
#     {
#         /* [OS088-03-266] [OS088-03-369] [OS088-03-267] [OS088-03-268] [OS088-03-269]
#          * [OS088-03-412] [OS088-03-270] [OS088-03-456] [OS088-03-271] [OS088-03-272]
#          * [OS088-04-MGC-050] [OS088-04-MGC-062] [OS088-04-MGC-051] [OS088-04-MGC-052] [OS088-04-MGC-053]
#          * [OS088-04-MGC-072] [OS088-04-MGC-054] [OS088-04-MGC-081] [OS088-04-MGC-055] [OS088-04-MGC-056]
#          * [OS-MGC-0056-32] [OS-MGC-0056-75]
#          */
...
# 
#     retVal = Os_GetElapsedValue_Err_Stat(counterId,valuePtr,elapsedValuePtr,callerProc);
	.d2line		125
	mr		r3,r29		# counterId=r3 counterId=r29
	mr		r4,r28		# valuePtr=r4 valuePtr=r28
	mr		r5,r27		# elapsedValuePtr=r5 elapsedValuePtr=r27
	mr		r6,r26		# callerProc=r6 callerProc=r26
	bl		Os_GetElapsedValue_Err_Stat
.Llo21:
...
.L11470:
#     {
#         VAR (TickType,   AUTOMATIC)  CurrentCounterValue;
#         CONSTP2CONST(Os_CounterStatType,TYPEDEF, OS_CONST)    counterRef = &Os_CounterStat[counterId];
	.d2line		131
.Llo22:
	lis		r24,Os_CounterStat@ha		# retVal=r24
.Llo23:
	e_add16i		r24,r24,Os_CounterStat@l		# retVal=r24 retVal=r24
	e_mulli		r3,r29,48		# retVal=r3 counterId=r29
	se_add		r3,r24		# retVal=r3 retVal=r3 retVal=r24
.Llo40:
	mr		r24,r3		# counterRef=r24 counterRef=r3
# 
#         retVal = Os_Counter_Err_Dyn(counterRef,callerProc);
	.d2line		133
.Llo24:
	mr		r3,r24		# counterRef=r3 counterRef=r24
.Llo41:
	mr		r4,r26		# callerProc=r4 callerProc=r26
...
#         if( E_OK == retVal )
	...
	bc		0,2,.L11361	# ne
#         {
#             CurrentCounterValue = Os_CounterGetValue(counterRef);
	.d2line		137
.Llo26:
	mr		r3,r24		# counterRef=r3 counterRef=r24
.Llo27:
...
.Llo38:
	mr		r3,r3		# CurrentCounterValue=r3 CurrentCounterValue=r3
# 
#             /* [OS533] */
#             if (CurrentCounterValue==*valuePtr)
	.d2line		140
	lwz		r0,0(r28)		# valuePtr=r28
	se_cmpl		r0,r3		# CurrentCounterValue=r3
	bc		0,2,.L11363	# ne
#             {
#                 *elapsedValuePtr = (TickType)0U;
	.d2line		142
	diab.li		r0,0
	stw		r0,0(r27)		# elapsedValuePtr=r27
	b		.L11364
.L11363:
#             }
#             else
#             {
#                 *elapsedValuePtr =  Os_CounterTickDiff(counterRef, *valuePtr, CurrentCounterValue);
	.d2line		146
	lwz		r0,0(r28)		# valuePtr=r28
	se_cmpl		r0,r3		# CurrentCounterValue=r3
	bc		0,0,.L11367	# ge
	lwz		r4,0(r28)		# valuePtr=r28
	subf		r4,r4,r3		# CurrentCounterValue=r3
	b		.L11368
.L11367:
	lwz		r0,4(r24)		# counterRef=r24
	lwz		r4,0(r28)		# valuePtr=r28
	subf		r4,r4,r0
	se_add		r4,r3		# CurrentCounterValue=r3
	se_addi		r4,1
.L11368:
.Llo42:
	stw		r4,0(r27)		# elapsedValuePtr=r27
.L11364:
#             }
#             *valuePtr            =  CurrentCounterValue;
	.d2line		148
	stw		r3,0(r28)		# valuePtr=r28 CurrentCounterValue=r3
	.section	.Os_TEXT,,c
.L11471:
.L11361:
#         }
...
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TickRef_Ticks        = valuePtr;
	...
	stwux		r28,r3,r0		# retVal=r3 valuePtr=r28
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TickRef_ElapsedTicks = elapsedValuePtr;
	.d2line		161
	lis		r3,(Os_Core_DynShared+104)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+104)@l		# retVal=r3 retVal=r3
	stwx		r27,r3,r0		# retVal=r3 elapsedValuePtr=r27
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_GetElapsedValue,callerProc); /* [OS001-302.v1-30] */
	.d2line		165
	rlwinm		r3,r30,0,24,31		# retVal=r3 retVal=r30
	diab.li		r4,17
	mr		r5,r26		# callerProc=r5 callerProc=r26
...
# 
#     OS_TRACE(GetElapsedValue_Exit , coreId);
	.d2line		172
	diab.li		r3,42		# retVal=r3
...
#$$ld
.L11448:
	.type		Os_API_GetElapsedValue,@function
	.size		Os_API_GetElapsedValue,.-Os_API_GetElapsedValue
# Number of nodes = 240

# Allocations for Os_API_GetElapsedValue
#	?a4		Os_APICall
#	?a5		$$2352
#	?a6		retVal
#	?a7		counterId
...
#$$ld
.L5:
.L12002:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11999:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11997:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11995:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11993:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11976:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11974:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11957:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11937:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11893:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11821:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11818:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
...
.L11499:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11488:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11484:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CounterCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11392:
.L11400:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\counter\\Os_GetElapsedValue.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11421:
.L11429:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\counter\\Os_GetElapsedValue.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\counter\\Os_GetElapsedValue.c"
	.byte		0
...
.L11414:
	...
	.uleb128	72
	.uleb128	38
	.byte		"Os_GetElapsedValueAPI_Call"
	.byte		0
	.4byte		.L11415
	.sleb128	3
	.byte		0x92
...
.L11430:
	.sleb128	5
	.4byte		.L11426-.L11418
	.byte		"Os_GetElapsedValue_Err_Stat"
	.byte		0
	.4byte		.L11429
	.uleb128	182
	.uleb128	41
...
.L11432:
	...
	.d2locend
.L11436:
	.d2locreg	%offsetof(.Llo5), %offsetof(.Llo11),4
	.d2locreg	%offsetof(.Llo7), %offsetof(.Llo12),30
	.d2locend
.L11437:
	.d2locreg	%offsetof(.Llo5), %offsetof(.Llo13),5
	.d2locreg	%offsetof(.Llo7), %offsetof(.Llo14),29
	.d2locend
.L11442:
	.d2locreg	%offsetof(.Llo5), %offsetof(.Llo13),6
	.d2locend
.L11444:
	.d2locreg	%offsetof(.Llo13), %offsetof(.Llo8),3
...
.L11453:
	...
	.d2locreg	%offsetof(.Llo23), %offsetof(.Llo24),24
	.d2locreg	%offsetof(.Llo25), %offsetof(.Llo26),3
	.d2locreg	%offsetof(.Llo27), %offsetof(.Llo20),30
...
.L11455:
	...
	.d2locend
.L11458:
	.d2locreg	%offsetof(.Llo32), %offsetof(.Llo31),28
	.d2locend
.L11460:
	.d2locreg	%offsetof(.Llo33), %offsetof(.Llo31),27
	.d2locend
.L11463:
	.d2locreg	%offsetof(.Llo34), %offsetof(.Llo31),26
	.d2locend
.L11469:
	.d2locreg	%offsetof(.Llo35), %offsetof(.Llo31),25
	.d2locreg	%offsetof(.Llo36), %offsetof(.Llo37),25
	.d2locend
.L11475:
...
.L11482:
	...
	.d2locreg	%offsetof(.Llo26), %offsetof(.Llo42),24
	.d2locreg	%offsetof(.Llo39), %offsetof(.Llo43),24
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetElapsedValue"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_CounterGetValue","Os_Counter_Err_Dyn","Os_GetElapsedValue_Err_Stat","Os_ShutdownAllCores"
	.wrcm.end
	.wrcm.nelem "Os_GetElapsedValue_Err_Stat"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Counter_Err_Stat"
	.wrcm.end
	.wrcm.nelem "GetElapsedValue"
	.wrcm.nint32 "frameSize", 48
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetElapsedValue.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\counter\Os_GetElapsedValue.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
