...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"ComM_DCM_InactiveDiagnostic.c"
#$$dg 1
...
# FUNC(void, COMM_CODE) ComM_DCM_InactiveDiagnostic(VAR(NetworkHandleType, AUTOMATIC) Channel)
	.align		2
	.section	.text_vle
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\ComM\\ssc\\make\\..\\src\\ComM_DCM_InactiveDiagnostic.c"
        .d2line         49,23
#$$ld
.L767:

#$$bf	ComM_DCM_InactiveDiagnostic,interprocedural,rasave,nostackparams
	.globl		ComM_DCM_InactiveDiagnostic
	.d2_cfa_start __cie
...
.Llo2:
	...
	bc		0,2,.L757	# ne
#     {
#         COMM_DET_REPORT_ERROR(COMM_DCM_INACTIVEDIAG_API_ID, COMM_E_NOT_INITED);
#     }
# #if(COMM_DEV_ERROR_DETECT == STD_ON)
#     /* Check if Channel is invalid */
#     else if(Channel >= ComM_ChannelsNum)
#     {
#         COMM_DET_REPORT_ERROR(COMM_DCM_INACTIVEDIAG_API_ID, COMM_E_WRONG_PARAMETERS);
#     }
# #endif
#     else
#     {
#         /* [ADD_ComM3000] ComM_DCM_InactiveDiagnostic shall not be called on PASSIVE channels */
...
.Llo3:
	...
	bc		1,2,.L757	# eq
#         {
#             COMM_DET_REPORT_ERROR(COMM_DCM_INACTIVEDIAG_API_ID, COMM_E_WRONG_NM_VARIANT);
#         }
#         else
#         {
...
#             SchM_Enter_ComM(Channel);
	...
	bl		SchM_Enter_ComM
# 
#             ComM_ChannelStates[Channel].ActiveDiagnostic = FALSE;
	.d2line		75
...
#$$ld
.L768:
	.type		ComM_DCM_InactiveDiagnostic,@function
	.size		ComM_DCM_InactiveDiagnostic,.-ComM_DCM_InactiveDiagnostic
# Number of nodes = 43

# Allocations for ComM_DCM_InactiveDiagnostic
#	?a4		Channel
#	?a5		$$238
#	?a6		$$237
...
.L769:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\ComM\\ssc\\make\\..\\src\\ComM_DCM_InactiveDiagnostic.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\ComM\\ssc\\make\\..\\src\\ComM_DCM_InactiveDiagnostic.c"
	.byte		0
...
.L770:
	.sleb128	2
	.4byte		.L766-.L2
	.byte		"ComM_DCM_InactiveDiagnostic"
	.byte		0
	.4byte		.L769
	.uleb128	49
	.uleb128	23
...
.L774:
	...
	.wrcm.nelem "ComM_DCM_InactiveDiagnostic"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\ComM_DCM_InactiveDiagnostic.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\COM\ComM\ssc\make\..\src\ComM_DCM_InactiveDiagnostic.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
