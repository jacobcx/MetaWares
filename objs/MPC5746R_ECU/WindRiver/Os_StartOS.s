...
#	?a4		app
#	?a5		coreDynInit
# void Os_StartOsRuntime(CONST(AppModeType, AUTOMATIC) appMode)
...
.L11437:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\core\\Os_StartOS.c"
        .d2line         55,6
#$$ld
.L11444:

#$$bf	Os_StartOsRuntime,interprocedural,rasave,nostackparams
	.globl		Os_StartOsRuntime
	.d2_cfa_start __cie
Os_StartOsRuntime:
.Llo4:
	stwu		r1,-48(r1)		
	.d2_cfa_def_cfa_offset	48
	mfspr		r0,lr		# appMode=r0
	stw		r0,52(r1)		# appMode=r0
	.d2_cfa_offset    108,-1
	mr		r0,r3		# appMode=r0 appMode=r3
	.d2prologue_end
# {
#     VAR(Os_APICallType, AUTOMATIC) Os_StartOsAPI_Call;
#     OS_API_ALLOC(Os_StartOsAPI_Call, StartOS);
	.d2line		58
.Llo5:
	e_lis		r3,4660
.Llo6:
	e_or2i		r3,22136
	stw		r3,8(r1)
	lis		r3,Os_API_StartOS@ha
	e_add16i		r3,r3,Os_API_StartOS@l
	stw		r3,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
#     Os_StartOsAPI_Call.Os_API_Data.Os_ApiStartOs.AppMode = appMode;
	.d2line		59
	stw		r0,24(r1)		# appMode=r0
# 
#     OS_SYSCALL(Os_StartOsAPI_Call);
	.d2line		61
	diab.addi		r3,r1,8
	bl		OS_SYS_CALL
# }
	...
	.d2epilogue_begin
.Llo7:
	lwz		r0,52(r1)		# appMode=r0
	mtspr		lr,r0		# appMode=lr
	diab.addi		r1,r1,48		
	.d2_cfa_def_cfa_offset	0
	blr
#$$ef
...
#$$ld
.L11445:
	.type		Os_StartOsRuntime,@function
	.size		Os_StartOsRuntime,.-Os_StartOsRuntime
# Number of nodes = 34

# Allocations for Os_StartOsRuntime
#	?a4		appMode
#	SP,8		Os_StartOsAPI_Call
# void Os_StartOsFirstTime(CONST(AppModeType, AUTOMATIC) appMode)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         73,6
#$$ld
...
#$$bf	Os_StartOsFirstTime,interprocedural,rasave,nostackparams
	.globl		Os_StartOsFirstTime
	.d2_cfa_start __cie
Os_StartOsFirstTime:
.Llo8:
	stwu		r1,-64(r1)		
	...
	.d2prologue_end
# {
#     /* This variable shall be here (not on kernel stack) otherwise upon first kernel entry it would be overwritten. */
#     VAR(Os_APICallType, AUTOMATIC) Os_StartOsAPI_Call;
# 
...
.Llo10:
	...
	bl		Os_PreInit
# 
#     /* [OS611] - Os_StartOsFirstTime->Os_CoreInit->OS_Init->OS_IOC_Init*/
#     OS_API_ALLOC(Os_StartOsAPI_Call, StartOS);
	.d2line		83
	e_lis		r0,4660
	e_or2i		r0,22136
...
#$$ld
.L11459:
	.type		Os_StartOsFirstTime,@function
	.size		Os_StartOsFirstTime,.-Os_StartOsFirstTime
# Number of nodes = 60

# Allocations for Os_StartOsFirstTime
#	?a4		appMode
#	not allocated	$$2352
#	SP,8		Os_StartOsAPI_Call
# FUNC (void, OS_CODE) StartOS(AppModeType appMode)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         96,22
#$$ld
...
#$$bf	StartOS,interprocedural,rasave,nostackparams
	.globl		StartOS
	.d2_cfa_start __cie
StartOS:
.Llo12:
...
.Llo16:
	...
	.d2_cfa_offset_list	31,31,1,1
	stw		r0,36(r1)		# func=r0
	.d2_cfa_offset    108,-1
	mr		r31,r3		# appMode=r31 appMode=r3
	.d2prologue_end
# {
#     CONST (Os_StartOsFuncType, AUTOMATIC) func = Os_Core_GetStartOsFunc(OS_GETCOREID());
	.d2line		98
	mfspr		r3,286
.Llo13:
	rlwinm		r3,r3,0,16,31
	bl		Os_Core_GetStartOsFunc
	.d2line		99
.Llo17:
	mr.		r0,r3		# func=?a5 func=r3
#     if(NULL_PTR != func)
.Llo18:
	bc		1,2,.L11364	# eq
#     {
#         func(appMode); /* [OS001-170.v1] [OS607] */
	.d2line		101
.Llo14:
	mtspr		ctr,r0		# func=ctr func=r0
	mr		r3,r31		# appMode=r3 appMode=r31
...
#$$bf	Os_API_StartOS,interprocedural,rasave,nostackparams
	.globl		Os_API_StartOS
	.d2_cfa_start __cie
Os_API_StartOS:
.Llo19:
	stwu		r1,-32(r1)		
...
#     VAR  (AppModeType, AUTOMATIC) appMode = Os_APICall->Os_API_Data.Os_ApiStartOs.AppMode;
	.d2line		124
	lwz		r30,16(r3)		# Os_APICall=r3
.Llo23:
	mr		r30,r30		# appMode=r30 appMode=r30
# 
#   #if ( (defined(OS_CONFIG_HOOK)) || (OS_APP_STARTUPHOOK == STD_ON) )
# 
#     CONSTP2VAR (Os_Core_DynType, AUTOMATIC, OS_CONST)  coreDyn     = OS_GET_CORE_DYN ( coreId );
	.d2line		128
	lis		r3,(Os_Core_Stat+4)@ha		# Os_APICall=r3
	e_add16i		r3,r3,(Os_Core_Stat+4)@l		# Os_APICall=r3 Os_APICall=r3
	rlwinm		r0,r31,0,16,31		# coreId=r31
	e_mulli		r4,r0,20
	lwzx		r28,r3,r4		# coreDyn=r28 Os_APICall=r3
	mr		r28,r28		# coreDyn=r28 coreDyn=r28
#     CONSTP2VAR (Os_HooksDynType, AUTOMATIC, OS_VAR)    coreHookDyn = &coreDyn->Os_HooksDyn;
	.d2line		129
	diab.addi		r28,r28,100		# coreDyn=r28 coreDyn=r28
.Llo35:
	mr		r28,r28		# coreHookDyn=r28 coreHookDyn=r28
# 
#   #endif
# 
#     OS_TRACE(StartOS_Entry , coreId);
	.d2line		133
	diab.li		r4,50
	lis		r3,(Os_Core_DynShared+120)@ha		# Os_APICall=r3
	e_add16i		r3,r3,(Os_Core_DynShared+120)@l		# Os_APICall=r3 Os_APICall=r3
	e_mulli		r0,r0,152
	stbx		r4,r3,r0		# Os_APICall=r3
	.section	.Os_TEXT,,c
.L11508:
# 
#     {
#         CONST(Os_CoreStartedType, AUTOMATIC) coreStarted = Os_Core_GetStarted(coreId);
	.d2line		136
.Llo20:
	rlwinm		r3,r31,0,16,31		# Os_APICall=r3 coreId=r31
	bl		Os_Core_GetStarted
.Llo36:
	mr		r3,r3		# coreStarted=r3 coreStarted=r3
# 
#         /* [OS001-259.v1] */
#         if(OS_CORE_START_INIT == coreStarted)
	.d2line		139
	e_lis		r0,7085
	e_or2i		r0,45058
	se_cmpl		r3,r0		# coreStarted=r3
	bc		0,2,.L11370	# ne
#         {
#             Os_Core_SetStarted(coreId, OS_CORE_START_OKAY);
	.d2line		141
.Llo37:
	rlwinm		r3,r31,0,16,31		# coreStarted=r3 coreId=r31
	e_lis		r4,51966
	e_or2i		r4,47806
	bl		Os_Core_SetStarted
	b		.L11371
.L11370:
#         }
#         else if(OS_CORE_START_OKAY == coreStarted)
	.d2line		143
.Llo38:
	e_lis		r0,51966
	e_or2i		r0,47806
...
.Llo39:
	diab.li		r4,53
	lis		r3,(Os_Core_DynShared+12)@ha		# coreStarted=r3
.Llo40:
	e_add16i		r3,r3,(Os_Core_DynShared+12)@l		# coreStarted=r3 coreStarted=r3
	mfspr		r0,286
	rlwinm		r0,r0,0,16,31
	e_mulli		r0,r0,152
	stwx		r4,r3,r0		# coreStarted=r3
	diab.li		r3,30		# coreStarted=r3
.Llo41:
...
#         else
#         {
#             OS_FATAL_ERROR(E_OS_SYS_INVALID_STARTSTATE);
	.d2line		149
	diab.li		r4,2
	lis		r3,(Os_Core_DynShared+12)@ha		# coreStarted=r3
.Llo42:
...
#     OS_GET_CORE_DYN_INIT_SHARED(coreId)->Os_CoreAppMode = appMode;
	.d2line		159
	lis		r3,(Os_Core_DynInitShared+12)@ha		# coreStarted=r3
.Llo44:
	e_add16i		r3,r3,(Os_Core_DynInitShared+12)@l		# coreStarted=r3 coreStarted=r3
	rlwinm		r4,r31,0,16,31		# coreId=r31
	e_mulli		r0,r4,20
	stwx		r30,r3,r0		# coreStarted=r3 appMode=r30
# 
#     Os_CoreSyncPhase0(coreId);
	.d2line		161
	mr		r3,r4
.Llo45:
	bl		Os_CoreSyncPhase0
# 
#     /* [OS608-01], [OS608-02] */
#     if(OS_CORE_ID_MASTER != coreId)
	...
	bc		1,2,.L11376	# eq
#     {
#         if(DONOTCARE == appMode)
	.d2line		166
	cmpi		0,0,r30,-1		# appMode=r30
	bc		0,2,.L11379	# ne
#         {
#             appMode = Os_Core_GetAppMode(OS_CORE_ID_MASTER); /* [OS609-01] */
	.d2line		168
	diab.li		r3,1		# coreStarted=r3
	bl		Os_Core_GetAppMode
	mr		r30,r3		# appMode=r30 appMode=r3
	b		.L11379
.L11376:
#         }
#         else
...
#     {
#         /* Master core has to define a valid application mode other than DONOTCARE. */
#         if(appMode >= Os_AppModeCount) /* [OS610-01] */
	.d2line		179
	lis		r3,Os_AppModeCount@ha		# coreStarted=r3
.Llo46:
	lwz		r0,Os_AppModeCount@l(r3)		# coreStarted=r3
	se_cmpl		r0,r30		# appMode=r30
	bc		1,1,.L11379	# gt
#         {
#             OS_FATAL_ERROR(E_OS_SYS_INVALID_MASTERAPPMODE);
	.d2line		181
.Llo47:
	diab.li		r4,3
	lis		r3,(Os_Core_DynShared+12)@ha		# coreStarted=r3
...
# 
#     /*********************************************
#      * Initialization before SyncPhase 1
#      ********************************************/
# 
#     /* Set application mode */
#     OS_GET_CORE_DYN_INIT_SHARED(coreId)->Os_CoreAppMode = appMode;
...
.Llo51:
	bl		Os_Init
# 
#     /* Start auto started objects */
#     Os_Task_AutoStart(appMode, coreId);  /* [OS001-394.v1] [OS001-395.v1] */
	.d2line		200
	rlwinm		r4,r31,0,16,31		# coreId=r31
	mr		r3,r30		# appMode=r3 appMode=r30
	bl		Os_Task_AutoStart
#     Os_Alarm_AutoStart(appMode, coreId); /* [OS001-392.v1] [OS374-01] */
	.d2line		201
	rlwinm		r4,r31,0,16,31		# coreId=r31
	mr		r3,r30		# appMode=r3 appMode=r30
	bl		Os_Alarm_AutoStart
#     Os_SchTblAutoStart(appMode, coreId);
	.d2line		202
	rlwinm		r4,r31,0,16,31		# coreId=r31
	mr		r3,r30		# appMode=r3 appMode=r30
	bl		Os_SchTblAutoStart
# 
#   #if defined(OS_MODULE_MEMORYPROTECTION) || defined(OS_MODULE_MEMORYPROTECTION_GLOBAL_INIT_REQUIRED)
#     Os_MemoryProtection_PostInit(coreId);
...
# 
#   #ifdef OS_MODULE_MULTICORE
#     /* [OS579-01][OS579-02][OS579-03][OS579-04][OS579-05][OS580-01][OS580-02][OS580-03][OS580-04][OS581] */
#     Os_CoreSyncPhase1( coreId );
	.d2line		214
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_CoreSyncPhase1
	.section	.Os_TEXT,,c
.L11516:
# 
#     {
#         /* [OS608-03]:  During the validity check of appMode, if the AppModes of any two cores do not match and
#          *              neither of them (within a pair) is DONOTCARE, the validity check fails.
#          *
#          * [OS608-04]:  If the validity check of appMode fails, the caller's core shall immediately enter an
#          *              empty infinite loop.
#          */
#         VAR(CoreIdType,  AUTOMATIC) coreIdx;
# 
#         /* This shall loop through all the cores. */
#         for (coreIdx = (CoreIdType)0U; coreIdx < OS_AUTOSAR_CORE_NO; ++coreIdx)
	.d2line		226
	diab.li		r29,0		# coreIdx=r29
.L11383:
.Llo52:
	rlwinm		r3,r29,0,16,31		# appMode=r3 coreIdx=r29
	se_cmpi		r3,2		# appMode=r3
	bc		0,0,.L11385	# ge
	.section	.Os_TEXT,,c
.L11522:
#         {
#             CONST (AppModeType, AUTOMATIC) otherAppMode = Os_Core_GetAppMode(coreIdx);
	.d2line		228
	rlwinm		r3,r29,0,16,31		# appMode=r3 coreIdx=r29
	bl		Os_Core_GetAppMode
.Llo53:
	mr		r3,r3		# otherAppMode=r3 otherAppMode=r3
#             if(otherAppMode != appMode)
	.d2line		229
	se_cmpl		r3,r30		# otherAppMode=r3 appMode=r30
	bc		1,2,.L11386	# eq
.L11387:
.Llo54:
	b		.L11387
...
#                 for(;;)
#                 {
#                     /* endless loop as required by [OS608-04] */
#                 }
#             }
#             else
#             {
...
#         }
	.d2line		240
	diab.addi		r3,r29,1		# otherAppMode=r3 coreIdx=r29
	se_addi		r29,1		# coreIdx=r29 coreIdx=r29
	b		.L11383
.L11385:
	.section	.Os_TEXT,,c
.L11517:
...
# 
#   #if(OS_STARTUPHOOK == STD_ON)
# 
#     coreHookDyn->Os_HookID = OS_HOOKID_STARTUPHOOK;
	.d2line		257
	diab.li		r0,2
	sth		r0,0(r28)		# coreHookDyn=r28
#     StartupHook(); /* [OS001-330.v1] */
	.d2line		258
	bl		StartupHook
	.section	.Os_TEXT,,c
.L11528:
# 
#   #endif /* (OS_STARTUPHOOK == STD_ON) */
# 
#   #if (OS_APP_STARTUPHOOK == STD_ON)
#     {
#         VAR (ApplicationType, AUTOMATIC) appId;
# 
#         coreHookDyn->Os_HookID = OS_HOOKID_APPSTARTUPHOOK;
	.d2line		266
	diab.li		r0,512
	sth		r0,0(r28)		# coreHookDyn=r28
# 
...
#         for ( appId =  (ApplicationType)Os_ApplicationRange[coreId].Os_ObjStartId;
	.d2line		269
	lis		r3,Os_ApplicationRange@ha		# appMode=r3
.Llo25:
	e_add16i		r3,r3,Os_ApplicationRange@l		# appMode=r3 appMode=r3
	rlwinm		r0,r31,3,13,28		# coreId=r31
	lwzx		r30,r3,r0		# appMode=r30 appMode=r3
.Llo55:
	mr		r30,r30		# appId=r30 appId=r30
.L11391:
.Llo26:
	rlwinm		r0,r30,0,24,31		# appId=r30
	lis		r3,(Os_ApplicationRange+4)@ha		# appMode=r3
.Llo27:
	e_add16i		r3,r3,(Os_ApplicationRange+4)@l		# appMode=r3 appMode=r3
	rlwinm		r4,r31,3,13,28		# coreId=r31
	lwzx		r3,r3,r4		# appMode=r3 appMode=r3
	rlwinm		r3,r3,0,24,31		# appMode=r3 appMode=r3
	se_cmp		r0,r3		# appMode=r3
	bc		1,1,.L11393	# gt
#               appId <= (ApplicationType)Os_ApplicationRange[coreId].Os_ObjEndId;
#               appId++ )
#         {
#             if(Os_Applications_Stat[appId].Os_AppStartupHook != NULL_PTR) /* [OS060] [OS226] */
	.d2line		273
.Llo28:
	rlwinm		r0,r30,0,24,31		# appId=r30
	lis		r3,(Os_Applications_Stat+20)@ha		# appMode=r3
.Llo29:
	e_add16i		r3,r3,(Os_Applications_Stat+20)@l		# appMode=r3 appMode=r3
	rlwinm		r4,r0,6,0,25
	se_slwi		r0,4
	subf		r0,r0,r4
	lwzx		r0,r3,r0		# appMode=r3
	se_cmpi		r0,0
	bc		1,2,.L11395	# eq
#             {
#                 Os_SchedulerSwitchApp(&Os_Applications_Stat[appId]);
	.d2line		275
.Llo30:
	rlwinm		r0,r30,0,24,31		# appId=r30
	lis		r3,Os_Applications_Stat@ha		# appMode=r3
.Llo31:
	e_add16i		r3,r3,Os_Applications_Stat@l		# appMode=r3 appMode=r3
	rlwinm		r4,r0,6,0,25
	se_slwi		r0,4
	subf		r0,r0,r4
	se_add		r3,r0		# appMode=r3 appMode=r3
.Llo32:
	bl		Os_SchedulerSwitchApp
#                 Os_Applications_Stat[appId].Os_AppStartupHook();
	.d2line		276
	rlwinm		r0,r30,0,24,31		# appId=r30
	lis		r3,(Os_Applications_Stat+20)@ha		# appMode=r3
.Llo33:
...
#         }
	.d2line		282
.Llo34:
	diab.addi		r0,r30,1		# appId=r30
	se_addi		r30,1		# appId=r30 appId=r30
	b		.L11391
.L11393:
# 
#         Os_SchedulerSwitchApp( NULL_PTR );
	.d2line		284
	diab.li		r3,0		# appMode=r3
	bl		Os_SchedulerSwitchApp
	.section	.Os_TEXT,,c
.L11529:
#     }
#   #endif /* (OS_APP_STARTUPHOOK == STD_ON) */
# 
...
#   #endif /* OS_MODULE_MULTICORE */
# 
# #endif /* ( (defined(OS_CONFIG_HOOK)) || (OS_APP_STARTUPHOOK == STD_ON) ) */
#     /*********************************************
#      * Initialization before SyncPhase 2
#      ********************************************/
# 
#     Os_Platform_PostInit(coreId);
	.d2line		300
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Platform_PostInit
#   #ifdef OS_MODULE_MULTICORE
#     Os_Core_PostInit(coreId);
	.d2line		302
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Core_PostInit
#   #endif /* OS_MODULE_MULTICORE */
#     Os_Isr_PostInit(coreId);
	.d2line		304
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Isr_PostInit
#     /* [OS374-01] [OS374-02] */
#     Os_Timer_PostInit(coreId);
	.d2line		306
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Timer_PostInit
# 
#     /*********************************************
#      * SyncPhase 2
#      ********************************************/
# 
# #ifdef OS_MODULE_MULTICORE
#   #if (STD_ON == OS_STARTUPHOOK)
#     /* Release self core in case Startup Hook calls ShutdownAllCores. */
#     Os_Core_UnlockCore(coreId);
	.d2line		315
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Core_UnlockCore
#   #endif
# 
#     /* [OS579-01][OS579-02][OS579-03][OS579-04][OS579-05] */
#     Os_CoreSyncPhase2(coreId);
	.d2line		319
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_CoreSyncPhase2
# 
#   #if (STD_ON == OS_STARTUPHOOK)
#     /* Release self core in case Startup Hook calls ShutdownAllCores. */
#     Os_Core_LockCore(coreId);
...
# 
#     /*********************************************
#      * Start timers after SyncPhase 2
#      ********************************************/
# 
#     /* [OS374-01] [OS374-02] */
#     Os_Timer_StartFirstTime(coreId);
	.d2line		335
	rlwinm		r3,r31,0,16,31		# appMode=r3 coreId=r31
	bl		Os_Timer_StartFirstTime
# 
#     /* [OS001-393.v1]: Interrupts will be enabled upon returning from SYSCALL */
# 
#     /*********************************************
#      * Begin first scheduling after return.
#      ********************************************/
# }
	.d2line		342
	.d2epilogue_begin
...
#$$ld
.L11479:
	.type		Os_API_StartOS,@function
	.size		Os_API_StartOS,.-Os_API_StartOS
# Number of nodes = 357

# Allocations for Os_API_StartOS
#	?a4		Os_APICall
...
#$$ld
.L5:
.L12035:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L12032:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L12030:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L12028:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L12026:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L12011:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L12008:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11991:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11971:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11880:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11877:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11852:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
.L11614:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
.L11566:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11565:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Core.h"
.L11548:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11538:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11412:
.L11480:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\core\\Os_StartOS.c"
.L11420:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Scheduler.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11438:
.L11446:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\core\\Os_StartOS.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\core\\Os_StartOS.c"
	.byte		0
...
.L11475:
	...
	.d2locreg	%offsetof(.Llo18), %offsetof(.Llo15),0
	.d2locend
.L11483:
...
.L11495:
	...
	.d2locend
.L11501:
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo35),28
	.d2locend
.L11507:
	.d2locreg	%offsetof(.Llo35), %offsetof(.Llo22),28
	.d2locend
.L11515:
	...
	.d2locend
.L11521:
	.d2locreg	%offsetof(.Llo52), %offsetof(.Llo24),29
	.d2locend
.L11527:
...
.L11536:
	...
	.wrcm.nelem "Os_API_StartOS"
	.wrcm.nint32 "indirectCalls", 1
	.wrcm.nlist "calls"
	.wrcm.str "Os_Alarm_AutoStart"
	.wrcm.str "Os_CoreSyncPhase0"
	.wrcm.str "Os_CoreSyncPhase1"
	.wrcm.str "Os_CoreSyncPhase2"
	.wrcm.str "Os_Core_GetAppMode"
	.wrcm.str "Os_Core_GetStarted"
	.wrcm.str "Os_Core_LockCore"
	.wrcm.str "Os_Core_PostInit"
	.wrcm.str "Os_Core_SetStarted"
	.wrcm.str "Os_Core_UnlockCore"
	.wrcm.str "Os_Init"
	.wrcm.str "Os_Isr_PostInit"
	.wrcm.str "Os_Isr_ServicesSwitchBackFromHook"
	.wrcm.str "Os_Isr_ServicesSwitchToHook"
	.wrcm.str "Os_Platform_PostInit"
	.wrcm.str "Os_SchTblAutoStart"
	.wrcm.str "Os_SchedulerSwitchApp"
	.wrcm.str "Os_ShutdownAllCores"
	.wrcm.str "Os_Task_AutoStart"
	.wrcm.str "Os_Timer_PostInit"
	.wrcm.str "Os_Timer_StartFirstTime"
	.wrcm.str "StartupHook"
	.wrcm.end
	.wrcm.nint32 "frameSize", 32
	.wrcm.end
	.wrcm.nelem "StartOS"
	.wrcm.nint32 "indirectCalls", 1
	.wrcm.nstrlist "calls", "Os_Core_GetStartOsFunc"
	.wrcm.nint32 "frameSize", 32
	.wrcm.end
	.wrcm.nelem "Os_StartOsFirstTime"
	.wrcm.nstrlist "calls", "OS_SYS_CALL","Os_PreInit"
	.wrcm.nint32 "frameSize", 64
	.wrcm.end
	.wrcm.nelem "Os_StartOsRuntime"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StartOS.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StartOS.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StartOS.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StartOS.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StartOS.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StartOS.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\core\Os_StartOS.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
