...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"Os_StartScheduleTableRel.c"
#$$dg 1
...
.L4:
	...
	.section	.text_vle
# FUNC(StatusType, OS_CODE) StartScheduleTableRel(VAR(ScheduleTableType, AUTOMATIC)  schTblId,
...
.L11402:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StartScheduleTableRel.c"
        .d2line         68,27
#$$ld
.L11409:

#$$bf	StartScheduleTableRel,interprocedural,rasave,nostackparams
	.globl		StartScheduleTableRel
	.d2_cfa_start __cie
StartScheduleTableRel:
.Llo1:
	stwu		r1,-48(r1)		
	.d2_cfa_def_cfa_offset	48
	mfspr		r0,lr		# offset=r0
	stw		r0,52(r1)		# offset=r0
	.d2_cfa_offset    108,-1
	mr		r3,r3		# schTblId=r3 schTblId=r3
	mr		r0,r4		# offset=r0 offset=r4
	.d2prologue_end
#                                                 VAR(TickType, AUTOMATIC)           offset)
# {
#     VAR (Os_APICallType, AUTOMATIC) Os_StartScheduleTableRelAPI_Call;
# 
#     OS_API_ALLOC(Os_StartScheduleTableRelAPI_Call,StartScheduleTableRel);
	.d2line		73
.Llo3:
	e_lis		r4,4660
.Llo4:
	e_or2i		r4,22136
	stw		r4,8(r1)
	lis		r4,Os_API_StartScheduleTableRel@ha
	e_add16i		r4,r4,Os_API_StartScheduleTableRel@l
	stw		r4,20(r1)
	diab.li		r4,0
	stw		r4,16(r1)
# 
#     Os_StartScheduleTableRelAPI_Call.Os_API_Data.Os_ApiStartScheduleTableRel.SchTblId  =  schTblId;
	.d2line		75
	stw		r3,24(r1)		# schTblId=r3
#     Os_StartScheduleTableRelAPI_Call.Os_API_Data.Os_ApiStartScheduleTableRel.Offset    =  offset;
	.d2line		76
	stw		r0,28(r1)		# offset=r0
# 
#     OS_SYSCALL(Os_StartScheduleTableRelAPI_Call);
	.d2line		78
	diab.addi		r3,r1,8		# schTblId=r3
.Llo2:
	bl		OS_SYS_CALL
# 
#     return Os_StartScheduleTableRelAPI_Call.Os_API_ReturnValue;
	.d2line		80
.Llo5:
...
# }
	.d2line		81
	.d2epilogue_begin
	lwz		r0,52(r1)		# offset=r0
	mtspr		lr,r0		# offset=lr
	diab.addi		r1,r1,48		
...
# Allocations for StartScheduleTableRel
#	?a4		schTblId
#	?a5		offset
#	SP,8		Os_StartScheduleTableRelAPI_Call
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_StartScheduleTableRel_Err_Dyn(
	.section	.Os_TEXT,,c
	.align		1
...
#$$bf	Os_StartScheduleTableRel_Err_Dyn,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_StartScheduleTableRel_Err_Dyn:
.Llo6:
	stwu		r1,-32(r1)		
...
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_STATE); /* [OS277-01] */
	.d2line		270
...
#$$ld
.L11436:
	.type		Os_StartScheduleTableRel_Err_Dyn,@function
	.size		Os_StartScheduleTableRel_Err_Dyn,.-Os_StartScheduleTableRel_Err_Dyn
# Number of nodes = 32

# Allocations for Os_StartScheduleTableRel_Err_Dyn
#	?a4		callerProc
#	?a5		schTblId
#	?a6		retVal
# FUNC(StatusType, OS_CODE) Os_StartScheduleTableRel(P2CONST(Os_ProcStatType,AUTOMATIC ,OS_CONST) callerProc,
	.align		2
	.section	.Os_TEXT,,c
        .d2line         165,27
#$$ld
...
#$$bf	Os_StartScheduleTableRel,interprocedural,rasave,nostackparams
	.globl		Os_StartScheduleTableRel
	.d2_cfa_start __cie
...
.Llo17:
	...
	mr		r30,r4		# schTblId=r30 schTblId=r4
	mr		r29,r5		# offset=r29 offset=r5
	.d2prologue_end
#                                                           CONST(ScheduleTableType, AUTOMATIC)   schTblId,
...
#     VAR (StatusType, AUTOMATIC) retVal;
# 
#     retVal = Os_StartScheduleTableRel_Err_Dyn(callerProc,schTblId);
	.d2line		171
	mr		r3,r31		# callerProc=r3 callerProc=r31
.Llo18:
	mr		r4,r30		# schTblId=r4 schTblId=r30
.Llo21:
	bl		Os_StartScheduleTableRel_Err_Dyn
.Llo22:
	mr		r28,r3		# retVal=r28 retVal=r3
# 
#     if( E_OK == retVal ) /* [OS278-04] */
	.d2line		173
.Llo23:
	rlwinm		r3,r3,0,24,31		# retVal=r3 retVal=r3
.Llo24:
	...
	bc		0,2,.L11374	# ne
#     {
#         Os_SchTblStartRel(schTblId, offset);
	.d2line		175
.Llo19:
	mr		r3,r30		# schTblId=r3 schTblId=r30
.Llo25:
	mr		r4,r29		# offset=r4 offset=r29
...
.Llo28:
	stwux		r30,r3,r0		# retVal=r3 schTblId=r30
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TicksStart = offset;
	.d2line		184
	lis		r3,(Os_Core_DynShared+36)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+36)@l		# retVal=r3 retVal=r3
	stwx		r29,r3,r0		# retVal=r3 offset=r29
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_StartScheduleTableRel,callerProc); /* [OS001-302.v1-20] */
	.d2line		188
...
#$$ld
.L11451:
	.type		Os_StartScheduleTableRel,@function
	.size		Os_StartScheduleTableRel,.-Os_StartScheduleTableRel
# Number of nodes = 61

# Allocations for Os_StartScheduleTableRel
#	?a4		callerProc
#	?a5		schTblId
#	?a6		offset
#	?a7		retVal
#	?a8		coreId
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_StartScheduleTableRel_Err_Stat(
	.align		1
	.section	.Os_TEXT,,c
        .d2line         200,40
#$$ld
...
#$$bf	Os_StartScheduleTableRel_Err_Stat,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_StartScheduleTableRel_Err_Stat:
.Llo29:
	stwu		r1,-32(r1)		
	.d2_cfa_def_cfa_offset	32
	mfspr		r0,lr
.Llo38:
	...
	.d2_cfa_offset    108,-1
	mr		r31,r4		# schTblId=r31 schTblId=r4
	mr		r30,r5		# offset=r30 offset=r5
	.d2prologue_end
#                                             P2CONST ( Os_ProcStatType,   AUTOMATIC, OS_CONST ) callerProc,
#                                             CONST   ( ScheduleTableType, AUTOMATIC )           schTblId,
#                                             CONST   ( TickType,          AUTOMATIC )           offset
...
#     if (retVal == E_OK)
	...
	bc		0,2,.L11379	# ne
#     {
#         if(Os_SchTblStat[schTblId].Os_SchTblSyncStrategy == OS_IMPLICIT) /* [OS430] */
	.d2line		212
.Llo32:
	lis		r3,Os_SchTblStat@ha		# retVal=r3
.Llo40:
	lwz		r3,Os_SchTblStat@l(r3)		# retVal=r3 retVal=r3
	e_mulli		r0,r31,40		# retVal=r0 schTblId=r31
	se_add		r3,r0		# retVal=r3 retVal=r3 retVal=r0
.Llo41:
...
.Llo42:
	...
	bc		0,2,.L11380	# ne
#         {
#             retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ID); /* [OS275-01] [OS452-01] */
	.d2line		214
.Llo43:
...
#         else
#         {
#             P2CONST (Os_SchTblEPStatType, AUTOMATIC, OS_CONST) firstEP;
# 
#             if ( 0 == ( Os_SchTblStat[schTblId].Os_SchTblInitialEP->Os_SchTblEPEventSetCount +
	.d2line		220
.Llo45:
...
.Llo46:
	...
	se_add		r3,r0		# retVal=r3 retVal=r3 retVal=r0
.Llo47:
	lwz		r3,12(r3)		# retVal=r3 retVal=r3
.Llo48:
	lwz		r3,12(r3)		# retVal=r3 retVal=r3
	lwz		r4,Os_SchTblStat@l(r4)
	se_add		r4,r0		# retVal=r0
	lwz		r4,12(r4)
	lwz		r0,4(r4)		# retVal=r0
	add.		r0,r0,r3		# retVal=r0 retVal=r0 retVal=r3
.Llo49:
	bc		0,2,.L11382	# ne
#                         Os_SchTblStat[schTblId].Os_SchTblInitialEP->Os_SchTblEPTaskActCount    ) )
#             {
#                 /* Advancing pointer inside array. */
#                 firstEP = Os_SchTblStat[schTblId].Os_SchTblInitialEP + 1;
	.d2line		224
	lis		r3,Os_SchTblStat@ha		# retVal=r3
.Llo50:
	lwz		r3,Os_SchTblStat@l(r3)		# retVal=r3 retVal=r3
...
#             else
#             {
#                 firstEP = Os_SchTblStat[schTblId].Os_SchTblInitialEP;
	.d2line		228
.Llo53:
	lis		r3,Os_SchTblStat@ha		# retVal=r3
.Llo54:
...
.Llo35:
	...
	lwz		r0,4(r3)		# retVal=r0 retVal=r3
	lwz		r3,0(r4)		# retVal=r3 firstEP=r4
.Llo59:
	subf		r3,r3,r0		# retVal=r3 retVal=r3 retVal=r0
.Llo60:
	se_cmpl		r3,r30		# retVal=r3 offset=r30
	bc		0,0,.L11384	# ge
.L11386:
#                  || ( offset > ( Os_CounterGetMaxAllowedValue(Os_SchTblStat[schTblId].Os_SchTblCounter) -
#                                  firstEP->Os_SchTblEPDelay ) )
#                 )
#             {
#                 retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_VALUE); /* [OS332-01] [OS276-01] */
	.d2line		236
.Llo36:
...
#$$ld
.L11472:
	.type		Os_StartScheduleTableRel_Err_Stat,@function
	.size		Os_StartScheduleTableRel_Err_Stat,.-Os_StartScheduleTableRel_Err_Stat
# Number of nodes = 100

# Allocations for Os_StartScheduleTableRel_Err_Stat
#	?a4		callerProc
#	?a5		schTblId
#	?a6		offset
#	?a7		retVal
#	?a8		firstEP
# OS_API(StartScheduleTableRel)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         95,1
#$$ld
...
#$$bf	Os_API_StartScheduleTableRel,interprocedural,rasave,nostackparams
	.globl		Os_API_StartScheduleTableRel
	.d2_cfa_start __cie
...
#     CONST (ScheduleTableType, AUTOMATIC)  schTblId    =  Os_APICall->Os_API_Data.Os_ApiStartScheduleTableRel.SchTblId;
	.d2line		98
.Llo74:
	lwz		r28,16(r31)		# Os_APICall=r31
.Llo89:
	mr		r28,r28		# schTblId=r28 schTblId=r28
#     CONST (TickType, AUTOMATIC)           offset      =  Os_APICall->Os_API_Data.Os_ApiStartScheduleTableRel.Offset;
	.d2line		99
	lwz		r27,20(r31)		# Os_APICall=r31
.Llo91:
	mr		r27,r27		# offset=r27 offset=r27
...
# 
#     OS_TRACE(StartScheduleTableRel_Entry , coreId);
	.d2line		105
	diab.li		r0,27		# retVal=r0
.Llo75:
...
#     if(OS_HOOKID_NONE != OS_GET_CORE_HOOK_DYN ( coreId )->Os_HookID)
	...
	bc		1,2,.L11360	# eq
#     {
#         /* [OS088-03-186] [OS088-03-187] [OS088-03-188] [OS088-03-189] [OS088-03-190]
#          * [OS088-03-191] [OS088-03-192] [OS088-03-359] [OS088-03-402] [OS088-03-446]
#          * [OS-MGC-0056-22] [OS-MGC-0056-65]
#          */
...
# 
#     retVal = Os_StartScheduleTableRel_Err_Stat(callerProc, schTblId, offset);
	.d2line		121
	mr		r3,r30		# callerProc=r3 callerProc=r30
	mr		r4,r28		# schTblId=r4 schTblId=r28
	mr		r5,r27		# offset=r5 offset=r27
	bl		Os_StartScheduleTableRel_Err_Stat
.Llo78:
...
#         {
#             /*[OS645-01-MGC]*/
#             OS_API_ALLOCAPIREMULTI(StartScheduleTableRel, coreId, Os_SchTblStat[schTblId].Os_SchTblCounter->Os_CounterCoreId);
	.d2line		131
.Llo72:
...
.Llo95:
	lis		r3,Os_API_MC_StartScheduleTableRel@ha		# retVal=r3
.Llo81:
	e_add16i		r3,r3,Os_API_MC_StartScheduleTableRel@l		# retVal=r3 retVal=r3
...
#       #endif
#         {
#             Os_APICall->Os_API_ReturnValue =  Os_StartScheduleTableRel(callerProc, schTblId, offset);
	.d2line		136
.Llo69:
	mr		r3,r30		# callerProc=r3 callerProc=r30
	mr		r4,r28		# schTblId=r4 schTblId=r28
	mr		r5,r27		# offset=r5 offset=r27
	bl		Os_StartScheduleTableRel
.Llo84:
...
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TicksStart = offset;
	...
	lis		r3,(Os_Core_DynShared+36)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+36)@l		# retVal=r3 retVal=r3
	stwx		r27,r3,r0		# retVal=r3 offset=r27
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_StartScheduleTableRel,callerProc); /* [OS001-302.v1-20] */
...
#     }
# 
#     OS_TRACE(StartScheduleTableRel_Exit , coreId);
	.d2line		152
.Llo70:
...
#$$ld
.L11492:
	.type		Os_API_StartScheduleTableRel,@function
	.size		Os_API_StartScheduleTableRel,.-Os_API_StartScheduleTableRel
# Number of nodes = 207

# Allocations for Os_API_StartScheduleTableRel
#	?a4		Os_APICall
#	?a5		callerProc
#	?a6		retVal
#	?a7		schTblId
...
#	?a9		coreId
#	?a10		_disp
# OS_APIMC(StartScheduleTableRel)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         156,1
#$$ld
...
#$$bf	Os_API_MC_StartScheduleTableRel,interprocedural,rasave,nostackparams
	.globl		Os_API_MC_StartScheduleTableRel
	.d2_cfa_start __cie
Os_API_MC_StartScheduleTableRel:
.Llo97:
	stwu		r1,-32(r1)		
	.d2_cfa_def_cfa_offset	32
	mfspr		r0,lr
...
#                                 Os_StartScheduleTableRel( callerProc,
#                                                           Os_APICall->Os_API_Data.Os_ApiStartScheduleTableRel.SchTblId,
#                                                           Os_APICall->Os_API_Data.Os_ApiStartScheduleTableRel.Offset );
# }
	.d2line		162
	.d2epilogue_begin
	lwz		r31,28(r1)		# offset r1+28  0x1c
...
#$$ld
.L11520:
	.type		Os_API_MC_StartScheduleTableRel,@function
	.size		Os_API_MC_StartScheduleTableRel,.-Os_API_MC_StartScheduleTableRel
# Number of nodes = 19

# Allocations for Os_API_MC_StartScheduleTableRel
#	?a4		Os_APICall
#	?a5		callerProc
...
.L12082:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L12080:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L12078:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L12076:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L12057:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L12055:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L12038:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L12018:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
...
.L11834:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
.L11595:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
.L11543:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_SchedulerCfgTypes.h"
.L11532:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_CoreCfgTypes.h"
.L11525:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ScheduleTableCfgTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11403:
.L11411:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StartScheduleTableRel.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11429:
.L11437:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StartScheduleTableRel.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\expiry_element\\schedule_table\\Os_StartScheduleTableRel.c"
	.byte		0
...
.L11422:
	...
	.uleb128	71
	.uleb128	37
	.byte		"Os_StartScheduleTableRelAPI_Call"
	.byte		0
	.4byte		.L11423
	.sleb128	3
	.byte		0x92
...
.L11438:
	.sleb128	5
	.4byte		.L11434-.L11426
	.byte		"Os_StartScheduleTableRel_Err_Dyn"
	.byte		0
	.4byte		.L11437
	.uleb128	258
	.uleb128	40
...
.L11473:
	.sleb128	5
	.4byte		.L11470-.L11426
	.byte		"Os_StartScheduleTableRel_Err_Stat"
	.byte		0
	.4byte		.L11437
	.uleb128	200
	.uleb128	40
...
.L11493:
	.sleb128	8
	.4byte		.L11490-.L11426
	.byte		"Os_API_StartScheduleTableRel"
	.byte		0
	.4byte		.L11437
	.uleb128	95
	.uleb128	1
...
.L11521:
	.sleb128	8
	.4byte		.L11518-.L11426
	.byte		"Os_API_MC_StartScheduleTableRel"
	.byte		0
	.4byte		.L11437
	.uleb128	156
	.uleb128	1
...
.L11454:
	...
	.d2locend
.L11456:
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo22),5
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo20),29
	.d2locend
.L11458:
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo23),28
...
.L11478:
	...
	.d2locreg	%offsetof(.Llo30), %offsetof(.Llo32),3
	...
	.d2locreg	%offsetof(.Llo60), %offsetof(.Llo36),0
	.d2locreg	%offsetof(.Llo61), %offsetof(.Llo37),3
	.d2locreg	%offsetof(.Llo62), %offsetof(.Llo63),3
	.d2locend
.L11488:
	.d2locreg	%offsetof(.Llo64), %offsetof(.Llo53),4
	.d2locreg	%offsetof(.Llo56), %offsetof(.Llo37),4
	.d2locend
.L11495:
	...
	.d2locend
.L11499:
	.d2locreg	%offsetof(.Llo65), %offsetof(.Llo71),4
	.d2locreg	%offsetof(.Llo67), %offsetof(.Llo72),30
	.d2locreg	%offsetof(.Llo69), %offsetof(.Llo70),30
	.d2locend
.L11501:
	.d2locreg	%offsetof(.Llo73), %offsetof(.Llo74),0
	.d2locreg	%offsetof(.Llo75), %offsetof(.Llo67),0
	.d2locreg	%offsetof(.Llo76), %offsetof(.Llo77),0
	.d2locreg	%offsetof(.Llo78), %offsetof(.Llo79),3
	.d2locreg	%offsetof(.Llo80), %offsetof(.Llo72),29
	.d2locreg	%offsetof(.Llo81), %offsetof(.Llo82),3
	.d2locreg	%offsetof(.Llo83), %offsetof(.Llo68),0
	.d2locreg	%offsetof(.Llo84), %offsetof(.Llo85),3
	.d2locreg	%offsetof(.Llo86), %offsetof(.Llo70),29
	.d2locreg	%offsetof(.Llo87), %offsetof(.Llo88),3
	.d2locend
.L11503:
	.d2locreg	%offsetof(.Llo89), %offsetof(.Llo72),28
	.d2locreg	%offsetof(.Llo83), %offsetof(.Llo90),28
	.d2locreg	%offsetof(.Llo69), %offsetof(.Llo70),28
	.d2locend
.L11505:
	.d2locreg	%offsetof(.Llo91), %offsetof(.Llo72),27
	.d2locreg	%offsetof(.Llo69), %offsetof(.Llo70),27
	.d2locend
.L11507:
	.d2locreg	%offsetof(.Llo65), %offsetof(.Llo70),26
	.d2locreg	%offsetof(.Llo92), %offsetof(.Llo93),26
	.d2locend
.L11516:
	.d2locreg	%offsetof(.Llo94), %offsetof(.Llo95),3
	.d2locreg	%offsetof(.Llo81), %offsetof(.Llo68),4
	.d2locreg	%offsetof(.Llo96), %offsetof(.Llo88),4
	.d2locend
.L11522:
	...
	.d2locend
.L11523:
	.d2locreg	%offsetof(.Llo97), %offsetof(.Llo101),4
	...
	.wrcm.nelem "Os_API_MC_StartScheduleTableRel"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_StartScheduleTableRel"
	.wrcm.end
	.wrcm.nelem "Os_API_StartScheduleTableRel"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_Dispatcher_Alloc_Core","Os_ShutdownAllCores","Os_StartScheduleTableRel","Os_StartScheduleTableRel_Err_Stat"
	.wrcm.end
	.wrcm.nelem "Os_StartScheduleTableRel_Err_Stat"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_SchTbl_Err_Stat"
	.wrcm.end
	.wrcm.nelem "Os_StartScheduleTableRel"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_SchTblStartRel","Os_StartScheduleTableRel_Err_Dyn"
	.wrcm.end
	.wrcm.nelem "Os_StartScheduleTableRel_Err_Dyn"
	.wrcm.nint32 "local", 1
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_SchTbl_Err_Dyn"
	.wrcm.end
	.wrcm.nelem "StartScheduleTableRel"
	.wrcm.nint32 "frameSize", 48
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_StartScheduleTableRel.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\expiry_element\schedule_table\Os_StartScheduleTableRel.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
