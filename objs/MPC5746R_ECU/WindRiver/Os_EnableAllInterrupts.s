...
.L11384:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_EnableAllInterrupts.c"
        .d2line         50,22
#$$ld
.L11391:

#$$bf	EnableAllInterrupts,interprocedural,rasave,nostackparams
...
# 
#     VAR (Os_APICallType, AUTOMATIC) Os_EnableAllInterruptCall;
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_EnableAllInterruptCall, EnableAllInterrupts );
# 
#   #else
# 
#     Os_PublicData[OS_GETCOREIDASUSER()].Os_PublicDataVarInitRef->Os_ISRServices->Os_EnAllInt();
	.d2line		63
...
# Allocations for EnableAllInterrupts
#	?a4		$$2352
# FUNC(void,OS_CODE)  Os_EnableAllInterruptsDefault(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         70,21
#$$ld
...
#$$bf	Os_EnableAllInterruptsDefault,interprocedural,nostackparams

# Regs written: r0,r1,cr0,lr
	.globl		Os_EnableAllInterruptsDefault
	.d2_cfa_start __cie
Os_EnableAllInterruptsDefault:
	stwu		r1,-16(r1)		
	.d2_cfa_def_cfa_offset	16
	mfspr		r0,lr
	stw		r0,20(r1)
...
#$$ld
.L11398:
	.type		Os_EnableAllInterruptsDefault,@function
	.size		Os_EnableAllInterruptsDefault,.-Os_EnableAllInterruptsDefault
# Number of nodes = 17

# Allocations for Os_EnableAllInterruptsDefault
#	not allocated	$$2353
# FUNC(void,OS_CODE)  Os_EnableAllInterruptsAPITrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         77,21
#$$ld
...
#$$bf	Os_EnableAllInterruptsAPITrusted,interprocedural,rasave,nostackparams
	.globl		Os_EnableAllInterruptsAPITrusted
	.d2_cfa_start __cie
Os_EnableAllInterruptsAPITrusted:
.Llo1:
	stwu		r1,-32(r1)		
...
#     OS_TRACE(EnableAllInterrupts_Entry , coreID);
	.d2line		85
	diab.li		r0,97
...
#     /* [OS-MGC-0079-01] */
# 
#     if(OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_DisableAllCount == 0U)    /* [OS092-01] */
	.d2line		91
	...
	bc		0,2,.L11364	# ne
#     {
#         /* [OS092-01] [OS-MGC-0067-01] [OS-MGC-0067-02] */
...
# 
#     /*
#      * Note that because of Os_DisableAllCount is not zero, Os_SuspendAllCount and Os_SuspendOSCount must be zeros
#      * since SuspendAllInterrupts and SuspendOsInterrupts calls are only valid if Os_DisableAllCount is zero.
#      */
# 
#     else
# 
...
# 
#         Os_TPTimer_Stop(OS_SCHEDULER_GET_CURRENT_PROC(coreID)->Os_ProcLockAllTimerConf); /* [OS037-04] */
# 
...
#         OS_GET_CORE_ISR_DYN_INIT(coreID)->Os_DisableAllCount--;
	...
	stw		r3,8(r4)
# 
#         OS_CALL_RTM_ENABLE_ALL_INTERRUPTS(coreID);
# 
#   #ifdef OS_MODULE_TIMINGPROTECTION
# 
#         OS_DISABLE_ALLINTR ();
...
#     }
# 
#     OS_TRACE(EnableAllInterrupts_Exit , coreID);
	.d2line		130
.Llo2:
	diab.li		r3,96
...
#$$ld
.L11403:
	.type		Os_EnableAllInterruptsAPITrusted,@function
	.size		Os_EnableAllInterruptsAPITrusted,.-Os_EnableAllInterruptsAPITrusted
# Number of nodes = 92

# Allocations for Os_EnableAllInterruptsAPITrusted
#	?a4		$$2355
#	not allocated	$$2354
#	?a5		coreID
# FUNC(void,OS_CODE)  Os_EnableAllInterruptsAPINonTrusted(void)
	.align		2
	.section	.Os_PUBLIC_TEXT,,c
        .d2line         140,21
#$$ld
...
#$$bf	Os_EnableAllInterruptsAPINonTrusted,interprocedural,rasave,nostackparams
	.globl		Os_EnableAllInterruptsAPINonTrusted
	.d2_cfa_start __cie
Os_EnableAllInterruptsAPINonTrusted:
	stwu		r1,-48(r1)		
...
#     OS_LIGHT_SYSCALL ( Os_EnableAllInterruptCall, EnableAllInterrupts );
	.d2line		145
	diab.addi		r3,r1,8
	lis		r4,Os_API_EnableAllInterrupts@ha
	e_add16i		r4,r4,Os_API_EnableAllInterrupts@l
	bl		OS_SYS_CALL
# }
	.d2line		146
	.d2epilogue_begin
...
#$$ld
.L11414:
	.type		Os_EnableAllInterruptsAPINonTrusted,@function
	.size		Os_EnableAllInterruptsAPINonTrusted,.-Os_EnableAllInterruptsAPINonTrusted
# Number of nodes = 8

# Allocations for Os_EnableAllInterruptsAPINonTrusted
#	SP,8		Os_EnableAllInterruptCall
# OS_APILIGHT(EnableAllInterrupts)
	.section	.Os_TEXT,,c
	.align		2
...
#$$bf	Os_API_EnableAllInterrupts,interprocedural,rasave,nostackparams
	.globl		Os_API_EnableAllInterrupts
	.d2_cfa_start __cie
...
#      *
#      * [OS088-01-027] [OS088-01-028] [OS088-01-029] [OS088-01-030] [OS088-01-031]
#      * [OS088-01-032] [OS088-01-033] [OS088-01-034] [OS088-01-035] [OS088-01-036]
#      * [OS088-01-206] [OS088-01-227] [OS088-01-228] [OS-MGC-0055-03] [OS-MGC-0055-17]
#      */
# 
#   #ifdef OS_CONFIG_INTERRUPTSERVICE_VALIDATION
# 
...
#         {
#             /* [OS037-04] */
#             Os_TPTimer_Stop ( currentTask->Os_ProcLockAllTimerConf );
#         }
# 
#   #endif /* OS_MODULE_TIMINGPROTECTION */
#     }
...
#$$ld
.L11430:
	.type		Os_API_EnableAllInterrupts,@function
	.size		Os_API_EnableAllInterrupts,.-Os_API_EnableAllInterrupts
# Number of nodes = 109

# Allocations for Os_API_EnableAllInterrupts
...
.L11884:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11839:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11791:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
.L11788:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
.L11763:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TrustedFunctionCfgTypes.h"
...
.L11437:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_PublicDataTypes.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11385:
.L11393:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_EnableAllInterrupts.c"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11423:
.L11431:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_EnableAllInterrupts.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\misc\\Os_EnableAllInterrupts.c"
	.byte		0
...
.L11399:
	.sleb128	2
	.4byte		.L11396-.L11382
	.byte		"Os_EnableAllInterruptsDefault"
	.byte		0
	.4byte		.L11393
	.uleb128	70
	.uleb128	21
...
.L11404:
	.sleb128	2
	.4byte		.L11401-.L11382
	.byte		"Os_EnableAllInterruptsAPITrusted"
	.byte		0
	.4byte		.L11393
	.uleb128	77
	.uleb128	21
...
.L11415:
	.sleb128	2
	.4byte		.L11412-.L11382
	.byte		"Os_EnableAllInterruptsAPINonTrusted"
	.byte		0
	.4byte		.L11393
	.uleb128	140
	.uleb128	21
...
.L11416:
	...
	.uleb128	142
	.uleb128	37
	.byte		"Os_EnableAllInterruptCall"
	.byte		0
	.4byte		.L11417
	.sleb128	3
	.byte		0x92
...
.L11432:
	.sleb128	2
	.4byte		.L11428-.L11420
	.byte		"Os_API_EnableAllInterrupts"
	.byte		0
	.4byte		.L11431
	.uleb128	157
	.uleb128	1
...
.L11435:
	...
	.wrcm.nelem "Os_API_EnableAllInterrupts"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_EnableAllInterruptsAPINonTrusted"
	.wrcm.nint32 "frameSize", 48
	.wrcm.nstrlist "calls", "OS_SYS_CALL"
	.wrcm.end
	.wrcm.nelem "Os_EnableAllInterruptsAPITrusted"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook"
	.wrcm.end
	.wrcm.nelem "Os_EnableAllInterruptsDefault"
	.wrcm.nint32 "frameSize", 16
	.wrcm.end
	.wrcm.nelem "EnableAllInterrupts"
	.wrcm.nint32 "frameSize", 16
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_EnableAllInterrupts.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\misc\Os_EnableAllInterrupts.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
