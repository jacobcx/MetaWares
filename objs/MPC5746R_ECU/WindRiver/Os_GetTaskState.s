...
.L11419:
	...
	.section	.Os_PUBLIC_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_GetTaskState.c"
        .d2line         70,28
#$$ld
.L11426:

#$$bf	GetTaskState,interprocedural,rasave,nostackparams
	.globl		GetTaskState
	.d2_cfa_start __cie
GetTaskState:
.Llo3:
	...
	mr		r4,r4		# taskState=r4 taskState=r4
	.d2prologue_end
#         VAR (TaskType,         AUTOMATIC)  taskId,
#         VAR (TaskStateRefType, AUTOMATIC)  taskState )
# {
# 
#     VAR (Os_APICallType,AUTOMATIC) Os_GetTaskStateCall;
# 
#     Os_GetTaskStateCall.Os_API_Data.Os_ApiGetTaskState.TaskId        =  taskId;
	.d2line		77
	stw		r3,24(r1)		# taskId=r3
#     Os_GetTaskStateCall.Os_API_Data.Os_ApiGetTaskState.TaskStateRef  =  taskState;
	.d2line		78
	stw		r4,28(r1)		# taskState=r4
# 
#     /* Taking address of function on purpose */
#     OS_LIGHT_SYSCALL ( Os_GetTaskStateCall, GetTaskState );
	.d2line		81
	diab.addi		r3,r1,8		# taskId=r3
.Llo4:
	lis		r4,Os_API_GetTaskState@ha		# taskState=r4
	e_add16i		r4,r4,Os_API_GetTaskState@l		# taskState=r4 taskState=r4
.Llo5:
	bl		OS_SYS_CALL
# 
#     return  Os_GetTaskStateCall.Os_API_ReturnValue;
	.d2line		83
...
# Allocations for GetTaskState
#	?a4		taskId
#	?a5		taskState
#	SP,8		Os_GetTaskStateCall
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_GetTaskState_Err_Dyn (
	.section	.Os_TEXT,,c
	.align		1
	.section	.Os_TEXT,,c
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_GetTaskState.c"
...
#$$bf	Os_GetTaskState_Err_Dyn,interprocedural,rasave,nostackparams

# Regs written: r0,r1,r3,r4,r5,r6,r7,r8,cr0,lr
	.d2_cfa_start __cie
Os_GetTaskState_Err_Dyn:
.Llo6:
	stwu		r1,-16(r1)		
	.d2_cfa_def_cfa_offset	16
	mfspr		r0,lr
	...
	mr		r8,r4		# taskId=r8 taskId=r4
	.d2prologue_end
#         P2CONST (Os_ProcStatType, AUTOMATIC, AUTOMATIC)  callerProc,
#         VAR     (TaskType,        AUTOMATIC)             taskId)
# {
#     VAR (StatusType, AUTOMATIC) retVal;
# 
#     /* The API should not return error if the following conditions satisfies
#      * If the parameter is a valid address != NULL_PTR
#      * If calling level is task level or Cat 2 interrupt level or error hook
#      *         or pretask hook or post task hook
#      * If TaskID is valid
#      * If current application has got access to the TaskID
#      * If the task had got access to the address that came as the argument */
# 
...
.Llo10:
	...
	bc		1,2,.L11377	# eq
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR,E_OS_DISABLEDINT);     /* [OS093-01-06] [OS093-02-06] */
	.d2line		212
.Llo8:
...
.Llo9:
	...
	e_add16i		r3,r3,(Os_Proc_Stat+48)@l
.Llo11:
	e_mulli		r8,r8,80		# taskId=r8 taskId=r8
.Llo12:
	lwzx		r3,r3,r8
	lwz		r3,0(r3)
	lbz		r0,0(r3)
...
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR,E_OS_ACCESS); /* [OS509-01-03] */
	.d2line		220
...
#$$ld
.L11450:
	.type		Os_GetTaskState_Err_Dyn,@function
	.size		Os_GetTaskState_Err_Dyn,.-Os_GetTaskState_Err_Dyn
# Number of nodes = 52

# Allocations for Os_GetTaskState_Err_Dyn
#	?a4		callerProc
#	?a5		taskId
#	?a6		retVal
# LOCAL_INLINE FUNC(StatusType, OS_CODE) Os_GetTaskState (
	.align		1
	.section	.Os_TEXT,,c
        .d2line         161,40
#$$ld
...
#$$bf	Os_GetTaskState,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_GetTaskState:
.Llo19:
	stwu		r1,-32(r1)		
	...
	stw		r0,36(r1)
	.d2_cfa_offset    108,-1
	mr		r9,r3		# callerProc=r9 callerProc=r3
	mr		r10,r4		# taskId=r10 taskId=r4
	mr		r30,r5		# stateRef=r30 stateRef=r5
	.d2prologue_end
#         CONSTP2CONST (Os_ProcStatType,  AUTOMATIC, OS_CONST)  callerProc,
#         CONST        (TaskType,         AUTOMATIC)            taskId,
#         VAR          (TaskStateRefType, AUTOMATIC)            stateRef )
# {
#     VAR (StatusType, AUTOMATIC)  retVal;
# 
#     retVal  = Os_GetTaskState_Err_Dyn ( callerProc, taskId );
	.d2line		168
	mr		r3,r9		# callerProc=r3 callerProc=r9
.Llo20:
	mr		r4,r10		# taskId=r4 taskId=r10
.Llo23:
	bl		Os_GetTaskState_Err_Dyn
.Llo27:
...
#     if( E_OK == retVal )
	...
	bc		0,2,.L11372	# ne
#     {
#         *stateRef = Os_Proc_Stat[taskId].Os_ProcDyn->Os_ProcState; /* [OS001-053.v1] [OS001-054.v1] */
	.d2line		172
.Llo21:
	lis		r3,(Os_Proc_Stat+8)@ha		# retVal=r3
.Llo28:
	e_add16i		r3,r3,(Os_Proc_Stat+8)@l		# retVal=r3 retVal=r3
.Llo24:
	e_mulli		r10,r10,80		# taskId=r10 taskId=r10
.Llo25:
	lwzx		r3,r3,r10		# retVal=r3 retVal=r3
	lwz		r0,0(r3)		# retVal=r3
	stw		r0,0(r30)		# stateRef=r30
	b		.L11373
.L11372:
	.section	.Os_TEXT,,c
.L11473:
...
.Llo31:
	stwux		r10,r3,r0		# retVal=r3 taskId=r10
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TaskStateRef = stateRef;
	.d2line		181
	lis		r3,(Os_Core_DynShared+84)@ha		# retVal=r3
	e_add16i		r3,r3,(Os_Core_DynShared+84)@l		# retVal=r3 retVal=r3
	stwx		r30,r3,r0		# retVal=r3 stateRef=r30
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_ActivateTask, callerProc); /* [OS001-302.v1-06] */
	.d2line		185
	rlwinm		r3,r31,0,24,31		# retVal=r3 retVal=r31
	diab.li		r4,128
	mr		r5,r9		# callerProc=r5 callerProc=r9
...
#$$ld
.L11464:
	.type		Os_GetTaskState,@function
	.size		Os_GetTaskState,.-Os_GetTaskState
# Number of nodes = 68

# Allocations for Os_GetTaskState
#	?a4		callerProc
#	?a5		taskId
#	?a6		stateRef
#	?a7		retVal
#	?a8		coreId
# LOCAL_INLINE FUNC (StatusType, OS_CODE) Os_GetTaskState_Err_Stat (
	.align		1
	.section	.Os_TEXT,,c
        .d2line         239,41
#$$ld
...
#$$bf	Os_GetTaskState_Err_Stat,interprocedural,rasave,nostackparams
	.d2_cfa_start __cie
Os_GetTaskState_Err_Stat:
.Llo32:
	stwu		r1,-32(r1)		
	.d2_cfa_def_cfa_offset	32
	mfspr		r0,lr
	...
	mr		r29,r5		# taskStateRef=r29 taskStateRef=r5
	.d2prologue_end
#         /*Parameter only used in some configurations*/
#         P2CONST (Os_ProcStatType, AUTOMATIC, AUTOMATIC)  callerProc,
#         VAR     (TaskType,        AUTOMATIC)             taskId,
#         P2CONST (TaskStateType,   AUTOMATIC, AUTOMATIC)  taskStateRef )
# {
#     VAR (StatusType, AUTOMATIC) retVal;
# 
#     /* The API should not return error if the following conditions satisfies
...
.Llo36:
	...
	bc		0,2,.L11385	# ne
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ID); /* [OS001-052.v1] */
	.d2line		257
.Llo34:
...
.L11385:
#     }
#     else if(NULL_PTR == taskStateRef)
	.d2line		259
.Llo42:
	se_cmpi		r29,0		# taskStateRef=r29
	bc		0,2,.L11387	# ne
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_PARAM_POINTER); /* [OS566-02] */
	.d2line		261
.Llo40:
...
#                                                           OS_CASTTOADDRESS(taskStateRef),
#                                                           OS_SIZEOF(TaskStateType),
#                                                           TRUE)))
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ILLEGAL_ADDRESS); /* [OS051-01-MGC-02] */
#     }
# 
...
#     {
#         retVal = OS_GET_ERRORCODE(E_OS_SYS_ERROR, E_OS_ACCESS); /*  [OS448-01-03] */
	.d2line		281
	diab.li		r3,1		# retVal=r3
	isel		r3,r3,r28,2		# retVal=r3 retVal=r3 retVal=r28
.L11389:
#     }
# 
#   #endif /* OS_MODULE_APPLICATION */
...
#          * [OS088-01-012] [OS088-01-013] [OS001-050.v1]
#          */
#         retVal = E_OK;
	.d2line		291
.Llo35:
...
#$$ld
.L11482:
	.type		Os_GetTaskState_Err_Stat,@function
	.size		Os_GetTaskState_Err_Stat,.-Os_GetTaskState_Err_Stat
# Number of nodes = 49

# Allocations for Os_GetTaskState_Err_Stat
#	?a4		callerProc
#	?a5		taskId
#	?a6		taskStateRef
#	?a7		retVal
# OS_APILIGHT(GetTaskState)
	.align		2
	.section	.Os_TEXT,,c
        .d2line         97,1
#$$ld
...
#$$bf	Os_API_GetTaskState,interprocedural,rasave,nostackparams
	.globl		Os_API_GetTaskState
	.d2_cfa_start __cie
Os_API_GetTaskState:
.Llo48:
	stwu		r1,-48(r1)		
...
.Llo49:
	...
	rlwinm		r4,r28,0,16,31		# coreId=r28
	e_mulli		r5,r4,20
	lwzx		r3,r3,r5
	lwz		r27,28(r3)
.Llo61:
...
# 
#     OS_TRACE(GetTaskState_Entry , coreId);
	.d2line		104
	diab.li		r0,59
...
#     if ( OS_HOOKISNOT(   OS_HOOKID_NONE          /* [OS088-01-012] */
	.d2line		109
	...
	se_cmpi		r0,0
	bc		0,2,.L11362	# ne
#                        | OS_HOOKID_ERRORHOOK     /* [OS088-01-014] */
#                        | OS_HOOKID_PRETASKHOOK   /* [OS088-01-015] */
#                        | OS_HOOKID_POSTTASKHOOK  /* [OS088-01-016] */
#                        | OS_HOOKID_APPERRORHOOK  /* [OS088-01-204] */
#                        | OS_HOOKID_PREAPPHOOK    /* [OS-MGC-0055-01] */
#                        | OS_HOOKID_POSTAPPHOOK   /* [OS-MGC-0055-15] */
#                        ,coreId))
#     {
#         /* [OS088-03-041] [OS088-03-042] [OS088-03-043] [OS088-03-044] [OS088-03-383]
#          * [OS088-03-426] [OS088-04-MGC-006] [OS088-04-MGC-007] [OS088-04-MGC-008] [OS088-04-MGC-009]
#          * [OS088-04-MGC-065] [OS088-04-MGC-074]
#          */
...
# 
#     {
#         taskId = Os_APICall->Os_API_Data.Os_ApiGetTaskState.TaskId;
	.d2line		129
.Llo53:
...
# 
#         retVal = Os_GetTaskState_Err_Stat(callerProc,taskId,
	.d2line		131
	lwz		r5,20(r31)		# Os_APICall=r31
	mr		r3,r27		# callerProc=r3 callerProc=r27
	mr		r4,r29		# taskId=r4 taskId=r29
	bl		Os_GetTaskState_Err_Stat
.Llo54:
	mr		r30,r3		# retVal=r30 retVal=r3
.L11363:
#                                       Os_APICall->Os_API_Data.Os_ApiGetTaskState.TaskStateRef);
#     }
# 
...
.Llo56:
	...
	bc		0,2,.L11364	# ne
#     {
#         Os_APICall->Os_API_ReturnValue = Os_GetTaskState ( callerProc,
	.d2line		138
	lwz		r5,20(r31)		# Os_APICall=r31
	mr		r3,r27		# callerProc=r3 callerProc=r27
	mr		r4,r29		# taskId=r4 taskId=r29
...
#       #ifdef OS_CONFIG_USEPARAMETERACCESS
# 
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TaskID       = Os_APICall->Os_API_Data.Os_ApiGetTaskState.TaskId;
	.d2line		146
	...
	e_mulli		r4,r4,152
	stwx		r0,r3,r4
#         OS_GET_PARAMETER_ERRORCODE ( coreId ).Os_Err_TaskStateRef = Os_APICall->Os_API_Data.Os_ApiGetTaskState.TaskStateRef;
	.d2line		147
	lwz		r0,20(r31)		# Os_APICall=r31
	lis		r3,(Os_Core_DynShared+84)@ha
	e_add16i		r3,r3,(Os_Core_DynShared+84)@l
	stwx		r0,r3,r4
# 
#       #endif
# 
#         OS_CALL_ERRORHOOK(retVal, OSServiceId_GetTaskState,callerProc); /* [OS001-302.v1-06] */
	.d2line		151
	rlwinm		r3,r30,0,24,31		# retVal=r30
	diab.li		r4,133
...
#     }
# 
#     OS_TRACE(GetTaskState_Exit , coreId);
	.d2line		155
.Llo51:
	diab.li		r3,58
...
#$$ld
.L11494:
	.type		Os_API_GetTaskState,@function
	.size		Os_API_GetTaskState,.-Os_API_GetTaskState
# Number of nodes = 151

# Allocations for Os_API_GetTaskState
#	?a4		Os_APICall
#	?a5		retVal
#	?a6		taskId
#	?a7		coreId
...
#$$ld
.L5:
.L11997:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_Types.h"
.L11994:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ApplicationApiTypes.h"
.L11992:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ScheduleTableApiTypes.h"
.L11990:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_TaskApiTypes.h"
.L11988:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_SpinlockApiTypes.h"
.L11976:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
.L11971:	.d2filenum "..\\..\\BuildSystem\\..\\TTs\\PowerPC\\WindRiver\\AUTOSAR\\ar422\\MemMap.h"
.L11969:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_InternalTypes.h"
.L11952:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ErrorApiTypes.h"
.L11932:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_ExceptionApiTypes.h"
.L11887:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApplicationCfgTypes.h"
.L11838:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\Os_HookApiTypes.h"
...
.L11578:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_ApiDispatchCfgTypes.h"
...
.L11507:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_TaskCfgTypes.h"
	.d2_line_end
	.section	.Os_TEXT,,c
#$$ld
.L11399:
.L11451:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_GetTaskState.c"
.L11407:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\inc\\internal\\Os_Isr.h"
	.d2_line_end
	.section	.Os_PUBLIC_TEXT,,c
#$$ld
.L11420:
.L11428:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_GetTaskState.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\Os\\Os\\core\\ssc\\make\\..\\src\\task\\Os_GetTaskState.c"
	.byte		0
...
.L11458:
	...
	.d2locreg	%offsetof(.Llo8), %offsetof(.Llo9),8
	.d2locreg	%offsetof(.Llo11), %offsetof(.Llo12),8
	.d2locreg	%offsetof(.Llo13), %offsetof(.Llo14),8
	.d2locend
.L11460:
	.d2locreg	%offsetof(.Llo15), %offsetof(.Llo16),3
	.d2locreg	%offsetof(.Llo17), %offsetof(.Llo13),3
	.d2locreg	%offsetof(.Llo14), %offsetof(.Llo18),3
	.d2locend
.L11467:
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo20),3
	.d2locreg	%offsetof(.Llo21), %offsetof(.Llo22),9
	.d2locend
.L11469:
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo23),4
	.d2locreg	%offsetof(.Llo24), %offsetof(.Llo25),10
	.d2locreg	%offsetof(.Llo26), %offsetof(.Llo22),10
	.d2locend
.L11470:
	.d2locreg	%offsetof(.Llo19), %offsetof(.Llo27),5
...
.L11485:
	...
	.d2locreg	%offsetof(.Llo34), %offsetof(.Llo37),30
	.d2locreg	%offsetof(.Llo38), %offsetof(.Llo39),30
	.d2locend
.L11488:
	.d2locreg	%offsetof(.Llo32), %offsetof(.Llo36),5
	.d2locreg	%offsetof(.Llo34), %offsetof(.Llo40),29
	.d2locend
.L11490:
	.d2locreg	%offsetof(.Llo41), %offsetof(.Llo42),3
	.d2locreg	%offsetof(.Llo43), %offsetof(.Llo37),3
...
.L11499:
	...
	.d2locreg	%offsetof(.Llo56), %offsetof(.Llo51),30
	.d2locend
.L11501:
	.d2locreg	%offsetof(.Llo57), %offsetof(.Llo51),29
	.d2locend
.L11503:
	.d2locreg	%offsetof(.Llo58), %offsetof(.Llo51),28
	.d2locreg	%offsetof(.Llo59), %offsetof(.Llo60),28
	.d2locend
.L11505:
	.d2locreg	%offsetof(.Llo61), %offsetof(.Llo51),27
	.d2locend
	.wrcm.doc
	.wrcm.elem
	.wrcm.nelem "code"
	.wrcm.nelem "functions"
	.wrcm.nelem "Os_API_GetTaskState"
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_GetTaskState","Os_GetTaskState_Err_Stat"
	.wrcm.nint32 "frameSize", 48
	.wrcm.end
	.wrcm.nelem "Os_GetTaskState_Err_Stat"
	.wrcm.nstrlist "calls", "Os_Access_Check","Os_Task_CheckId"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nint32 "local", 1
	.wrcm.end
	.wrcm.nelem "Os_GetTaskState"
	.wrcm.nstrlist "calls", "Os_Call_ErrorHook","Os_GetTaskState_Err_Dyn"
	.wrcm.nint32 "frameSize", 32
	.wrcm.nint32 "local", 1
	.wrcm.end
	.wrcm.nelem "Os_GetTaskState_Err_Dyn"
	.wrcm.nstrlist "calls", "Os_Isr_GetState"
	.wrcm.nint32 "frameSize", 16
	.wrcm.nint32 "local", 1
	.wrcm.end
	.wrcm.nelem "GetTaskState"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\Os_GetTaskState.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\Os\Os\core\ssc\make\..\src\task\Os_GetTaskState.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
