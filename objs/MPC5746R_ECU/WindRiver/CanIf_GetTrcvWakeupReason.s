...
#$$oPPCE200Z4
#$$ko 1		- Reorder info
	.file		"CanIf_GetTrcvWakeupReason.c"
#$$dg 1
...
# FUNC( Std_ReturnType, CANIF_CODE )CanIf_GetTrcvWakeupReason
	.align		2
	.section	.text_vle
	.d2file		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanIf\\ssc\\make\\..\\src\\CanIf_GetTrcvWakeupReason.c"
        .d2line         54,35
#$$ld
.L196:

#$$bf	CanIf_GetTrcvWakeupReason,interprocedural,rasave,nostackparams
	.globl		CanIf_GetTrcvWakeupReason
	.d2_cfa_start __cie
...
#     /* REQ: [CANIF289] */
# 
#     /* Variable to hold the Physical TransceiverId Id */
...
#     {
#         /* REQ: [CANIF649] */
#         /* Check if TrcvWuReasonPtr received is valid */
...
#         {
#             /* REQ: [CANIF537] */
#             /* Check if the TransceiverId Id is valid */
...
#         }/* End if( NULL_PTR == TrcvWuReasonPtr ) */
# 
#     }/* End if( CANIF_UNINITIALIZED == CanIf_InitStatus_u8 ) */
# 
#     /* No DET errors present */
#     if( E_OK == CanIfRet )
# #else
# 
...
# 
#     {
#         /* Tranceiver Id of the underlying transceiver*/
#         TransceiverId_u8 = CanIf_TransceiverDrvConfig_a[ TransceiverId ].CanIfTrcvIdRef_u8;
	.d2line		122
...
#         /* REQ: [CANIF368] */
#         /* Calls the Can TransceiverId driver API to get the Wakeup reason */
#         CanIfRet = CanIf_TransceiverDrvConfig_a[ TransceiverId ].
	.d2line		125
	lis		r5,(CanIf_TransceiverDrvConfig_a+12)@ha
	e_add16i		r5,r5,(CanIf_TransceiverDrvConfig_a+12)@l
	lwzx		r0,r5,r0		# TransceiverId=r0
.Llo4:
	mtspr		ctr,r0		# TransceiverId=ctr
	rlwinm		r3,r3,0,24,31		# TransceiverId_u8=r3 TransceiverId_u8=r3
.Llo6:
	mr		r0,r4		# TrcvWuReasonPtr=r0 TrcvWuReasonPtr=r4
#$$fn 0x1ff9 0x0 0x0 0x1
#$$tl 0x18 0x0 0x0 0x1
#$$rs 1 u
	bcctrl		20,0
#                    CanIfCanTrcvGetBusWuReason( TransceiverId_u8, TrcvWuReasonPtr );
#         
...
#     
# }/* End of CanIf_GetTrcvWakeupReason() */
	.d2line		132
	.d2epilogue_begin
.Llo7:
...
# Allocations for CanIf_GetTrcvWakeupReason
#	?a4		TransceiverId
#	?a5		TrcvWuReasonPtr
#	?a6		$$70
#	?a7		$$69
...
.L213:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanIf\\ssc\\make\\..\\inc\\internal\\CanIf_Private.h"
.L198:	.d2filenum "d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanIf\\ssc\\make\\..\\src\\CanIf_GetTrcvWakeupReason.c"
	.d2_line_end
...
.L1:
	...
	.sleb128	1
	.4byte		.L7-.L2
	.byte		"d:\\VSB_Demo\\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\\VSTAR\\BSWs\\COM\\CanIf\\ssc\\make\\..\\src\\CanIf_GetTrcvWakeupReason.c"
	.byte		0
...
.L202:
	.sleb128	2
	.4byte		.L195-.L2
	.byte		"CanIf_GetTrcvWakeupReason"
	.byte		0
	.4byte		.L198
	.uleb128	54
	.uleb128	35
...
.L211:
	...
	.wrcm.nelem "CanIf_GetTrcvWakeupReason"
	...
	.wrcm.nstr "label", "DIAB_5_9_6_4-FCS_20170817_111028"
	.wrcm.end
	.wrcm.nstr "options", "-ei4618 -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.o -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.d -Xmake-opt-key=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.o -MC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\PPC\PPCVLE.cd -ZC:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32\lib\cderror.cat -Xsingle-fp -Xno-double -Xuser-specified-proc=PPCE200Z4204N3V -XPPCE200Z4 -Xname-code=.text_vle -Xname-const=.text_vle -Xname-uconst=.text_vle -Xname-string=.text_vle -Xstsw-slow -Xintrinsic-mask=0xc00041 -Xconventions-eabi -Xsoft-float -Xdouble-avoid -Xcoloring -Xapu-efpu-v2 -Xefpu-spfs -Xtarget-family=2 -Xlicense-proxy-use -Xlicense-proxy-path=C:\WINDRI~1\COMPIL~1\DIAB-5~1.4\WIN32 -Xdialect-c99 -Xforce-prototypes -Xforce-declarations -Xsmall-data=0 -Xsmall-const=0 -Xlocal-data-area=0 -Xnested-interrupts -ei4618 -g2 -Xdebug-inline-on -Xoptimized-debug-off -Xdebug-dwarf2 -Xpass-source -Xmake-dependency-canonicalize-path-off -Xmake-dependency=0x4 -Xc-mode -Xmake-dependency-target=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.o -Xmake-dependency-savefile=objs\MPC5746R_ECU\WindRiver\CanIf_GetTrcvWakeupReason.d"
	.wrcm.end
	.wrcm.end
	.wrcm.nelem "file"
	.wrcm.nstr "input", "d:\VSB_Demo\VSTAR_MPC5746R_Diab_PR_4.2.2_g_3.0_10\VSTAR\BSWs\COM\CanIf\ssc\make\..\src\CanIf_GetTrcvWakeupReason.c"
	.wrcm.end
	.wrcm.end
	.wrcm.end
