...
#define GPT_SW_PATCH_VERSION_CFG_C             2
...
#if (GPT_VENDOR_ID_CFG_C != REG_ESYS_EMIOS_VENDOR_ID)
    #error "Gpt_Cfg.c and Reg_eSys_eMios.h have different vendor ids"
#endif
/* Check if the source file and Gpt header file are of the same Autosar version */

#if ((GPT_AR_RELEASE_MAJOR_VERSION_CFG_C != REG_ESYS_EMIOS_AR_RELEASE_MAJOR_VERSION) || \
     (GPT_AR_RELEASE_MINOR_VERSION_CFG_C != REG_ESYS_EMIOS_AR_RELEASE_MINOR_VERSION) || \
     (GPT_AR_RELEASE_REVISION_VERSION_CFG_C != REG_ESYS_EMIOS_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Gpt_Cfg.c and Reg_eSys_eMios.h are different"
#endif
/* Check if source file and GPT header file are of the same Software version */

#if ((GPT_SW_MAJOR_VERSION_CFG_C != REG_ESYS_EMIOS_SW_MAJOR_VERSION) || \
     (GPT_SW_MINOR_VERSION_CFG_C != REG_ESYS_EMIOS_SW_MINOR_VERSION) || \
     (GPT_SW_PATCH_VERSION_CFG_C != REG_ESYS_EMIOS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Gpt_Cfg.c and Reg_eSys_eMios.h are different"
#endif
/*==================================================================================================
*                                      GLOBAL VARIABLES
==================================================================================================*/
