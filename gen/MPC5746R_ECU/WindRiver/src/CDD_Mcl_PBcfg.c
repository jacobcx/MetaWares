...
#define MCL_PBCFG_AR_RELEASE_MINOR_VERSION_C      0
#define MCL_PBCFG_AR_RELEASE_REVISION_VERSION_C   3
#define MCL_PBCFG_SW_MAJOR_VERSION_C              1
#define MCL_PBCFG_SW_MINOR_VERSION_C              0
#define MCL_PBCFG_SW_PATCH_VERSION_C              2
...
/**
* @violates @ref Mcl_PBcfg_c_REF_1 MISRA 2004 Required Rule 19.15, Repeated include file
* @violates @ref Mcl_PBcfg_c_REF_2 MISRA 2004 Advisory Rule 19.1, only preprocessor statements and comments before '#include'
*/
#include "MemMap.h"
...
*/
CONST( Mcl_DemConfigType, MCL_CONST) Mcl_Dem_Config_PB =
...
/**
* @violates @ref Mcl_PBcfg_c_REF_1 MISRA 2004 Required Rule 19.15, Repeated include file
* @violates @ref Mcl_PBcfg_c_REF_2 MISRA 2004 Advisory Rule 19.1, only preprocessor 
...
/**
  ...
  */
#define MCL_DMA_CONF_CHANNELS_PB_0   1U


/**
  * @brief Number of configured DmaMux channels
  */
#define MCL_DMAMUX_CONF_CHANNELS_PB_0  1U
...
static CONST(Mcl_DmaChannelConfigType, MCL_CONST) Mcl_Dma_ChannelConfig_PB_0[MCL_DMA_CONF_CHANNELS_PB_0] =
...
static CONST(Mcl_DmaConfigInstanceType, MCL_CONST) Mcl_Dma_InstanceConfig_PB_0[MCL_DMA_NB_CONTROLLERS] =
{
    {
...
*
*/
static CONST( Mcl_DmaConfigType, MCL_CONST) Dma_Config_PB_0 =
    {
        /** @brief Number of configured eDMA channels. */
        1U,  
        &Mcl_Dma_InstanceConfig_PB_0,
        /** @brief Pointer to the structure containing DMA channel configuration */
        &Mcl_Dma_ChannelConfig_PB_0
    };


/** @brief Configuration for DmaMux channels */
static CONST( Mcl_DmaMuxChannelConfigType, MCL_CONST) Mcl_DmaMux_ChannelConfig_PB_0[MCL_DMAMUX_CONF_CHANNELS_PB_0] =
...
*
*/
static CONST( Mcl_DmaMuxConfigType, MCL_CONST) DmaMux_Config_PB_0 =
    {
        /** @brief Number of configured DMA channels which are also linked to DMAMUX. */
        MCL_DMAMUX_CONF_CHANNELS_PB_0,   
        /** @brief Pointer to the structure containing DMAMUX channel configuration */
        &Mcl_DmaMux_ChannelConfig_PB_0
    };
    
/** @brief Array of configured Mcl channels */
static CONST(Mcl_ChannelConfigType, MCL_CONST) Mcl_ChannelConfig_PB_0[MCL_DMA_CONF_CHANNELS_PB_0] =
{
    /** @brief DMAChannel */
    {
...
*
*/
static CONST( Mcl_DmaHwIpsConfigType, MCL_CONST) Mcl_HwIPs_Config_PB_0 =
    {
...
*
*/
static CONST( Mcl_DmaInitConfigType, MCL_CONST) Mcl_Dma_InitConfig_0=
    {
        /** @brief Number of configured eDMA channels. */
        1U,
        /** @brief Pointer to the structure containing Mcl channel configuration */
        &Mcl_ChannelConfig_PB_0,
        /**< @brief IPs data generic configuration. */
        &Mcl_HwIPs_Config_PB_0
...
*
*/
/** @violates @ref Mcl_PBcfg_c_REF_10 All declarations and definitions should have internal linkage */
CONST( Mcl_ConfigType, MCL_CONST) MclConfigSet =
{
#if (MCL_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
