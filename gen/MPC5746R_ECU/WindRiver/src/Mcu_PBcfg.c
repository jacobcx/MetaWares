...
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to 
...
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to 
*   ensure that 31 character significance and case sensitivity are supported for external identifiers. */
#define MCU_PBCFG_AR_RELEASE_MINOR_VERSION_C      0
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to 
*   ensure that 31 character significance and case sensitivity are supported for external identifiers. */
#define MCU_PBCFG_AR_RELEASE_REVISION_VERSION_C   3
...
*/
static CONST( Mcu_DemConfigType, MCU_CONST) Mcu_Dem_ConfigPB0 =
{
...
static CONST( Mcu_MC_ME_CoreAddressConfigType, MCU_CONST) Mcu_Mode_CoreAddressConfigPB0_0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
...
{    
    ...
    /* Start of Mcu_ModeConfig[0] - DRUN */
    {
        ...
        &Mcu_Mode_CoreAddressConfigPB0_0
#endif /* MCU_CONFIGURE_CADDRN == STD_ON */
...
*               Configuration set by calling Mcu_InitClock API.
*/
static CONST( Mcu_FLASH_ClockConfigType, MCU_CONST) FLASH_Clock_ConfigPB0_0 = 
{
...
#if (MCU_INIT_CLOCK == STD_ON)
static CONST( Mcu_MC_CGM_RegisterConfigType, MCU_CONST) MC_CGM_aAuxClockConfigPB0_0[23] = 
{
...
*
*/
static CONST( Mcu_MC_CGM_ClockConfigType, MCU_CONST) MC_CGM_Clock_ConfigPB0_0 = 
{
...
*/
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
static CONST( Mcu_PLLDIG_RegisterConfigType, MCU_CONST) Mcu_PLLDIG_aRegistersConfigPB0_0[6] = 
{
...
*
*/
/** @violates @ref Mcu_PBcfg_c_REF_6 This is not a standard library macro. */
static CONST(Mcu_eMios_ConfigType, MCU_CONST) EMIOS_Module_ConfigPB0_0 = 
{
    {
...
*
*/
static CONST( Mcu_CMU_ConfigType, MCU_CONST) CMU_ConfigPB0_0 =
{
    {
...
*
*/
static CONST( Mcu_XOSC_ConfigType, MCU_CONST) MC_XOSC_ClockConfigPB0_0 =
{
...
static CONST( Mcu_MC_ME_CoreAddressConfigType, MCU_CONST) MC_ME_CADDR_ConfigPB0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
    /* Core Control Register (ME_CADDR0) */
    {
        MC_ME_CADDR0_ADDR32,
...
static CONST( Mcu_MC_ME_CoreConfigType, MCU_CONST) MC_ME_CCTL_ConfigPB0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
...
*
*/
static CONST( Mcu_MC_PCU_ConfigType, MCU_CONST) MC_PCU_ConfigPB0 =
{
...
*
*/
static CONST( Mcu_HwIPsConfigType, MCU_CONST) Mcu_HwIPs_ConfigPB0 =
{
