...
#define ICU_SW_PATCH_VERSION_PBCFG_C            2
...
/*
 *  @brief    PB Default SIUL2 Configuration
 *  @violates @ref Icu_PBCfg_c_3 violates Misra 8.10 external ... could be made static
 */
 CONST(Icu_Siul2_ChannelConfigType, ICU_CONST) Icu_Siul2_ChannelConfig_PB0[1] =
 {
 ...
 *  @violates @ref Icu_PBCfg_c_3 violates Misra 8.10 external ... could be made static
 */
 CONST(Icu_Siul2_IpConfigType, ICU_CONST) Icu_Siul2Icu_IpConfig_PB0 =
 {
