...
* signifiance and case sensitivity are supported for external identifiers
*/
#define ADC_AR_RELEASE_MINOR_VERSION_PBCFG_C     0
/**
* @violates @ref Adc_PBcfg_c_REF_3 The compiler/linker shall be checked to ensure that 31 character
* signifiance and case sensitivity are supported for external identifiers
*/
#define ADC_AR_RELEASE_REVISION_VERSION_PBCFG_C  3
...
*
*/
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group0_AssignmentPB_0_1[ADC_CFGSET1_GROUP_0_CHANNELS] =
{
    0U
};
/**
* @brief          Group Assignments on ADC Hardware unit 1 Configuration 1.
*
*/
/**
* @brief          Group Assignments on ADC Hardware unit 2 Configuration 1.
*
*/
/**
* @brief          Group Assignments on ADC Hardware unit 3 Configuration 1.
*
*/
...
/**
* @brief          Definition of ADC Hw units Configuration 1.
*/
static CONST(Adc_Adcdig_HwUnitConfigurationType, ADC_CONST) Adc_HwUnitCfgPB_1[] =
{
    ...
    /** @violates @ref Adc_PBcfg_c_REF_6 MISRA-C:2004 Rule 9.2.*/
    }
};
...
*/
static CONST(Adc_Adcdig_ChannelConfigurationType, ADC_CONST) Adc_ChannelsCfgPB_0_1[] =
{
...
/**
* @brief          Definition of channels's pointer structure Configuration 1.
*
*/
static P2CONST(Adc_Adcdig_ChannelConfigurationType, ADC_VAR, ADC_APPL_CONST) Adc_ChannelsCfgPB_1[] =
{
...
/**
* @brief          Definition of all ADC groups for configuration 1.
*/
static CONST(Adc_GroupConfigurationType, ADC_CONST) Adc_GroupsCfgPB_1[] =
{
...
/**
* @brief          ADC driver Configuration structure 1.
*/
