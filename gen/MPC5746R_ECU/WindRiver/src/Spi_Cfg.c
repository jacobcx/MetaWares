...
#define SPI_SW_PATCH_VERSION_CFG_C                 2
...
VAR_ALIGN(static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel, 2)
VAR_ALIGN(static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel_CANA_TJA1145, 2)
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel_EEP_CommandAddress;
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel_EEP_Data;
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel_EEP_LatchCommand;
static VAR(Spi_BufferDescriptorType, SPI_VAR) Buffer_PCSpiChannel_EEP_StatusReg;
...
static CONST(Spi_ChannelConfigType, SPI_CONST) SpiChannelConfig_PC[6] =
{
...

    {
        ...
        (Spi_DataType)1U,
        10U,
        &Buffer_PCSpiChannel_CANA_TJA1145,
...

    {
        ...
        (Spi_DataType)1U,
        3U,
        &Buffer_PCSpiChannel_EEP_CommandAddress,
...

    {
        ...
        (Spi_DataType)1U,
        1U,
        &Buffer_PCSpiChannel_EEP_LatchCommand,
...

    {
        ...
        (Spi_DataType)1U,
        2U,
        &Buffer_PCSpiChannel_EEP_StatusReg,
...
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_ChannelAssignment_PC[1] = {SpiConf_SpiChannel_SpiChannel};
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_CANA_TJA1145_ChannelAssignment_PC[1] = {SpiConf_SpiChannel_SpiChannel_CANA_TJA1145};
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_CAND_TJA1145_ChannelAssignment_PC[1] = {SpiConf_SpiChannel_SpiChannel_CANA_TJA1145};
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_EEP_DataJob_ChannelAssignment_PC[2] = {SpiConf_SpiChannel_SpiChannel_EEP_CommandAddress,SpiConf_SpiChannel_SpiChannel_EEP_Data};
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_EEP_CommandJob_ChannelAssignment_PC[1] = {SpiConf_SpiChannel_SpiChannel_EEP_LatchCommand};
static CONST(Spi_ChannelType, SPI_CONST) SpiJob_EEP_ReadStatusReg_ChannelAssignment_PC[1] = {SpiConf_SpiChannel_SpiChannel_EEP_StatusReg};
...
{
    {
        /* SpiJob */
        (Spi_ChannelType)1u,
        &SpiJob_ChannelAssignment_PC, /* List of Channels */
            ...
            },
    {
        /* SpiJob_CANA_TJA1145 */
        (Spi_ChannelType)1u,
        &SpiJob_CANA_TJA1145_ChannelAssignment_PC, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        /* SpiJob_CAND_TJA1145 */
        (Spi_ChannelType)1u,
        &SpiJob_CAND_TJA1145_ChannelAssignment_PC, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        ...
        (Spi_ChannelType)1u,
        &SpiJob_EEP_CommandJob_ChannelAssignment_PC, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)1, /* Priority */
            ...
            },
    {
        /* SpiJob_EEP_DataJob */
        (Spi_ChannelType)2u,
        &SpiJob_EEP_DataJob_ChannelAssignment_PC, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
            ...
            },
    {
        ...
        (Spi_ChannelType)1u,
        &SpiJob_EEP_ReadStatusReg_ChannelAssignment_PC, /* List of Channels */
        NULL_PTR, /* End Notification */
        NULL_PTR, /* Start Notification */
        (sint8)0, /* Priority */
...
static CONST(Spi_JobType, SPI_CONST) SpiSequence_SBC_JobAssignment_PC[1] = {SpiConf_SpiJob_SpiJob};
static CONST(Spi_JobType, SPI_CONST) SpiSequence_CANA_TJA1145_JobAssignment_PC[1] = {SpiConf_SpiJob_SpiJob_CANA_TJA1145};
static CONST(Spi_JobType, SPI_CONST) SpiSequence_CAND_TJA1145_JobAssignment_PC[1] = {SpiConf_SpiJob_SpiJob_CAND_TJA1145};
static CONST(Spi_JobType, SPI_CONST) SpiSequence_EEP_READ_JobAssignment_PC[1] = {SpiConf_SpiJob_SpiJob_EEP_DataJob};
static CONST(Spi_JobType, SPI_CONST) SpiSequence_EEP_WRITE_JobAssignment_PC[2] = {SpiConf_SpiJob_SpiJob_EEP_CommandJob,SpiConf_SpiJob_SpiJob_EEP_DataJob};
static CONST(Spi_JobType, SPI_CONST) SpiSequence_EEP_READSTATUS_JobAssignment_PC[1] = {SpiConf_SpiJob_SpiJob_EEP_ReadStatusReg};
...
static CONST(Spi_SequenceConfigType, SPI_CONST) SpiSequenceConfig_PC[6] =
{
    {  /* SpiSequence_SBC */
        ...
        (Spi_JobType)1u,
        &SpiSequence_SBC_JobAssignment_PC, /* List of Jobs */
        NULL_PTR, /* End Notification */
    ...
    {  /* SpiSequence_CANA_TJA1145 */
        ...
        (Spi_JobType)1u,
        &SpiSequence_CANA_TJA1145_JobAssignment_PC, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* SpiSequence_CAND_TJA1145 */
        ...
        (Spi_JobType)1u,
        &SpiSequence_CAND_TJA1145_JobAssignment_PC, /* List of Jobs */
        NULL_PTR, /* End Notification */
                (uint8)FALSE /* Interruptible */
    },
    ...
    {  /* SpiSequence_EEP_READ */
        ...
        (Spi_JobType)1u,
        &SpiSequence_EEP_READ_JobAssignment_PC, /* List of Jobs */
    ...
    {  /* SpiSequence_EEP_WRITE */
        ...
        (Spi_JobType)2u,
        &SpiSequence_EEP_WRITE_JobAssignment_PC, /* List of Jobs */
    ...
    {  /* SpiSequence_EEP_READSTATUS */
        ...
        (Spi_JobType)1u,
        &SpiSequence_EEP_READSTATUS_JobAssignment_PC, /* List of Jobs */
...
static CONST(Spi_Ipw_DeviceAttributesConfigType, SPI_CONST) DspiDeviceAttributesConfig_PC[4] =
{
