...
#define SCHM_CANIF_SW_MAJOR_VERSION (4U)
#define SCHM_CANIF_SW_MINOR_VERSION (18U)
#define SCHM_CANIF_SW_PATCH_VERSION (3U)
...
extern FUNC(void, RTE_CODE) SchM_Enter_CanIf_EXCLUSIVE_AREA_0(void);
extern FUNC(void, RTE_CODE) SchM_Exit_CanIf_EXCLUSIVE_AREA_0(void);
...
extern FUNC(void, CANIF_CODE) CanIf_MainFunction(void);
