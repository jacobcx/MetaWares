...
#define SCHM_LINSM_SW_MAJOR_VERSION (6U)
#define SCHM_LINSM_SW_MINOR_VERSION (0U)
#define SCHM_LINSM_SW_PATCH_VERSION (1U)
...
extern FUNC(void, RTE_CODE) SchM_Enter_LinSM_ExclusiveArea0(void);
extern FUNC(void, RTE_CODE) SchM_Exit_LinSM_ExclusiveArea0(void);
